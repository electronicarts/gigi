...
namespace /*$(Name)*/
{
    // Compile time technique settings. Feel free to modify these./*$(TechniqueSettings)*/
    ...
    private:
        ...
        ProfileEntry m_profileData[/*$(NumActionNodes)*/+1]; // One for each action node, and another for the total
    };
    ...
    // Destroy a context
    void DestroyContext(Context* context);/*$(Public)*/
};
