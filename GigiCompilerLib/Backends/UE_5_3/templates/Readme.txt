...
Copy Public//*$(Name)*/Technique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public//*$(Name)*/Technique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private//*$(Name)*//

/*Readme_SlangWarning*//*Readme_VSSemantics*//*Readme_Assets*//*Readme_NonTransientStorage*/=====================================================================================================
Connect Technique
=====================================================================================================
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:
	...
	{
		/*$(Name)*/::FTechniqueParams params;

		// Set inputs, such as this line:
		//params.inputs.Texture_InputTexture = SceneColor.Texture;

		// Set variables, such as this line:
		// View.ViewState->TechniqueState_/*$(Name)*/.Var_Enabled = true;

		/*$(Name)*/::AddTechnique(GraphBuilder, View, params);
...
See /*$(Name)*/Technique.cpp for details.
