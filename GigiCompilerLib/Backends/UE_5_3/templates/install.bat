...
copy public\/*$(Name)*/Technique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\/*$(Name)*/Technique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\/*$(Name)*/\ mkdir %1Engine\Shaders\Private\/*$(Name)*/\
copy shaders\*.* %1Engine\Shaders\Private\/*$(Name)*/\
