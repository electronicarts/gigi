...
int main(int, char**)
{
    ...
    if (!g_doSubsetTest || g_doTest_buffertest_viewOffsetCS)
    {
        buffertest_viewOffsetCS::Context::LogFn = &LogFunction;
        buffertest_viewOffsetCS::Context::PerfEventBeginFn = &PerfEventBeginFn;
        buffertest_viewOffsetCS::Context::PerfEventEndFn = &PerfEventEndFn;
        buffertest_viewOffsetCS::Context::s_techniqueLocation = L".\\UnitTests\\Buffers\\buffertest_viewOffsetCS\\";
        m_buffertest_viewOffsetCS = buffertest_viewOffsetCS::CreateContext(g_pd3dDevice);
        if (!m_buffertest_viewOffsetCS)
        {
            printf("Could not create m_buffertest_viewOffsetCS context");
            return 1;
        }
    }
    ...
    if (!g_doSubsetTest || g_doTest_bufferViewDescriptorTable)
    {
        ...
        bufferViewDescriptorTable::Context::PerfEventBeginFn = &PerfEventBeginFn;
        bufferViewDescriptorTable::Context::PerfEventEndFn = &PerfEventEndFn;
        bufferViewDescriptorTable::Context::s_techniqueLocation = L".\\UnitTests\\Buffers\\bufferViewDescriptorTable\\";
        m_bufferViewDescriptorTable = bufferViewDescriptorTable::CreateContext(g_pd3dDevice);
        if (!m_bufferViewDescriptorTable)
        {
            printf("Could not create m_bufferViewDescriptorTable context");
            return 1;
        }
    }
    ...
    if (!g_doSubsetTest || g_doTest_CopyPartialBuffer)
    {
        CopyPartialBuffer::Context::LogFn = &LogFunction;
        CopyPartialBuffer::Context::PerfEventBeginFn = &PerfEventBeginFn;
        CopyPartialBuffer::Context::PerfEventEndFn = &PerfEventEndFn;
        CopyPartialBuffer::Context::s_techniqueLocation = L".\\UnitTests\\CopyResource\\CopyPartialBuffer\\";
        m_CopyPartialBuffer = CopyPartialBuffer::CreateContext(g_pd3dDevice);
        if (!m_CopyPartialBuffer)
        {
            printf("Could not create m_CopyPartialBuffer context");
            return 1;
        }
    }
    ...
    if (m_bufferViewDescriptorTable)
    {
        ...
        m_bufferViewDescriptorTable = nullptr;
    }
    if (m_StructuredBuffer)
    {
    ...
    if (m_CopyPartialBuffer)
    {
        CopyPartialBuffer::DestroyContext(m_CopyPartialBuffer);
        m_CopyPartialBuffer = nullptr;
    }
    if (m_CopyResourceTest)
    {
