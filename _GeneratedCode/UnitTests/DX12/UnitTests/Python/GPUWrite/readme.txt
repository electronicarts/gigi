...
GPUWrite::Context *m_GPUWriteContext = nullptr;

m_GPUWriteContext = GPUWrite::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

GPUWrite::OnNewFrame(FramesInFlight)
...
GPUWrite::DestroyContext(m_GPUWriteContext);
...
GPUWrite::Context::s_techniqueLocation = L"./"
...
GPUWrite::Execute(m_GPUWrite, m_device, m_commandList);
...
GPUWrite::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

GPUWrite::Context::PerfEventBeginFn
GPUWrite::Context::PerfEventEndFn
...
if (m_GPUWrite && ImGui::CollapsingHeader("GPUWrite"))
    outline::MakeUI(m_GPUWrite);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("GPUWrite", GPUWrite::CreateModule);

in the python module, you will need to "import GPUWrite", and when will be able to set user exposed
variables like:

GPUWrite.Set_<variable name>(<value>);
