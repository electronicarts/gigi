...
profiling::Context *m_profilingContext = nullptr;

m_profilingContext = profiling::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

profiling::OnNewFrame(FramesInFlight)
...
profiling::DestroyContext(m_profilingContext);
...
profiling::Context::s_techniqueLocation = L"./"
...
profiling::Execute(m_profiling, m_device, m_commandList);
...
profiling::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

profiling::Context::PerfEventBeginFn
profiling::Context::PerfEventEndFn
...
if (m_profiling && ImGui::CollapsingHeader("profiling"))
    outline::MakeUI(m_profiling);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("profiling", profiling::CreateModule);

in the python module, you will need to "import profiling", and when will be able to set user exposed
variables like:

profiling.Set_<variable name>(<value>);
