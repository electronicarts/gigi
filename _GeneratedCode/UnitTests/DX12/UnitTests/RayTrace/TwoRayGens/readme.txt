...
TwoRayGens::Context *m_TwoRayGensContext = nullptr;

m_TwoRayGensContext = TwoRayGens::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

TwoRayGens::OnNewFrame(FramesInFlight)
...
TwoRayGens::DestroyContext(m_TwoRayGensContext);
...
TwoRayGens::Context::s_techniqueLocation = L"./"
...
m_TwoRayGens.m_input.

TwoRayGens::Execute(m_TwoRayGens, m_device, m_commandList);
...
TwoRayGens::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

TwoRayGens::Context::PerfEventBeginFn
TwoRayGens::Context::PerfEventEndFn
...
if (m_TwoRayGens && ImGui::CollapsingHeader("TwoRayGens"))
    outline::MakeUI(m_TwoRayGens);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("TwoRayGens", TwoRayGens::CreateModule);

in the python module, you will need to "import TwoRayGens", and when will be able to set user exposed
variables like:

TwoRayGens.Set_<variable name>(<value>);
