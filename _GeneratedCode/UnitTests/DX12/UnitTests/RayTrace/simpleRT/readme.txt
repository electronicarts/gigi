...
simpleRT::Context *m_simpleRTContext = nullptr;

m_simpleRTContext = simpleRT::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

simpleRT::OnNewFrame(FramesInFlight)
...
simpleRT::DestroyContext(m_simpleRTContext);
...
simpleRT::Context::s_techniqueLocation = L"./"
...
simpleRT::Execute(m_simpleRT, m_device, m_commandList);
...
simpleRT::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

simpleRT::Context::PerfEventBeginFn
simpleRT::Context::PerfEventEndFn
...
if (m_simpleRT && ImGui::CollapsingHeader("simpleRT"))
    outline::MakeUI(m_simpleRT);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("simpleRT", simpleRT::CreateModule);

in the python module, you will need to "import simpleRT", and when will be able to set user exposed
variables like:

simpleRT.Set_<variable name>(<value>);
