...
AnyHit::Context *m_AnyHitContext = nullptr;

m_AnyHitContext = AnyHit::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

AnyHit::OnNewFrame(FramesInFlight)
...
AnyHit::DestroyContext(m_AnyHitContext);
...
AnyHit::Context::s_techniqueLocation = L"./"
...
AnyHit::Execute(m_AnyHit, m_device, m_commandList);
...
AnyHit::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

AnyHit::Context::PerfEventBeginFn
AnyHit::Context::PerfEventEndFn
...
if (m_AnyHit && ImGui::CollapsingHeader("AnyHit"))
    outline::MakeUI(m_AnyHit);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("AnyHit", AnyHit::CreateModule);

in the python module, you will need to "import AnyHit", and when will be able to set user exposed
variables like:

AnyHit.Set_<variable name>(<value>);
