...
IntersectionShader::Context *m_IntersectionShaderContext = nullptr;

m_IntersectionShaderContext = IntersectionShader::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

IntersectionShader::OnNewFrame(FramesInFlight)
...
IntersectionShader::DestroyContext(m_IntersectionShaderContext);
...
IntersectionShader::Context::s_techniqueLocation = L"./"
...
m_IntersectionShader.m_input.

IntersectionShader::Execute(m_IntersectionShader, m_device, m_commandList);
...
IntersectionShader::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

IntersectionShader::Context::PerfEventBeginFn
IntersectionShader::Context::PerfEventEndFn
...
if (m_IntersectionShader && ImGui::CollapsingHeader("IntersectionShader"))
    outline::MakeUI(m_IntersectionShader);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("IntersectionShader", IntersectionShader::CreateModule);

in the python module, you will need to "import IntersectionShader", and when will be able to set user exposed
variables like:

IntersectionShader.Set_<variable name>(<value>);
