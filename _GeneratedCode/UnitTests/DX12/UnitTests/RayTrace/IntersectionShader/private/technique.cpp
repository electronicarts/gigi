    ...
    void Execute(Context* context, ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
    {
        ...
        // Ray Shader: Do_RT
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                { context->m_input.buffer_AABBs, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::RTScene, false, context->m_input.buffer_AABBs_tlasSize, 1 },
                { context->m_input.buffer_AABBsSRV, context->m_input.buffer_AABBsSRV_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::Buffer, false, context->m_input.buffer_AABBsSRV_stride, context->m_input.buffer_AABBsSRV_count },
                ...
                { context->m_internal.constantBuffer__Ray_GenCB, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::CBV, DX12Utils::ResourceType::Buffer, false, 256, 1 }
            };
