    ...
    void Execute(Context* context, ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
    {
        ...
        // Ray Shader: A_DoRT1
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                ...
                { context->m_internal.constantBuffer__A_TwoRayGens1CB, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::CBV, DX12Utils::ResourceType::Buffer, false, 256, 1, 0, 0, 0, false }
            };
        ...
        // Ray Shader: B_DoRT2
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                ...
                { context->m_internal.constantBuffer__B_TwoRayGens2CB, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::CBV, DX12Utils::ResourceType::Buffer, false, 256, 1, 0, 0, 0, false }
            };
