...
TwoRayGensSubgraph::Context *m_TwoRayGensSubgraphContext = nullptr;

m_TwoRayGensSubgraphContext = TwoRayGensSubgraph::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

TwoRayGensSubgraph::OnNewFrame(FramesInFlight)
...
TwoRayGensSubgraph::DestroyContext(m_TwoRayGensSubgraphContext);
...
TwoRayGensSubgraph::Context::s_techniqueLocation = L"./"
...
m_TwoRayGensSubgraph.m_input.

TwoRayGensSubgraph::Execute(m_TwoRayGensSubgraph, m_device, m_commandList);
...
TwoRayGensSubgraph::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

TwoRayGensSubgraph::Context::PerfEventBeginFn
TwoRayGensSubgraph::Context::PerfEventEndFn
...
if (m_TwoRayGensSubgraph && ImGui::CollapsingHeader("TwoRayGensSubgraph"))
    outline::MakeUI(m_TwoRayGensSubgraph);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("TwoRayGensSubgraph", TwoRayGensSubgraph::CreateModule);

in the python module, you will need to "import TwoRayGensSubgraph", and when will be able to set user exposed
variables like:

TwoRayGensSubgraph.Set_<variable name>(<value>);
