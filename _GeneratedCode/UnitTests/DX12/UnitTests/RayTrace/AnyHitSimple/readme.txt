...
AnyHitSimple::Context *m_AnyHitSimpleContext = nullptr;

m_AnyHitSimpleContext = AnyHitSimple::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

AnyHitSimple::OnNewFrame(FramesInFlight)
...
AnyHitSimple::DestroyContext(m_AnyHitSimpleContext);
...
AnyHitSimple::Context::s_techniqueLocation = L"./"
...
m_AnyHitSimple.m_input.

AnyHitSimple::Execute(m_AnyHitSimple, m_device, m_commandList);
...
AnyHitSimple::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

AnyHitSimple::Context::PerfEventBeginFn
AnyHitSimple::Context::PerfEventEndFn
...
if (m_AnyHitSimple && ImGui::CollapsingHeader("AnyHitSimple"))
    outline::MakeUI(m_AnyHitSimple);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("AnyHitSimple", AnyHitSimple::CreateModule);

in the python module, you will need to "import AnyHitSimple", and when will be able to set user exposed
variables like:

AnyHitSimple.Set_<variable name>(<value>);
