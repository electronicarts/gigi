...
MeshAmplificationLines::Context *m_MeshAmplificationLinesContext = nullptr;

m_MeshAmplificationLinesContext = MeshAmplificationLines::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

MeshAmplificationLines::OnNewFrame(FramesInFlight)
...
MeshAmplificationLines::DestroyContext(m_MeshAmplificationLinesContext);
...
MeshAmplificationLines::Context::s_techniqueLocation = L"./"
...
m_MeshAmplificationLines.m_input.

MeshAmplificationLines::Execute(m_MeshAmplificationLines, m_device, m_commandList);
...
MeshAmplificationLines::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

MeshAmplificationLines::Context::PerfEventBeginFn
MeshAmplificationLines::Context::PerfEventEndFn
...
if (m_MeshAmplificationLines && ImGui::CollapsingHeader("MeshAmplificationLines"))
    outline::MakeUI(m_MeshAmplificationLines);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("MeshAmplificationLines", MeshAmplificationLines::CreateModule);

in the python module, you will need to "import MeshAmplificationLines", and when will be able to set user exposed
variables like:

MeshAmplificationLines.Set_<variable name>(<value>);
