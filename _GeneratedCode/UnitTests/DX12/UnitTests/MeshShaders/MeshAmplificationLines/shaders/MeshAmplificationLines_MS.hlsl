...
[OutputTopology("line")]
#line 24
void MSMain(uint3 dtid : SV_DispatchThreadID, uint gtid : SV_GroupIndex, uint3 gid : SV_GroupID, in payload ASPayload payload, out vertices ProcessedVertex verts[MESHLET_NUM_VERTS], out indices uint2 lines[MESHLET_NUM_LINES])
{
