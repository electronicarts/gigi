...
MeshAmplification::Context *m_MeshAmplificationContext = nullptr;

m_MeshAmplificationContext = MeshAmplification::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

MeshAmplification::OnNewFrame(FramesInFlight)
...
MeshAmplification::DestroyContext(m_MeshAmplificationContext);
...
MeshAmplification::Context::s_techniqueLocation = L"./"
...
m_MeshAmplification.m_input.

MeshAmplification::Execute(m_MeshAmplification, m_device, m_commandList);
...
MeshAmplification::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

MeshAmplification::Context::PerfEventBeginFn
MeshAmplification::Context::PerfEventEndFn
...
if (m_MeshAmplification && ImGui::CollapsingHeader("MeshAmplification"))
    outline::MakeUI(m_MeshAmplification);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("MeshAmplification", MeshAmplification::CreateModule);

in the python module, you will need to "import MeshAmplification", and when will be able to set user exposed
variables like:

MeshAmplification.Set_<variable name>(<value>);
