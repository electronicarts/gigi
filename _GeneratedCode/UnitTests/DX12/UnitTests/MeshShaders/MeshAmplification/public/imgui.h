...
namespace MeshAmplification
{
    ...
    {
        ImGui::PushID("gigi_MeshAmplification");
        ...
        ImGui::InputFloat("AmplificationSpacing", &context->m_input.variable_AmplificationSpacing);
        {
            ...
            ImGui::InputFloat("##X", &context->m_input.variable_Offset[0]);
            ImGui::SameLine();
            ImGui::InputFloat("##Y", &context->m_input.variable_Offset[1]);
            ImGui::SameLine();
            ImGui::InputFloat("##Z", &context->m_input.variable_Offset[2]);
            ImGui::SameLine();
            ImGui::Text("Offset");
            ImGui::PopItemWidth();
            ImGui::PopID();
