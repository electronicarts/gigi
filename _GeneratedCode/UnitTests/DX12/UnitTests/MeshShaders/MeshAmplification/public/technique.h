...
namespace MeshAmplification
{
    ...
    struct Context
    {
        ...
        {
            return "MeshAmplification";
        }

        static const wchar_t* GetTechniqueNameW()
        {
            return L"MeshAmplification";
        }
        ...
        struct ContextInput
        {
            ...
            uint variable_AmplificationCount = 4;
            float variable_AmplificationSpacing = 2.000000f;
            float3 variable_Offset = {0.000000f, 1.000000f, 0.000000f};
