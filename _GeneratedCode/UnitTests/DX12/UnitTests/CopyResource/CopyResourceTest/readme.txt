...
CopyResourceTest::Context *m_CopyResourceTestContext = nullptr;

m_CopyResourceTestContext = CopyResourceTest::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

CopyResourceTest::OnNewFrame(FramesInFlight)
...
CopyResourceTest::DestroyContext(m_CopyResourceTestContext);
...
CopyResourceTest::Context::s_techniqueLocation = L"./"
...
m_CopyResourceTest.m_input.

CopyResourceTest::Execute(m_CopyResourceTest, m_device, m_commandList);
...
CopyResourceTest::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

CopyResourceTest::Context::PerfEventBeginFn
CopyResourceTest::Context::PerfEventEndFn
...
if (m_CopyResourceTest && ImGui::CollapsingHeader("CopyResourceTest"))
    outline::MakeUI(m_CopyResourceTest);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("CopyResourceTest", CopyResourceTest::CreateModule);

in the python module, you will need to "import CopyResourceTest", and when will be able to set user exposed
variables like:

CopyResourceTest.Set_<variable name>(<value>);
