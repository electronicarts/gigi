...
CopyPartialBuffer::Context *m_CopyPartialBufferContext = nullptr;

m_CopyPartialBufferContext = CopyPartialBuffer::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

CopyPartialBuffer::OnNewFrame(FramesInFlight)
...
CopyPartialBuffer::DestroyContext(m_CopyPartialBufferContext);
...
CopyPartialBuffer::Context::s_techniqueLocation = L"./"
...
m_CopyPartialBuffer.m_input.

CopyPartialBuffer::Execute(m_CopyPartialBuffer, m_device, m_commandList);
...
CopyPartialBuffer::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

CopyPartialBuffer::Context::PerfEventBeginFn
CopyPartialBuffer::Context::PerfEventEndFn
...
if (m_CopyPartialBuffer && ImGui::CollapsingHeader("CopyPartialBuffer"))
    outline::MakeUI(m_CopyPartialBuffer);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("CopyPartialBuffer", CopyPartialBuffer::CreateModule);

in the python module, you will need to "import CopyPartialBuffer", and when will be able to set user exposed
variables like:

CopyPartialBuffer.Set_<variable name>(<value>);
