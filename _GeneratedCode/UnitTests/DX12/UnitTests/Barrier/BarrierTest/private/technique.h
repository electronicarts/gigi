...
namespace BarrierTest
{
    ...
    struct ContextInternal
    {
        ...
        static ID3D12PipelineState* computeShader_Draw_Left_pso;
        static ID3D12RootSignature* computeShader_Draw_Left_rootSig;

        static ID3D12PipelineState* computeShader_Draw_Right_pso;
        static ID3D12RootSignature* computeShader_Draw_Right_rootSig;

        static ID3D12PipelineState* computeShader_After_pso;
        static ID3D12RootSignature* computeShader_After_rootSig;
