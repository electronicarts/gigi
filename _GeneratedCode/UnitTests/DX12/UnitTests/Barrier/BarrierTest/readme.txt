...
BarrierTest::Context *m_BarrierTestContext = nullptr;

m_BarrierTestContext = BarrierTest::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

BarrierTest::OnNewFrame(FramesInFlight)
...
BarrierTest::DestroyContext(m_BarrierTestContext);
...
BarrierTest::Context::s_techniqueLocation = L"./"
...
m_BarrierTest.m_input.

BarrierTest::Execute(m_BarrierTest, m_device, m_commandList);
...
BarrierTest::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

BarrierTest::Context::PerfEventBeginFn
BarrierTest::Context::PerfEventEndFn
...
if (m_BarrierTest && ImGui::CollapsingHeader("BarrierTest"))
    outline::MakeUI(m_BarrierTest);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("BarrierTest", BarrierTest::CreateModule);

in the python module, you will need to "import BarrierTest", and when will be able to set user exposed
variables like:

BarrierTest.Set_<variable name>(<value>);
