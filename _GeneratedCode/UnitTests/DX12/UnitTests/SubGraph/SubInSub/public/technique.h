...
namespace SubInSub
{
    ...
    struct Context
    {
        ...
        struct ContextOutput
        {
            ...
            ID3D12Resource* texture_Inner1_Inner2_Output = nullptr;
            unsigned int texture_Inner1_Inner2_Output_size[3] = { 0, 0, 0 };
            unsigned int texture_Inner1_Inner2_Output_numMips = 0;
            DXGI_FORMAT texture_Inner1_Inner2_Output_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_Inner1_Inner2_Output_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_Inner1_Inner2_Output_endingState = D3D12_RESOURCE_STATE_COPY_SOURCE;
        };
