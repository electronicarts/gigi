...
SubInSub::Context *m_SubInSubContext = nullptr;

m_SubInSubContext = SubInSub::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

SubInSub::OnNewFrame(FramesInFlight)
...
SubInSub::DestroyContext(m_SubInSubContext);
...
SubInSub::Context::s_techniqueLocation = L"./"
...
SubInSub::Execute(m_SubInSub, m_device, m_commandList);
...
SubInSub::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

SubInSub::Context::PerfEventBeginFn
SubInSub::Context::PerfEventEndFn
...
if (m_SubInSub && ImGui::CollapsingHeader("SubInSub"))
    outline::MakeUI(m_SubInSub);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("SubInSub", SubInSub::CreateModule);

in the python module, you will need to "import SubInSub", and when will be able to set user exposed
variables like:

SubInSub.Set_<variable name>(<value>);
