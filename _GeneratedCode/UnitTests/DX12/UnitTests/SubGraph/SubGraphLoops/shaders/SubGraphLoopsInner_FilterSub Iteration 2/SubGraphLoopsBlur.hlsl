...
ConstantBuffer<Struct__FilterSub_Iteration_2_Blur_0CB> _FilterSub_Iteration_2_Blur_0CB : register(b0);
...
void main(uint3 DTid : SV_DispatchThreadID)
{
	...
	int radius = _FilterSub_Iteration_2_Blur_0CB.__loopIndexValue_2 + 1;
	...
	if ((bool)_FilterSub_Iteration_2_Blur_0CB.FilterSub_Iteration_2_sRGB)
