...
SubGraphLoops::Context *m_SubGraphLoopsContext = nullptr;

m_SubGraphLoopsContext = SubGraphLoops::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

SubGraphLoops::OnNewFrame(FramesInFlight)
...
SubGraphLoops::DestroyContext(m_SubGraphLoopsContext);
...
SubGraphLoops::Context::s_techniqueLocation = L"./"
...
m_SubGraphLoops.m_input.

SubGraphLoops::Execute(m_SubGraphLoops, m_device, m_commandList);
...
SubGraphLoops::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

SubGraphLoops::Context::PerfEventBeginFn
SubGraphLoops::Context::PerfEventEndFn
...
if (m_SubGraphLoops && ImGui::CollapsingHeader("SubGraphLoops"))
    outline::MakeUI(m_SubGraphLoops);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("SubGraphLoops", SubGraphLoops::CreateModule);

in the python module, you will need to "import SubGraphLoops", and when will be able to set user exposed
variables like:

SubGraphLoops.Set_<variable name>(<value>);
