...
namespace SubGraphLoops
{
    ...
    struct Context
    {
        ...
        {
            return "SubGraphLoops";
        }

        static const wchar_t* GetTechniqueNameW()
        {
            return L"SubGraphLoops";
        }
        ...
        struct ContextInput
        {
            ...
            // Variables
            int variable_FilterSub_Iteration_0_LoopIndex = 0;
            bool variable_FilterSub_Iteration_0_sRGB = true;
            int variable_FilterSub_Iteration_1_LoopIndex = 0;
            bool variable_FilterSub_Iteration_1_sRGB = true;
            int variable_FilterSub_Iteration_2_LoopIndex = 0;
            bool variable_FilterSub_Iteration_2_sRGB = true;
            int variable_FilterSub_Iteration_3_LoopIndex = 0;
            bool variable_FilterSub_Iteration_3_sRGB = true;
            int variable_FilterSub_Iteration_4_LoopIndex = 0;
            bool variable_FilterSub_Iteration_4_sRGB = true;
        ...
        struct ContextOutput
        {
            ...
            ID3D12Resource* texture_FilterSub_Iteration_0_Output = nullptr;
            unsigned int texture_FilterSub_Iteration_0_Output_size[3] = { 0, 0, 0 };
            unsigned int texture_FilterSub_Iteration_0_Output_numMips = 0;
            DXGI_FORMAT texture_FilterSub_Iteration_0_Output_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_FilterSub_Iteration_0_Output_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_FilterSub_Iteration_0_Output_endingState = D3D12_RESOURCE_STATE_COPY_SOURCE;

            ID3D12Resource* texture_FilterSub_Iteration_1_Output = nullptr;
            unsigned int texture_FilterSub_Iteration_1_Output_size[3] = { 0, 0, 0 };
            unsigned int texture_FilterSub_Iteration_1_Output_numMips = 0;
            DXGI_FORMAT texture_FilterSub_Iteration_1_Output_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_FilterSub_Iteration_1_Output_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_FilterSub_Iteration_1_Output_endingState = D3D12_RESOURCE_STATE_COPY_SOURCE;

            ID3D12Resource* texture_FilterSub_Iteration_2_Output = nullptr;
            unsigned int texture_FilterSub_Iteration_2_Output_size[3] = { 0, 0, 0 };
            unsigned int texture_FilterSub_Iteration_2_Output_numMips = 0;
            DXGI_FORMAT texture_FilterSub_Iteration_2_Output_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_FilterSub_Iteration_2_Output_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_FilterSub_Iteration_2_Output_endingState = D3D12_RESOURCE_STATE_COPY_SOURCE;

            ID3D12Resource* texture_FilterSub_Iteration_3_Output = nullptr;
            unsigned int texture_FilterSub_Iteration_3_Output_size[3] = { 0, 0, 0 };
            unsigned int texture_FilterSub_Iteration_3_Output_numMips = 0;
            DXGI_FORMAT texture_FilterSub_Iteration_3_Output_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_FilterSub_Iteration_3_Output_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_FilterSub_Iteration_3_Output_endingState = D3D12_RESOURCE_STATE_COPY_SOURCE;

            ID3D12Resource* texture_FilterSub_Iteration_4_Output = nullptr;
            unsigned int texture_FilterSub_Iteration_4_Output_size[3] = { 0, 0, 0 };
            unsigned int texture_FilterSub_Iteration_4_Output_numMips = 0;
            DXGI_FORMAT texture_FilterSub_Iteration_4_Output_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_FilterSub_Iteration_4_Output_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_FilterSub_Iteration_4_Output_endingState = D3D12_RESOURCE_STATE_COPY_SOURCE;
        };
    ...
    private:
        ...
        ProfileEntry m_profileData[10+1]; // One for each action node, and another for the total
    };
