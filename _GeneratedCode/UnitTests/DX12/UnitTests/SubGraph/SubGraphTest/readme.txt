...
SubGraphTest::Context *m_SubGraphTestContext = nullptr;

m_SubGraphTestContext = SubGraphTest::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

SubGraphTest::OnNewFrame(FramesInFlight)
...
SubGraphTest::DestroyContext(m_SubGraphTestContext);
...
SubGraphTest::Context::s_techniqueLocation = L"./"
...
m_SubGraphTest.m_input.

SubGraphTest::Execute(m_SubGraphTest, m_device, m_commandList);
...
SubGraphTest::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

SubGraphTest::Context::PerfEventBeginFn
SubGraphTest::Context::PerfEventEndFn
...
if (m_SubGraphTest && ImGui::CollapsingHeader("SubGraphTest"))
    outline::MakeUI(m_SubGraphTest);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("SubGraphTest", SubGraphTest::CreateModule);

in the python module, you will need to "import SubGraphTest", and when will be able to set user exposed
variables like:

SubGraphTest.Set_<variable name>(<value>);
