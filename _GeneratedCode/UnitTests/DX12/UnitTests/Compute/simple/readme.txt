...
simple::Context *m_simpleContext = nullptr;

m_simpleContext = simple::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

simple::OnNewFrame(FramesInFlight)
...
simple::DestroyContext(m_simpleContext);
...
simple::Context::s_techniqueLocation = L"./"
...
simple::Execute(m_simple, m_device, m_commandList);
...
simple::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

simple::Context::PerfEventBeginFn
simple::Context::PerfEventEndFn
...
if (m_simple && ImGui::CollapsingHeader("simple"))
    outline::MakeUI(m_simple);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("simple", simple::CreateModule);

in the python module, you will need to "import simple", and when will be able to set user exposed
variables like:

simple.Set_<variable name>(<value>);
