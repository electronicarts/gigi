...
Defines::Context *m_DefinesContext = nullptr;

m_DefinesContext = Defines::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Defines::OnNewFrame(FramesInFlight)
...
Defines::DestroyContext(m_DefinesContext);
...
Defines::Context::s_techniqueLocation = L"./"
...
Defines::Execute(m_Defines, m_device, m_commandList);
...
Defines::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Defines::Context::PerfEventBeginFn
Defines::Context::PerfEventEndFn
...
if (m_Defines && ImGui::CollapsingHeader("Defines"))
    outline::MakeUI(m_Defines);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Defines", Defines::CreateModule);

in the python module, you will need to "import Defines", and when will be able to set user exposed
variables like:

Defines.Set_<variable name>(<value>);
