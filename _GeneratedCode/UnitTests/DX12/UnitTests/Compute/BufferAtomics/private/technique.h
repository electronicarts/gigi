...
namespace BufferAtomics
{
    ...
    struct ContextInternal
    {
        ...
        static ID3D12PipelineState* computeShader_ClearBuffer_pso;
        static ID3D12RootSignature* computeShader_ClearBuffer_rootSig;

        static ID3D12PipelineState* computeShader_RunShader_pso;
        static ID3D12RootSignature* computeShader_RunShader_rootSig;
