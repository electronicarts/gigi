...
namespace IndirectDispatch
{
    ...
    struct Context
    {
        ...
        struct ContextInput
        {
            ...
            // Variables
            uint3 variable_Dispatch_Count_1 = {50, 50, 1};
            uint3 variable_Dispatch_Count_2 = {100, 100, 1};
            int variable_Second_Dispatch_Offset = 2;
        };
        ...
        struct ContextOutput
        {
            ...
            ID3D12Resource* texture_Render_Target = nullptr;
            unsigned int texture_Render_Target_size[3] = { 0, 0, 0 };
            unsigned int texture_Render_Target_numMips = 0;
            DXGI_FORMAT texture_Render_Target_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_Render_Target_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_Render_Target_endingState = D3D12_RESOURCE_STATE_UNORDERED_ACCESS;
        };
