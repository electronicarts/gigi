...
IndirectDispatch::Context *m_IndirectDispatchContext = nullptr;

m_IndirectDispatchContext = IndirectDispatch::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

IndirectDispatch::OnNewFrame(FramesInFlight)
...
IndirectDispatch::DestroyContext(m_IndirectDispatchContext);
...
IndirectDispatch::Context::s_techniqueLocation = L"./"
...
m_IndirectDispatch.m_input.

IndirectDispatch::Execute(m_IndirectDispatch, m_device, m_commandList);
...
IndirectDispatch::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

IndirectDispatch::Context::PerfEventBeginFn
IndirectDispatch::Context::PerfEventEndFn
...
if (m_IndirectDispatch && ImGui::CollapsingHeader("IndirectDispatch"))
    outline::MakeUI(m_IndirectDispatch);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("IndirectDispatch", IndirectDispatch::CreateModule);

in the python module, you will need to "import IndirectDispatch", and when will be able to set user exposed
variables like:

IndirectDispatch.Set_<variable name>(<value>);
