...
namespace boxblur
{
    ...
    struct Context
    {
        ...
        struct ContextInput
        {
            ...
            unsigned int texture_InputTexture_size[3] = { 0, 0, 0 };
            DXGI_FORMAT texture_InputTexture_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_InputTexture_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            D3D12_RESOURCE_STATES texture_InputTexture_state = D3D12_RESOURCE_STATE_COMMON;
        };
