...
boxblur::Context *m_boxblurContext = nullptr;

m_boxblurContext = boxblur::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

boxblur::OnNewFrame(FramesInFlight)
...
boxblur::DestroyContext(m_boxblurContext);
...
boxblur::Context::s_techniqueLocation = L"./"
...
boxblur::Execute(m_boxblur, m_device, m_commandList);
...
boxblur::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

boxblur::Context::PerfEventBeginFn
boxblur::Context::PerfEventEndFn
...
if (m_boxblur && ImGui::CollapsingHeader("boxblur"))
    outline::MakeUI(m_boxblur);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("boxblur", boxblur::CreateModule);

in the python module, you will need to "import boxblur", and when will be able to set user exposed
variables like:

boxblur.Set_<variable name>(<value>);
