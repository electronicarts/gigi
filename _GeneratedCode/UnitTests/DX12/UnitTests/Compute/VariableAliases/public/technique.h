...
namespace VariableAliases
{
    ...
    struct Context
    {
        ...
        struct ContextInput
        {
            ...
            // Variables
            uint2 variable_RenderSize = {32, 32};
            int variable_Node1Channel = 0;
            float variable_Node1Value = 0.25f;
            int variable_Node2Channel = 1;
            float variable_Node2Value = 0.5f;
