...
namespace SlangAutoDiff
{
    ...
    bool CreateShared(ID3D12Device* device)
    {
        ...
        // Compute Shader: Initialize
        {
            ...
            if(!DX12Utils::MakeComputePSO_DXC(device, Context::s_techniqueLocation.c_str(), L"shaders/SlangAutoDiff_Initialize.hlsl", "csmain", "cs_6_1", defines,
               ContextInternal::computeShader_Initialize_rootSig, &ContextInternal::computeShader_Initialize_pso, c_debugShaders, (c_debugNames ? L"Initialize" : nullptr), Context::LogFn))
                return false;
        }
        ...
        // Compute Shader: GradientDescend
        {
            ...
            if(!DX12Utils::MakeComputePSO_DXC(device, Context::s_techniqueLocation.c_str(), L"shaders/SlangAutoDiff_Descend.hlsl", "csmain", "cs_6_1", defines,
               ContextInternal::computeShader_GradientDescend_rootSig, &ContextInternal::computeShader_GradientDescend_pso, c_debugShaders, (c_debugNames ? L"GradientDescend" : nullptr), Context::LogFn))
                return false;
        }
        ...
        // Compute Shader: Render
        {
            ...
            if(!DX12Utils::MakeComputePSO_DXC(device, Context::s_techniqueLocation.c_str(), L"shaders/SlangAutoDiff_Render.hlsl", "csmain", "cs_6_1", defines,
               ContextInternal::computeShader_Render_rootSig, &ContextInternal::computeShader_Render_pso, c_debugShaders, (c_debugNames ? L"Render" : nullptr), Context::LogFn))
                return false;
        }
    ...
    void Execute(Context* context, ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
    {
        ...
        // Compute Shader: Initialize
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                { context->m_internal.buffer_Data, context->m_internal.buffer_Data_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Buffer, false, context->m_internal.buffer_Data_stride, context->m_internal.buffer_Data_count },
                { context->m_internal.constantBuffer__InitCB, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::CBV, DX12Utils::ResourceType::Buffer, false, 256, 1 }
            };
        ...
        // Compute Shader: GradientDescend
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                { context->m_internal.buffer_Data, context->m_internal.buffer_Data_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Buffer, false, context->m_internal.buffer_Data_stride, context->m_internal.buffer_Data_count },
                { context->m_internal.constantBuffer__DescendCB, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::CBV, DX12Utils::ResourceType::Buffer, false, 256, 1 }
            };
        ...
        // Compute Shader: Render
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                { context->m_internal.buffer_Data, context->m_internal.buffer_Data_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::Buffer, false, context->m_internal.buffer_Data_stride, context->m_internal.buffer_Data_count },
                ...
                { context->m_internal.constantBuffer__RenderCB, DXGI_FORMAT_UNKNOWN, DX12Utils::AccessType::CBV, DX12Utils::ResourceType::Buffer, false, 256, 1 }
            };
