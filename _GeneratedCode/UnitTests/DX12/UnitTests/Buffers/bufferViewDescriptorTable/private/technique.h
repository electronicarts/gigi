...
namespace bufferViewDescriptorTable
{
    ...
    struct ContextInternal
    {
        ...
        static ID3D12PipelineState* computeShader_Write1_pso;
        static ID3D12RootSignature* computeShader_Write1_rootSig;

        static ID3D12PipelineState* computeShader_Write2_pso;
        static ID3D12RootSignature* computeShader_Write2_rootSig;
