...
bufferViewDescriptorTable::Context *m_bufferViewDescriptorTableContext = nullptr;

m_bufferViewDescriptorTableContext = bufferViewDescriptorTable::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

bufferViewDescriptorTable::OnNewFrame(FramesInFlight)
...
bufferViewDescriptorTable::DestroyContext(m_bufferViewDescriptorTableContext);
...
bufferViewDescriptorTable::Context::s_techniqueLocation = L"./"
...
m_bufferViewDescriptorTable.m_input.

bufferViewDescriptorTable::Execute(m_bufferViewDescriptorTable, m_device, m_commandList);
...
bufferViewDescriptorTable::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

bufferViewDescriptorTable::Context::PerfEventBeginFn
bufferViewDescriptorTable::Context::PerfEventEndFn
...
if (m_bufferViewDescriptorTable && ImGui::CollapsingHeader("bufferViewDescriptorTable"))
    outline::MakeUI(m_bufferViewDescriptorTable);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("bufferViewDescriptorTable", bufferViewDescriptorTable::CreateModule);

in the python module, you will need to "import bufferViewDescriptorTable", and when will be able to set user exposed
variables like:

bufferViewDescriptorTable.Set_<variable name>(<value>);
