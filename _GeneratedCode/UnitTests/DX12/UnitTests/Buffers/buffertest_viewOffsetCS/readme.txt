...
buffertest_viewOffsetCS::Context *m_buffertest_viewOffsetCSContext = nullptr;

m_buffertest_viewOffsetCSContext = buffertest_viewOffsetCS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

buffertest_viewOffsetCS::OnNewFrame(FramesInFlight)
...
buffertest_viewOffsetCS::DestroyContext(m_buffertest_viewOffsetCSContext);
...
buffertest_viewOffsetCS::Context::s_techniqueLocation = L"./"
...
m_buffertest_viewOffsetCS.m_input.

buffertest_viewOffsetCS::Execute(m_buffertest_viewOffsetCS, m_device, m_commandList);
...
buffertest_viewOffsetCS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

buffertest_viewOffsetCS::Context::PerfEventBeginFn
buffertest_viewOffsetCS::Context::PerfEventEndFn
...
if (m_buffertest_viewOffsetCS && ImGui::CollapsingHeader("buffertest_viewOffsetCS"))
    outline::MakeUI(m_buffertest_viewOffsetCS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("buffertest_viewOffsetCS", buffertest_viewOffsetCS::CreateModule);

in the python module, you will need to "import buffertest_viewOffsetCS", and when will be able to set user exposed
variables like:

buffertest_viewOffsetCS.Set_<variable name>(<value>);
