...
MultipleUVMesh::Context *m_MultipleUVMeshContext = nullptr;

m_MultipleUVMeshContext = MultipleUVMesh::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

MultipleUVMesh::OnNewFrame(FramesInFlight)
...
MultipleUVMesh::DestroyContext(m_MultipleUVMeshContext);
...
MultipleUVMesh::Context::s_techniqueLocation = L"./"
...
m_MultipleUVMesh.m_input.

MultipleUVMesh::Execute(m_MultipleUVMesh, m_device, m_commandList);
...
MultipleUVMesh::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

MultipleUVMesh::Context::PerfEventBeginFn
MultipleUVMesh::Context::PerfEventEndFn
...
if (m_MultipleUVMesh && ImGui::CollapsingHeader("MultipleUVMesh"))
    outline::MakeUI(m_MultipleUVMesh);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("MultipleUVMesh", MultipleUVMesh::CreateModule);

in the python module, you will need to "import MultipleUVMesh", and when will be able to set user exposed
variables like:

MultipleUVMesh.Set_<variable name>(<value>);
