...
StructuredBuffer::Context *m_StructuredBufferContext = nullptr;

m_StructuredBufferContext = StructuredBuffer::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

StructuredBuffer::OnNewFrame(FramesInFlight)
...
StructuredBuffer::DestroyContext(m_StructuredBufferContext);
...
StructuredBuffer::Context::s_techniqueLocation = L"./"
...
m_StructuredBuffer.m_input.

StructuredBuffer::Execute(m_StructuredBuffer, m_device, m_commandList);
...
StructuredBuffer::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

StructuredBuffer::Context::PerfEventBeginFn
StructuredBuffer::Context::PerfEventEndFn
...
if (m_StructuredBuffer && ImGui::CollapsingHeader("StructuredBuffer"))
    outline::MakeUI(m_StructuredBuffer);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("StructuredBuffer", StructuredBuffer::CreateModule);

in the python module, you will need to "import StructuredBuffer", and when will be able to set user exposed
variables like:

StructuredBuffer.Set_<variable name>(<value>);
