...
buffertest::Context *m_buffertestContext = nullptr;

m_buffertestContext = buffertest::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

buffertest::OnNewFrame(FramesInFlight)
...
buffertest::DestroyContext(m_buffertestContext);
...
buffertest::Context::s_techniqueLocation = L"./"
...
m_buffertest.m_input.

buffertest::Execute(m_buffertest, m_device, m_commandList);
...
buffertest::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

buffertest::Context::PerfEventBeginFn
buffertest::Context::PerfEventEndFn
...
if (m_buffertest && ImGui::CollapsingHeader("buffertest"))
    outline::MakeUI(m_buffertest);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("buffertest", buffertest::CreateModule);

in the python module, you will need to "import buffertest", and when will be able to set user exposed
variables like:

buffertest.Set_<variable name>(<value>);
