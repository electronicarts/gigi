...
namespace buffertest_viewOffsetCS_Vars
{
    ...
    void Execute(Context* context, ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
    {
        ...
        ScopedPerfEvent scopedPerf("buffertest_viewOffsetCS_Vars", commandList, 10);
        ...
        if(context->m_profile)
        {
            ...
            if(context->m_internal.m_TimestampQueryHeap == nullptr)
            {
                ...
                if (c_debugNames)
                    context->m_internal.m_TimestampQueryHeap->SetName(L"buffertest_viewOffsetCS_Vars Time Stamp Query Heap");

                context->m_internal.m_TimestampReadbackBuffer = DX12Utils::CreateBuffer(device, sizeof(uint64_t) * (1+1) * 2, D3D12_RESOURCE_FLAG_NONE, D3D12_RESOURCE_STATE_COPY_DEST, D3D12_HEAP_TYPE_READBACK, (c_debugNames ? L"buffertest_viewOffsetCS_Vars Time Stamp Query Heap" : nullptr), nullptr);
            }
        ...
        {
            Context::LogFn(LogLevel::Error, "buffertest_viewOffsetCS_Vars: Imported buffer \"InputTypedBuffer\" is null.\n");
            return;
        }

        if (!context->m_input.buffer_InputStructuredBuffer)
        {
            Context::LogFn(LogLevel::Error, "buffertest_viewOffsetCS_Vars: Imported buffer \"InputStructuredBuffer\" is null.\n");
            return;
        }

        if (!context->m_input.buffer_InputTypedBufferRaw)
        {
            Context::LogFn(LogLevel::Error, "buffertest_viewOffsetCS_Vars: Imported buffer \"InputTypedBufferRaw\" is null.\n");
            return;
        }

        if (!context->m_input.buffer_InputTypedStructBuffer)
        {
            Context::LogFn(LogLevel::Error, "buffertest_viewOffsetCS_Vars: Imported buffer \"InputTypedStructBuffer\" is null.\n");
            return;
        }
        ...
        // BufferTest compute shader
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                { context->m_input.buffer_InputTypedBuffer, context->m_input.buffer_InputTypedBuffer_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::Buffer, false, context->m_input.buffer_InputTypedBuffer_stride, context->m_input.buffer_InputTypedBuffer_count, 0, (UINT)context->m_internal.variable_InputTypedBufferBegin, (UINT)context->m_internal.variable_InputTypedBufferSize, false },
                { context->m_output.buffer_OutputTypedBuffer, context->m_output.buffer_OutputTypedBuffer_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Buffer, false, context->m_output.buffer_OutputTypedBuffer_stride, context->m_output.buffer_OutputTypedBuffer_count, 0, (UINT)context->m_internal.variable_OutputTypedBufferBegin, (UINT)context->m_internal.variable_OutputTypedBufferSize, false },
                { context->m_input.buffer_InputTypedStructBuffer, context->m_input.buffer_InputTypedStructBuffer_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::Buffer, false, context->m_input.buffer_InputTypedStructBuffer_stride, context->m_input.buffer_InputTypedStructBuffer_count, 0, (UINT)context->m_internal.variable_InputTypedStructBufferBegin, (UINT)context->m_internal.variable_InputTypedStructBufferSize, false },
                { context->m_output.buffer_OutputTypedStructBuffer, context->m_output.buffer_OutputTypedStructBuffer_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Buffer, false, context->m_output.buffer_OutputTypedStructBuffer_stride, context->m_output.buffer_OutputTypedStructBuffer_count, 0, (UINT)context->m_internal.variable_OutputTypedStructBufferBegin, (UINT)context->m_internal.variable_OutputTypedStructBufferSize, true },
                { context->m_input.buffer_InputStructuredBuffer, context->m_input.buffer_InputStructuredBuffer_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::Buffer, false, context->m_input.buffer_InputStructuredBuffer_stride, context->m_input.buffer_InputStructuredBuffer_count, 0, (UINT)context->m_internal.variable_InputStructuredBufferBegin, (UINT)context->m_internal.variable_InputStructuredBufferSize, false },
                { context->m_output.buffer_OutputStructuredBuffer, context->m_output.buffer_OutputStructuredBuffer_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Buffer, false, context->m_output.buffer_OutputStructuredBuffer_stride, context->m_output.buffer_OutputStructuredBuffer_count, 0, (UINT)context->m_internal.variable_OutputStructuredBufferBegin, (UINT)context->m_internal.variable_OutputStructuredBufferSize, false },
                { context->m_input.buffer_InputTypedBufferRaw, context->m_input.buffer_InputTypedBufferRaw_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::Buffer, true, context->m_input.buffer_InputTypedBufferRaw_stride, context->m_input.buffer_InputTypedBufferRaw_count, 0, (UINT)context->m_internal.variable_InputTypedBufferRawBegin, (UINT)context->m_internal.variable_InputTypedBufferRawSize, false },
                { context->m_output.buffer_OutputTypedBufferRaw, context->m_output.buffer_OutputTypedBufferRaw_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Buffer, true, context->m_output.buffer_OutputTypedBufferRaw_stride, context->m_output.buffer_OutputTypedBufferRaw_count, 0, (UINT)context->m_internal.variable_OutputTypedBufferRawBegin, (UINT)context->m_internal.variable_OutputTypedBufferRawSize, true },
