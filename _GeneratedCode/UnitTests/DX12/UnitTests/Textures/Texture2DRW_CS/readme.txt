...
Texture2DRW_CS::Context *m_Texture2DRW_CSContext = nullptr;

m_Texture2DRW_CSContext = Texture2DRW_CS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture2DRW_CS::OnNewFrame(FramesInFlight)
...
Texture2DRW_CS::DestroyContext(m_Texture2DRW_CSContext);
...
Texture2DRW_CS::Context::s_techniqueLocation = L"./"
...
m_Texture2DRW_CS.m_input.

Texture2DRW_CS::Execute(m_Texture2DRW_CS, m_device, m_commandList);
...
Texture2DRW_CS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture2DRW_CS::Context::PerfEventBeginFn
Texture2DRW_CS::Context::PerfEventEndFn
...
if (m_Texture2DRW_CS && ImGui::CollapsingHeader("Texture2DRW_CS"))
    outline::MakeUI(m_Texture2DRW_CS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture2DRW_CS", Texture2DRW_CS::CreateModule);

in the python module, you will need to "import Texture2DRW_CS", and when will be able to set user exposed
variables like:

Texture2DRW_CS.Set_<variable name>(<value>);
