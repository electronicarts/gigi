...
Texture2DRW_PS::Context *m_Texture2DRW_PSContext = nullptr;

m_Texture2DRW_PSContext = Texture2DRW_PS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture2DRW_PS::OnNewFrame(FramesInFlight)
...
Texture2DRW_PS::DestroyContext(m_Texture2DRW_PSContext);
...
Texture2DRW_PS::Context::s_techniqueLocation = L"./"
...
m_Texture2DRW_PS.m_input.

Texture2DRW_PS::Execute(m_Texture2DRW_PS, m_device, m_commandList);
...
Texture2DRW_PS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture2DRW_PS::Context::PerfEventBeginFn
Texture2DRW_PS::Context::PerfEventEndFn
...
if (m_Texture2DRW_PS && ImGui::CollapsingHeader("Texture2DRW_PS"))
    outline::MakeUI(m_Texture2DRW_PS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture2DRW_PS", Texture2DRW_PS::CreateModule);

in the python module, you will need to "import Texture2DRW_PS", and when will be able to set user exposed
variables like:

Texture2DRW_PS.Set_<variable name>(<value>);
