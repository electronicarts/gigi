...
Texture3DRW_RGS::Context *m_Texture3DRW_RGSContext = nullptr;

m_Texture3DRW_RGSContext = Texture3DRW_RGS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture3DRW_RGS::OnNewFrame(FramesInFlight)
...
Texture3DRW_RGS::DestroyContext(m_Texture3DRW_RGSContext);
...
Texture3DRW_RGS::Context::s_techniqueLocation = L"./"
...
m_Texture3DRW_RGS.m_input.

Texture3DRW_RGS::Execute(m_Texture3DRW_RGS, m_device, m_commandList);
...
Texture3DRW_RGS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture3DRW_RGS::Context::PerfEventBeginFn
Texture3DRW_RGS::Context::PerfEventEndFn
...
if (m_Texture3DRW_RGS && ImGui::CollapsingHeader("Texture3DRW_RGS"))
    outline::MakeUI(m_Texture3DRW_RGS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture3DRW_RGS", Texture3DRW_RGS::CreateModule);

in the python module, you will need to "import Texture3DRW_RGS", and when will be able to set user exposed
variables like:

Texture3DRW_RGS.Set_<variable name>(<value>);
