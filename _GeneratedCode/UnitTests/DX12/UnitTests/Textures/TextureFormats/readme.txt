...
TextureFormats::Context *m_TextureFormatsContext = nullptr;

m_TextureFormatsContext = TextureFormats::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

TextureFormats::OnNewFrame(FramesInFlight)
...
TextureFormats::DestroyContext(m_TextureFormatsContext);
...
TextureFormats::Context::s_techniqueLocation = L"./"
...
m_TextureFormats.m_input.

TextureFormats::Execute(m_TextureFormats, m_device, m_commandList);
...
TextureFormats::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

TextureFormats::Context::PerfEventBeginFn
TextureFormats::Context::PerfEventEndFn
...
if (m_TextureFormats && ImGui::CollapsingHeader("TextureFormats"))
    outline::MakeUI(m_TextureFormats);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("TextureFormats", TextureFormats::CreateModule);

in the python module, you will need to "import TextureFormats", and when will be able to set user exposed
variables like:

TextureFormats.Set_<variable name>(<value>);
