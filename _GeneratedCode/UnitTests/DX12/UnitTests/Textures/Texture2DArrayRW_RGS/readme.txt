...
Texture2DArrayRW_RGS::Context *m_Texture2DArrayRW_RGSContext = nullptr;

m_Texture2DArrayRW_RGSContext = Texture2DArrayRW_RGS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture2DArrayRW_RGS::OnNewFrame(FramesInFlight)
...
Texture2DArrayRW_RGS::DestroyContext(m_Texture2DArrayRW_RGSContext);
...
Texture2DArrayRW_RGS::Context::s_techniqueLocation = L"./"
...
m_Texture2DArrayRW_RGS.m_input.

Texture2DArrayRW_RGS::Execute(m_Texture2DArrayRW_RGS, m_device, m_commandList);
...
Texture2DArrayRW_RGS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture2DArrayRW_RGS::Context::PerfEventBeginFn
Texture2DArrayRW_RGS::Context::PerfEventEndFn
...
if (m_Texture2DArrayRW_RGS && ImGui::CollapsingHeader("Texture2DArrayRW_RGS"))
    outline::MakeUI(m_Texture2DArrayRW_RGS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture2DArrayRW_RGS", Texture2DArrayRW_RGS::CreateModule);

in the python module, you will need to "import Texture2DArrayRW_RGS", and when will be able to set user exposed
variables like:

Texture2DArrayRW_RGS.Set_<variable name>(<value>);
