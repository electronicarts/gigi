...
TextureCubeRW_PS::Context *m_TextureCubeRW_PSContext = nullptr;

m_TextureCubeRW_PSContext = TextureCubeRW_PS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

TextureCubeRW_PS::OnNewFrame(FramesInFlight)
...
TextureCubeRW_PS::DestroyContext(m_TextureCubeRW_PSContext);
...
TextureCubeRW_PS::Context::s_techniqueLocation = L"./"
...
m_TextureCubeRW_PS.m_input.

TextureCubeRW_PS::Execute(m_TextureCubeRW_PS, m_device, m_commandList);
...
TextureCubeRW_PS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

TextureCubeRW_PS::Context::PerfEventBeginFn
TextureCubeRW_PS::Context::PerfEventEndFn
...
if (m_TextureCubeRW_PS && ImGui::CollapsingHeader("TextureCubeRW_PS"))
    outline::MakeUI(m_TextureCubeRW_PS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("TextureCubeRW_PS", TextureCubeRW_PS::CreateModule);

in the python module, you will need to "import TextureCubeRW_PS", and when will be able to set user exposed
variables like:

TextureCubeRW_PS.Set_<variable name>(<value>);
