...
Mips_CS_2D::Context *m_Mips_CS_2DContext = nullptr;

m_Mips_CS_2DContext = Mips_CS_2D::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_CS_2D::OnNewFrame(FramesInFlight)
...
Mips_CS_2D::DestroyContext(m_Mips_CS_2DContext);
...
Mips_CS_2D::Context::s_techniqueLocation = L"./"
...
m_Mips_CS_2D.m_input.

Mips_CS_2D::Execute(m_Mips_CS_2D, m_device, m_commandList);
...
Mips_CS_2D::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_CS_2D::Context::PerfEventBeginFn
Mips_CS_2D::Context::PerfEventEndFn
...
if (m_Mips_CS_2D && ImGui::CollapsingHeader("Mips_CS_2D"))
    outline::MakeUI(m_Mips_CS_2D);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_CS_2D", Mips_CS_2D::CreateModule);

in the python module, you will need to "import Mips_CS_2D", and when will be able to set user exposed
variables like:

Mips_CS_2D.Set_<variable name>(<value>);
