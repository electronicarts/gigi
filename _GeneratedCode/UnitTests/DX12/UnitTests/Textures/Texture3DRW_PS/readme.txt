...
Texture3DRW_PS::Context *m_Texture3DRW_PSContext = nullptr;

m_Texture3DRW_PSContext = Texture3DRW_PS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture3DRW_PS::OnNewFrame(FramesInFlight)
...
Texture3DRW_PS::DestroyContext(m_Texture3DRW_PSContext);
...
Texture3DRW_PS::Context::s_techniqueLocation = L"./"
...
m_Texture3DRW_PS.m_input.

Texture3DRW_PS::Execute(m_Texture3DRW_PS, m_device, m_commandList);
...
Texture3DRW_PS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture3DRW_PS::Context::PerfEventBeginFn
Texture3DRW_PS::Context::PerfEventEndFn
...
if (m_Texture3DRW_PS && ImGui::CollapsingHeader("Texture3DRW_PS"))
    outline::MakeUI(m_Texture3DRW_PS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture3DRW_PS", Texture3DRW_PS::CreateModule);

in the python module, you will need to "import Texture3DRW_PS", and when will be able to set user exposed
variables like:

Texture3DRW_PS.Set_<variable name>(<value>);
