...
namespace Mips_CS_Cube
{
    ...
    struct ContextInternal
    {
        ...
        static ID3D12PipelineState* computeShader_Mip0_pso;
        static ID3D12RootSignature* computeShader_Mip0_rootSig;

        static ID3D12PipelineState* computeShader_Mip1_pso;
        static ID3D12RootSignature* computeShader_Mip1_rootSig;

        static ID3D12PipelineState* computeShader_Mip2_pso;
        static ID3D12RootSignature* computeShader_Mip2_rootSig;

        static ID3D12PipelineState* computeShader_Mip3_pso;
        static ID3D12RootSignature* computeShader_Mip3_rootSig;
