...
Mips_DrawCall::Context *m_Mips_DrawCallContext = nullptr;

m_Mips_DrawCallContext = Mips_DrawCall::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_DrawCall::OnNewFrame(FramesInFlight)
...
Mips_DrawCall::DestroyContext(m_Mips_DrawCallContext);
...
Mips_DrawCall::Context::s_techniqueLocation = L"./"
...
m_Mips_DrawCall.m_input.

Mips_DrawCall::Execute(m_Mips_DrawCall, m_device, m_commandList);
...
Mips_DrawCall::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_DrawCall::Context::PerfEventBeginFn
Mips_DrawCall::Context::PerfEventEndFn
...
if (m_Mips_DrawCall && ImGui::CollapsingHeader("Mips_DrawCall"))
    outline::MakeUI(m_Mips_DrawCall);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_DrawCall", Mips_DrawCall::CreateModule);

in the python module, you will need to "import Mips_DrawCall", and when will be able to set user exposed
variables like:

Mips_DrawCall.Set_<variable name>(<value>);
