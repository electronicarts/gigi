...
Mips_ShaderToken_3D::Context *m_Mips_ShaderToken_3DContext = nullptr;

m_Mips_ShaderToken_3DContext = Mips_ShaderToken_3D::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_ShaderToken_3D::OnNewFrame(FramesInFlight)
...
Mips_ShaderToken_3D::DestroyContext(m_Mips_ShaderToken_3DContext);
...
Mips_ShaderToken_3D::Context::s_techniqueLocation = L"./"
...
m_Mips_ShaderToken_3D.m_input.

Mips_ShaderToken_3D::Execute(m_Mips_ShaderToken_3D, m_device, m_commandList);
...
Mips_ShaderToken_3D::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_ShaderToken_3D::Context::PerfEventBeginFn
Mips_ShaderToken_3D::Context::PerfEventEndFn
...
if (m_Mips_ShaderToken_3D && ImGui::CollapsingHeader("Mips_ShaderToken_3D"))
    outline::MakeUI(m_Mips_ShaderToken_3D);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_ShaderToken_3D", Mips_ShaderToken_3D::CreateModule);

in the python module, you will need to "import Mips_ShaderToken_3D", and when will be able to set user exposed
variables like:

Mips_ShaderToken_3D.Set_<variable name>(<value>);
