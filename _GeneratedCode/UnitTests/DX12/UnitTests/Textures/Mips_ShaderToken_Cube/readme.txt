...
Mips_ShaderToken_Cube::Context *m_Mips_ShaderToken_CubeContext = nullptr;

m_Mips_ShaderToken_CubeContext = Mips_ShaderToken_Cube::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_ShaderToken_Cube::OnNewFrame(FramesInFlight)
...
Mips_ShaderToken_Cube::DestroyContext(m_Mips_ShaderToken_CubeContext);
...
Mips_ShaderToken_Cube::Context::s_techniqueLocation = L"./"
...
m_Mips_ShaderToken_Cube.m_input.

Mips_ShaderToken_Cube::Execute(m_Mips_ShaderToken_Cube, m_device, m_commandList);
...
Mips_ShaderToken_Cube::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_ShaderToken_Cube::Context::PerfEventBeginFn
Mips_ShaderToken_Cube::Context::PerfEventEndFn
...
if (m_Mips_ShaderToken_Cube && ImGui::CollapsingHeader("Mips_ShaderToken_Cube"))
    outline::MakeUI(m_Mips_ShaderToken_Cube);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_ShaderToken_Cube", Mips_ShaderToken_Cube::CreateModule);

in the python module, you will need to "import Mips_ShaderToken_Cube", and when will be able to set user exposed
variables like:

Mips_ShaderToken_Cube.Set_<variable name>(<value>);
