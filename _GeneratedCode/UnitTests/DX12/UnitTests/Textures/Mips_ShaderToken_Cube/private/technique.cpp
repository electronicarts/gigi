...
namespace Mips_ShaderToken_Cube
{
    ...
    bool CreateShared(ID3D12Device* device)
    {
        ...
        // Compute Shader: MakeOutput
        {
            ...
            if(!DX12Utils::MakeComputePSO_DXC(device, Context::s_techniqueLocation.c_str(), L"shaders/Mips_ShaderToken_Cube_CS.hlsl", "main", "cs_6_1", defines,
               ContextInternal::computeShader_MakeOutput_rootSig, &ContextInternal::computeShader_MakeOutput_pso, c_debugShaders, (c_debugNames ? L"MakeOutput" : nullptr), Context::LogFn))
                return false;
        }
    ...
    void Execute(Context* context, ID3D12Device* device, ID3D12GraphicsCommandList* commandList)
    {
        ...
        // Compute Shader: MakeOutput
        {
            ...
            DX12Utils::ResourceDescriptor descriptors[] = {
                { context->m_internal.texture_Output, context->m_internal.texture_Output_format, DX12Utils::AccessType::UAV, DX12Utils::ResourceType::Texture2D, false, 0, 0, 0 },
                { context->m_internal.texture__loadedTexture_0, context->m_internal.texture__loadedTexture_0_format, DX12Utils::AccessType::SRV, DX12Utils::ResourceType::TextureCube, false, 0, 6, 0 }
            };
