...
Mips_CS_2DArray::Context *m_Mips_CS_2DArrayContext = nullptr;

m_Mips_CS_2DArrayContext = Mips_CS_2DArray::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_CS_2DArray::OnNewFrame(FramesInFlight)
...
Mips_CS_2DArray::DestroyContext(m_Mips_CS_2DArrayContext);
...
Mips_CS_2DArray::Context::s_techniqueLocation = L"./"
...
m_Mips_CS_2DArray.m_input.

Mips_CS_2DArray::Execute(m_Mips_CS_2DArray, m_device, m_commandList);
...
Mips_CS_2DArray::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_CS_2DArray::Context::PerfEventBeginFn
Mips_CS_2DArray::Context::PerfEventEndFn
...
if (m_Mips_CS_2DArray && ImGui::CollapsingHeader("Mips_CS_2DArray"))
    outline::MakeUI(m_Mips_CS_2DArray);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_CS_2DArray", Mips_CS_2DArray::CreateModule);

in the python module, you will need to "import Mips_CS_2DArray", and when will be able to set user exposed
variables like:

Mips_CS_2DArray.Set_<variable name>(<value>);
