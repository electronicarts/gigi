...
Mips_CS_3D::Context *m_Mips_CS_3DContext = nullptr;

m_Mips_CS_3DContext = Mips_CS_3D::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_CS_3D::OnNewFrame(FramesInFlight)
...
Mips_CS_3D::DestroyContext(m_Mips_CS_3DContext);
...
Mips_CS_3D::Context::s_techniqueLocation = L"./"
...
m_Mips_CS_3D.m_input.

Mips_CS_3D::Execute(m_Mips_CS_3D, m_device, m_commandList);
...
Mips_CS_3D::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_CS_3D::Context::PerfEventBeginFn
Mips_CS_3D::Context::PerfEventEndFn
...
if (m_Mips_CS_3D && ImGui::CollapsingHeader("Mips_CS_3D"))
    outline::MakeUI(m_Mips_CS_3D);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_CS_3D", Mips_CS_3D::CreateModule);

in the python module, you will need to "import Mips_CS_3D", and when will be able to set user exposed
variables like:

Mips_CS_3D.Set_<variable name>(<value>);
