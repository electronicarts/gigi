...
namespace Texture2DRW_RGS
{
    ...
    bool CreateShared(ID3D12Device* device)
    {
        ...
        // Ray Shader: RW
        {
            ...
            shaderCode[0] = DX12Utils::CompileShaderToByteCode_DXC(Context::s_techniqueLocation.c_str(), L"shaders/Texture2DRW_RGS.hlsl", "", "lib_6_3", defines, c_debugShaders, Context::LogFn);
