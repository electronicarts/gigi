...
Texture2DRW_RGS::Context *m_Texture2DRW_RGSContext = nullptr;

m_Texture2DRW_RGSContext = Texture2DRW_RGS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture2DRW_RGS::OnNewFrame(FramesInFlight)
...
Texture2DRW_RGS::DestroyContext(m_Texture2DRW_RGSContext);
...
Texture2DRW_RGS::Context::s_techniqueLocation = L"./"
...
m_Texture2DRW_RGS.m_input.

Texture2DRW_RGS::Execute(m_Texture2DRW_RGS, m_device, m_commandList);
...
Texture2DRW_RGS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture2DRW_RGS::Context::PerfEventBeginFn
Texture2DRW_RGS::Context::PerfEventEndFn
...
if (m_Texture2DRW_RGS && ImGui::CollapsingHeader("Texture2DRW_RGS"))
    outline::MakeUI(m_Texture2DRW_RGS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture2DRW_RGS", Texture2DRW_RGS::CreateModule);

in the python module, you will need to "import Texture2DRW_RGS", and when will be able to set user exposed
variables like:

Texture2DRW_RGS.Set_<variable name>(<value>);
