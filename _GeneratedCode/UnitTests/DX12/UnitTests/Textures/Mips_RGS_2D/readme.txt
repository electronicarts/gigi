...
Mips_RGS_2D::Context *m_Mips_RGS_2DContext = nullptr;

m_Mips_RGS_2DContext = Mips_RGS_2D::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Mips_RGS_2D::OnNewFrame(FramesInFlight)
...
Mips_RGS_2D::DestroyContext(m_Mips_RGS_2DContext);
...
Mips_RGS_2D::Context::s_techniqueLocation = L"./"
...
m_Mips_RGS_2D.m_input.

Mips_RGS_2D::Execute(m_Mips_RGS_2D, m_device, m_commandList);
...
Mips_RGS_2D::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Mips_RGS_2D::Context::PerfEventBeginFn
Mips_RGS_2D::Context::PerfEventEndFn
...
if (m_Mips_RGS_2D && ImGui::CollapsingHeader("Mips_RGS_2D"))
    outline::MakeUI(m_Mips_RGS_2D);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Mips_RGS_2D", Mips_RGS_2D::CreateModule);

in the python module, you will need to "import Mips_RGS_2D", and when will be able to set user exposed
variables like:

Mips_RGS_2D.Set_<variable name>(<value>);
