...
namespace Mips_RGS_2D
{
    ...
    struct Context
    {
        ...
        struct ContextInput
        {
            ...
            unsigned int buffer_VertexBuffer_tlasSize = 0;
            ID3D12Resource* buffer_VertexBuffer_blas = nullptr;
            unsigned int buffer_VertexBuffer_blasSize = 0;
        };
        ...
        struct ContextOutput
        {
            ...
            ID3D12Resource* texture_MipTex = nullptr;
            unsigned int texture_MipTex_size[3] = { 0, 0, 0 };
            unsigned int texture_MipTex_numMips = 0;
            DXGI_FORMAT texture_MipTex_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_MipTex_flags =  D3D12_RESOURCE_FLAG_ALLOW_UNORDERED_ACCESS;
            const D3D12_RESOURCE_STATES c_texture_MipTex_endingState = D3D12_RESOURCE_STATE_UNORDERED_ACCESS;
        };
