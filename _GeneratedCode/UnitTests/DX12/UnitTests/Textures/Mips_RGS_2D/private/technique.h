...
namespace Mips_RGS_2D
{
    ...
    struct ContextInternal
    {
        ...
        static ID3D12StateObject* rayShader_RayGen_rtso;
        static ID3D12RootSignature* rayShader_RayGen_rootSig;
        static ID3D12Resource* rayShader_RayGen_shaderTableRayGen;
        static unsigned int    rayShader_RayGen_shaderTableRayGenSize;
        static ID3D12Resource* rayShader_RayGen_shaderTableMiss;
        static unsigned int    rayShader_RayGen_shaderTableMissSize;
        static ID3D12Resource* rayShader_RayGen_shaderTableHitGroup;
        static unsigned int    rayShader_RayGen_shaderTableHitGroupSize;
