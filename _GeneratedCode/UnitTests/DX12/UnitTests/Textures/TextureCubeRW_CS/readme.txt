...
TextureCubeRW_CS::Context *m_TextureCubeRW_CSContext = nullptr;

m_TextureCubeRW_CSContext = TextureCubeRW_CS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

TextureCubeRW_CS::OnNewFrame(FramesInFlight)
...
TextureCubeRW_CS::DestroyContext(m_TextureCubeRW_CSContext);
...
TextureCubeRW_CS::Context::s_techniqueLocation = L"./"
...
m_TextureCubeRW_CS.m_input.

TextureCubeRW_CS::Execute(m_TextureCubeRW_CS, m_device, m_commandList);
...
TextureCubeRW_CS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

TextureCubeRW_CS::Context::PerfEventBeginFn
TextureCubeRW_CS::Context::PerfEventEndFn
...
if (m_TextureCubeRW_CS && ImGui::CollapsingHeader("TextureCubeRW_CS"))
    outline::MakeUI(m_TextureCubeRW_CS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("TextureCubeRW_CS", TextureCubeRW_CS::CreateModule);

in the python module, you will need to "import TextureCubeRW_CS", and when will be able to set user exposed
variables like:

TextureCubeRW_CS.Set_<variable name>(<value>);
