...
Texture3DRW_CS::Context *m_Texture3DRW_CSContext = nullptr;

m_Texture3DRW_CSContext = Texture3DRW_CS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Texture3DRW_CS::OnNewFrame(FramesInFlight)
...
Texture3DRW_CS::DestroyContext(m_Texture3DRW_CSContext);
...
Texture3DRW_CS::Context::s_techniqueLocation = L"./"
...
m_Texture3DRW_CS.m_input.

Texture3DRW_CS::Execute(m_Texture3DRW_CS, m_device, m_commandList);
...
Texture3DRW_CS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Texture3DRW_CS::Context::PerfEventBeginFn
Texture3DRW_CS::Context::PerfEventEndFn
...
if (m_Texture3DRW_CS && ImGui::CollapsingHeader("Texture3DRW_CS"))
    outline::MakeUI(m_Texture3DRW_CS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Texture3DRW_CS", Texture3DRW_CS::CreateModule);

in the python module, you will need to "import Texture3DRW_CS", and when will be able to set user exposed
variables like:

Texture3DRW_CS.Set_<variable name>(<value>);
