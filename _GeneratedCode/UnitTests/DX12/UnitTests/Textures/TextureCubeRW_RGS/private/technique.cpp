...
namespace TextureCubeRW_RGS
{
    ...
    bool CreateShared(ID3D12Device* device)
    {
        ...
        // Ray Shader: RW
        {
            ...
            shaderCode[0] = DX12Utils::CompileShaderToByteCode_DXC(Context::s_techniqueLocation.c_str(), L"shaders/TextureCubeRW_RGS.hlsl", "", "lib_6_3", defines, c_debugShaders, Context::LogFn);
