...
TextureCubeRW_RGS::Context *m_TextureCubeRW_RGSContext = nullptr;

m_TextureCubeRW_RGSContext = TextureCubeRW_RGS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

TextureCubeRW_RGS::OnNewFrame(FramesInFlight)
...
TextureCubeRW_RGS::DestroyContext(m_TextureCubeRW_RGSContext);
...
TextureCubeRW_RGS::Context::s_techniqueLocation = L"./"
...
m_TextureCubeRW_RGS.m_input.

TextureCubeRW_RGS::Execute(m_TextureCubeRW_RGS, m_device, m_commandList);
...
TextureCubeRW_RGS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

TextureCubeRW_RGS::Context::PerfEventBeginFn
TextureCubeRW_RGS::Context::PerfEventEndFn
...
if (m_TextureCubeRW_RGS && ImGui::CollapsingHeader("TextureCubeRW_RGS"))
    outline::MakeUI(m_TextureCubeRW_RGS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("TextureCubeRW_RGS", TextureCubeRW_RGS::CreateModule);

in the python module, you will need to "import TextureCubeRW_RGS", and when will be able to set user exposed
variables like:

TextureCubeRW_RGS.Set_<variable name>(<value>);
