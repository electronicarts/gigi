...
NoVertex_NoIndex_NoInstance::Context *m_NoVertex_NoIndex_NoInstanceContext = nullptr;

m_NoVertex_NoIndex_NoInstanceContext = NoVertex_NoIndex_NoInstance::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

NoVertex_NoIndex_NoInstance::OnNewFrame(FramesInFlight)
...
NoVertex_NoIndex_NoInstance::DestroyContext(m_NoVertex_NoIndex_NoInstanceContext);
...
NoVertex_NoIndex_NoInstance::Context::s_techniqueLocation = L"./"
...
m_NoVertex_NoIndex_NoInstance.m_input.

NoVertex_NoIndex_NoInstance::Execute(m_NoVertex_NoIndex_NoInstance, m_device, m_commandList);
...
NoVertex_NoIndex_NoInstance::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

NoVertex_NoIndex_NoInstance::Context::PerfEventBeginFn
NoVertex_NoIndex_NoInstance::Context::PerfEventEndFn
...
if (m_NoVertex_NoIndex_NoInstance && ImGui::CollapsingHeader("NoVertex_NoIndex_NoInstance"))
    outline::MakeUI(m_NoVertex_NoIndex_NoInstance);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("NoVertex_NoIndex_NoInstance", NoVertex_NoIndex_NoInstance::CreateModule);

in the python module, you will need to "import NoVertex_NoIndex_NoInstance", and when will be able to set user exposed
variables like:

NoVertex_NoIndex_NoInstance.Set_<variable name>(<value>);
