...
simpleRaster_Lines::Context *m_simpleRaster_LinesContext = nullptr;

m_simpleRaster_LinesContext = simpleRaster_Lines::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

simpleRaster_Lines::OnNewFrame(FramesInFlight)
...
simpleRaster_Lines::DestroyContext(m_simpleRaster_LinesContext);
...
simpleRaster_Lines::Context::s_techniqueLocation = L"./"
...
m_simpleRaster_Lines.m_input.

simpleRaster_Lines::Execute(m_simpleRaster_Lines, m_device, m_commandList);
...
simpleRaster_Lines::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

simpleRaster_Lines::Context::PerfEventBeginFn
simpleRaster_Lines::Context::PerfEventEndFn
...
if (m_simpleRaster_Lines && ImGui::CollapsingHeader("simpleRaster_Lines"))
    outline::MakeUI(m_simpleRaster_Lines);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("simpleRaster_Lines", simpleRaster_Lines::CreateModule);

in the python module, you will need to "import simpleRaster_Lines", and when will be able to set user exposed
variables like:

simpleRaster_Lines.Set_<variable name>(<value>);
