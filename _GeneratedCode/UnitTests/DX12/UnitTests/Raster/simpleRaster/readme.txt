...
simpleRaster::Context *m_simpleRasterContext = nullptr;

m_simpleRasterContext = simpleRaster::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

simpleRaster::OnNewFrame(FramesInFlight)
...
simpleRaster::DestroyContext(m_simpleRasterContext);
...
simpleRaster::Context::s_techniqueLocation = L"./"
...
m_simpleRaster.m_input.

simpleRaster::Execute(m_simpleRaster, m_device, m_commandList);
...
simpleRaster::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

simpleRaster::Context::PerfEventBeginFn
simpleRaster::Context::PerfEventEndFn
...
if (m_simpleRaster && ImGui::CollapsingHeader("simpleRaster"))
    outline::MakeUI(m_simpleRaster);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("simpleRaster", simpleRaster::CreateModule);

in the python module, you will need to "import simpleRaster", and when will be able to set user exposed
variables like:

simpleRaster.Set_<variable name>(<value>);
