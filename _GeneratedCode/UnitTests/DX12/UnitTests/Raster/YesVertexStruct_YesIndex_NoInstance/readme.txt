...
YesVertexStruct_YesIndex_NoInstance::Context *m_YesVertexStruct_YesIndex_NoInstanceContext = nullptr;

m_YesVertexStruct_YesIndex_NoInstanceContext = YesVertexStruct_YesIndex_NoInstance::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

YesVertexStruct_YesIndex_NoInstance::OnNewFrame(FramesInFlight)
...
YesVertexStruct_YesIndex_NoInstance::DestroyContext(m_YesVertexStruct_YesIndex_NoInstanceContext);
...
YesVertexStruct_YesIndex_NoInstance::Context::s_techniqueLocation = L"./"
...
m_YesVertexStruct_YesIndex_NoInstance.m_input.

YesVertexStruct_YesIndex_NoInstance::Execute(m_YesVertexStruct_YesIndex_NoInstance, m_device, m_commandList);
...
YesVertexStruct_YesIndex_NoInstance::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

YesVertexStruct_YesIndex_NoInstance::Context::PerfEventBeginFn
YesVertexStruct_YesIndex_NoInstance::Context::PerfEventEndFn
...
if (m_YesVertexStruct_YesIndex_NoInstance && ImGui::CollapsingHeader("YesVertexStruct_YesIndex_NoInstance"))
    outline::MakeUI(m_YesVertexStruct_YesIndex_NoInstance);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("YesVertexStruct_YesIndex_NoInstance", YesVertexStruct_YesIndex_NoInstance::CreateModule);

in the python module, you will need to "import YesVertexStruct_YesIndex_NoInstance", and when will be able to set user exposed
variables like:

YesVertexStruct_YesIndex_NoInstance.Set_<variable name>(<value>);
