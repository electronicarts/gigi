...
namespace YesVertexStruct_YesIndex_NoInstance
{
    ...
    static PyModuleDef pythonModule = {
        PyModuleDef_HEAD_INIT, "YesVertexStruct_YesIndex_NoInstance", NULL, -1, pythonModuleMethods,
        NULL, NULL, NULL, NULL
    };
    ...
    PyObject* CreateModule()
    {
        ...
        PyModule_AddIntConstant(module, "ViewMode_UV", 0);
        PyModule_AddIntConstant(module, "ViewMode_Solid", 1);
        return module;
    }
};
