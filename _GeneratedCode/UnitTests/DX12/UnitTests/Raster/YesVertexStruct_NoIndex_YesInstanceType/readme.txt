...
YesVertexStruct_NoIndex_YesInstanceType::Context *m_YesVertexStruct_NoIndex_YesInstanceTypeContext = nullptr;

m_YesVertexStruct_NoIndex_YesInstanceTypeContext = YesVertexStruct_NoIndex_YesInstanceType::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

YesVertexStruct_NoIndex_YesInstanceType::OnNewFrame(FramesInFlight)
...
YesVertexStruct_NoIndex_YesInstanceType::DestroyContext(m_YesVertexStruct_NoIndex_YesInstanceTypeContext);
...
YesVertexStruct_NoIndex_YesInstanceType::Context::s_techniqueLocation = L"./"
...
m_YesVertexStruct_NoIndex_YesInstanceType.m_input.

YesVertexStruct_NoIndex_YesInstanceType::Execute(m_YesVertexStruct_NoIndex_YesInstanceType, m_device, m_commandList);
...
YesVertexStruct_NoIndex_YesInstanceType::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

YesVertexStruct_NoIndex_YesInstanceType::Context::PerfEventBeginFn
YesVertexStruct_NoIndex_YesInstanceType::Context::PerfEventEndFn
...
if (m_YesVertexStruct_NoIndex_YesInstanceType && ImGui::CollapsingHeader("YesVertexStruct_NoIndex_YesInstanceType"))
    outline::MakeUI(m_YesVertexStruct_NoIndex_YesInstanceType);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("YesVertexStruct_NoIndex_YesInstanceType", YesVertexStruct_NoIndex_YesInstanceType::CreateModule);

in the python module, you will need to "import YesVertexStruct_NoIndex_YesInstanceType", and when will be able to set user exposed
variables like:

YesVertexStruct_NoIndex_YesInstanceType.Set_<variable name>(<value>);
