...
simpleRaster_Points::Context *m_simpleRaster_PointsContext = nullptr;

m_simpleRaster_PointsContext = simpleRaster_Points::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

simpleRaster_Points::OnNewFrame(FramesInFlight)
...
simpleRaster_Points::DestroyContext(m_simpleRaster_PointsContext);
...
simpleRaster_Points::Context::s_techniqueLocation = L"./"
...
m_simpleRaster_Points.m_input.

simpleRaster_Points::Execute(m_simpleRaster_Points, m_device, m_commandList);
...
simpleRaster_Points::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

simpleRaster_Points::Context::PerfEventBeginFn
simpleRaster_Points::Context::PerfEventEndFn
...
if (m_simpleRaster_Points && ImGui::CollapsingHeader("simpleRaster_Points"))
    outline::MakeUI(m_simpleRaster_Points);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("simpleRaster_Points", simpleRaster_Points::CreateModule);

in the python module, you will need to "import simpleRaster_Points", and when will be able to set user exposed
variables like:

simpleRaster_Points.Set_<variable name>(<value>);
