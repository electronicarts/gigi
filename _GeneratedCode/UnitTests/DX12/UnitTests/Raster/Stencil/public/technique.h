...
namespace Stencil
{
    ...
    struct Context
    {
        ...
        struct ContextOutput
        {
            ...
            static const D3D12_RESOURCE_FLAGS texture_Color_flags =  D3D12_RESOURCE_FLAG_ALLOW_RENDER_TARGET;
            int texture_Color_rtv = -1;
            const D3D12_RESOURCE_STATES c_texture_Color_endingState = D3D12_RESOURCE_STATE_RENDER_TARGET;

            ID3D12Resource* texture_Depth_Stencil = nullptr;
            unsigned int texture_Depth_Stencil_size[3] = { 0, 0, 0 };
            DXGI_FORMAT texture_Depth_Stencil_format = DXGI_FORMAT_UNKNOWN;
            static const D3D12_RESOURCE_FLAGS texture_Depth_Stencil_flags =  D3D12_RESOURCE_FLAG_ALLOW_DEPTH_STENCIL;
            int texture_Depth_Stencil_dsv = -1;
            const D3D12_RESOURCE_STATES c_texture_Depth_Stencil_endingState = D3D12_RESOURCE_STATE_DEPTH_WRITE;
        };
