...
Stencil::Context *m_StencilContext = nullptr;

m_StencilContext = Stencil::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

Stencil::OnNewFrame(FramesInFlight)
...
Stencil::DestroyContext(m_StencilContext);
...
Stencil::Context::s_techniqueLocation = L"./"
...
Stencil::Execute(m_Stencil, m_device, m_commandList);
...
Stencil::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

Stencil::Context::PerfEventBeginFn
Stencil::Context::PerfEventEndFn
...
if (m_Stencil && ImGui::CollapsingHeader("Stencil"))
    outline::MakeUI(m_Stencil);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("Stencil", Stencil::CreateModule);

in the python module, you will need to "import Stencil", and when will be able to set user exposed
variables like:

Stencil.Set_<variable name>(<value>);
