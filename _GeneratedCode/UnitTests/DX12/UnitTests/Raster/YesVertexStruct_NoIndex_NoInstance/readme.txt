...
YesVertexStruct_NoIndex_NoInstance::Context *m_YesVertexStruct_NoIndex_NoInstanceContext = nullptr;

m_YesVertexStruct_NoIndex_NoInstanceContext = YesVertexStruct_NoIndex_NoInstance::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

YesVertexStruct_NoIndex_NoInstance::OnNewFrame(FramesInFlight)
...
YesVertexStruct_NoIndex_NoInstance::DestroyContext(m_YesVertexStruct_NoIndex_NoInstanceContext);
...
YesVertexStruct_NoIndex_NoInstance::Context::s_techniqueLocation = L"./"
...
m_YesVertexStruct_NoIndex_NoInstance.m_input.

YesVertexStruct_NoIndex_NoInstance::Execute(m_YesVertexStruct_NoIndex_NoInstance, m_device, m_commandList);
...
YesVertexStruct_NoIndex_NoInstance::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

YesVertexStruct_NoIndex_NoInstance::Context::PerfEventBeginFn
YesVertexStruct_NoIndex_NoInstance::Context::PerfEventEndFn
...
if (m_YesVertexStruct_NoIndex_NoInstance && ImGui::CollapsingHeader("YesVertexStruct_NoIndex_NoInstance"))
    outline::MakeUI(m_YesVertexStruct_NoIndex_NoInstance);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("YesVertexStruct_NoIndex_NoInstance", YesVertexStruct_NoIndex_NoInstance::CreateModule);

in the python module, you will need to "import YesVertexStruct_NoIndex_NoInstance", and when will be able to set user exposed
variables like:

YesVertexStruct_NoIndex_NoInstance.Set_<variable name>(<value>);
