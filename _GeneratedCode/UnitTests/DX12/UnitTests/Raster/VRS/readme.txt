...
VRS::Context *m_VRSContext = nullptr;

m_VRSContext = VRS::CreateContext(device);

=====================================================================================================
4) Call OnNewFrame at the beginning of your frame.
=====================================================================================================

VRS::OnNewFrame(FramesInFlight)
...
VRS::DestroyContext(m_VRSContext);
...
VRS::Context::s_techniqueLocation = L"./"
...
VRS::Execute(m_VRS, m_device, m_commandList);
...
VRS::Context::LogFn = &CustomLogFn;

you can do similar for perf markers (like for pix) by overriding these:

VRS::Context::PerfEventBeginFn
VRS::Context::PerfEventEndFn
...
if (m_VRS && ImGui::CollapsingHeader("VRS"))
    outline::MakeUI(m_VRS);

=====================================================================================================
11) Optional: Hook up python
=====================================================================================================

PyImport_AppendInittab("VRS", VRS::CreateModule);

in the python module, you will need to "import VRS", and when will be able to set user exposed
variables like:

VRS.Set_<variable name>(<value>);
