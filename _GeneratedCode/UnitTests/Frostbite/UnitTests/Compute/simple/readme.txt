...
Copy simpleRenderPassModule.h and simpleShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\simple\

Copy simpleRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\simple\

Copy simpleShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\simple\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\simple

Copy the shader files into Code\Engine\World\Render\sourcedata\source\simple\
...
#include <Engine.World.Render/simple/simpleRenderPassModule.h>

moduleManager.registerModule<simpleRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

simpleRenderPassModule::addPass() in simpleRenderPassModule.cpp has a todo at the top and
