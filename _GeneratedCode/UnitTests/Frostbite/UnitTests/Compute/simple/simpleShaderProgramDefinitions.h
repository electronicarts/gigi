...
class simpleShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(simpleShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
