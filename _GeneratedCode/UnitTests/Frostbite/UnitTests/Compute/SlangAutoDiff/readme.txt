...
Copy SlangAutoDiffRenderPassModule.h and SlangAutoDiffShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\SlangAutoDiff\

Copy SlangAutoDiffRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\SlangAutoDiff\

Copy SlangAutoDiffShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\SlangAutoDiff\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\SlangAutoDiff

Copy the shader files into Code\Engine\World\Render\sourcedata\source\SlangAutoDiff\
...
SlangAutoDiff.NumGaussians

SlangAutoDiff.Reset

SlangAutoDiff.LearningRate

SlangAutoDiff.MaximumStepSize

SlangAutoDiff.UseBackwardAD

SlangAutoDiff.QuantizeDisplay
...
#include <Engine.World.Render/SlangAutoDiff/SlangAutoDiffRenderPassModule.h>

moduleManager.registerModule<SlangAutoDiffRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

SlangAutoDiffRenderPassModule::addPass() in SlangAutoDiffRenderPassModule.cpp has a todo at the top and
