...
class SlangAutoDiffShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(SlangAutoDiffShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
