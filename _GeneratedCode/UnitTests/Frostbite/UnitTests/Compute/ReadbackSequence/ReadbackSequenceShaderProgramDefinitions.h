...
class ReadbackSequenceShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(ReadbackSequenceShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
