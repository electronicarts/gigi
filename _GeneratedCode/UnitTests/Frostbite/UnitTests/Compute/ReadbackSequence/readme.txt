...
Copy ReadbackSequenceRenderPassModule.h and ReadbackSequenceShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\ReadbackSequence\

Copy ReadbackSequenceRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\ReadbackSequence\

Copy ReadbackSequenceShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\ReadbackSequence\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\ReadbackSequence

Copy the shader files into Code\Engine\World\Render\sourcedata\source\ReadbackSequence\
...
#include <Engine.World.Render/ReadbackSequence/ReadbackSequenceRenderPassModule.h>

moduleManager.registerModule<ReadbackSequenceRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

ReadbackSequenceRenderPassModule::addPass() in ReadbackSequenceRenderPassModule.cpp has a todo at the top and
