...
Copy VariableAliasesRenderPassModule.h and VariableAliasesShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\VariableAliases\

Copy VariableAliasesRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\VariableAliases\

Copy VariableAliasesShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\VariableAliases\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\VariableAliases

Copy the shader files into Code\Engine\World\Render\sourcedata\source\VariableAliases\
...
VariableAliases.RenderSize

VariableAliases.Node1Channel

VariableAliases.Node1Value

VariableAliases.Node2Channel

VariableAliases.Node2Value

VariableAliases.Node3Channel

VariableAliases.Node3Value

This is for the unused alias in the shader
VariableAliases.UnusedFloat
...
#include <Engine.World.Render/VariableAliases/VariableAliasesRenderPassModule.h>

moduleManager.registerModule<VariableAliasesRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

VariableAliasesRenderPassModule::addPass() in VariableAliasesRenderPassModule.cpp has a todo at the top and
