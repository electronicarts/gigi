...
class VariableAliasesShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(VariableAliasesShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
