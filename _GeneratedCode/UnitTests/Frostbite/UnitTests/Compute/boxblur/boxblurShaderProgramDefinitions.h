...
class boxblurShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(boxblurShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
