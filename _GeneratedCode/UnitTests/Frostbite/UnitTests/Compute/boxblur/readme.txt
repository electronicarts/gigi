...
Copy boxblurRenderPassModule.h and boxblurShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\boxblur\

Copy boxblurRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\boxblur\

Copy boxblurShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\boxblur\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\boxblur

Copy the shader files into Code\Engine\World\Render\sourcedata\source\boxblur\
...
Enables or disables the blurring effect.
boxblur.enabled

The radius of the blur.  Actual size in pixles of the blur is (radius*2+1)^2
boxblur.radius
...
#include <Engine.World.Render/boxblur/boxblurRenderPassModule.h>

moduleManager.registerModule<boxblurRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

boxblurRenderPassModule::addPass() in boxblurRenderPassModule.cpp has a todo at the top and
