...
class buffertestShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(buffertestShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
