...
Copy buffertestRenderPassModule.h and buffertestShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\buffertest\

Copy buffertestRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\buffertest\

Copy buffertestShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\buffertest\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\buffertest

Copy the shader files into Code\Engine\World\Render\sourcedata\source\buffertest\
...
#include <Engine.World.Render/buffertest/buffertestRenderPassModule.h>

moduleManager.registerModule<buffertestRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

buffertestRenderPassModule::addPass() in buffertestRenderPassModule.cpp has a todo at the top and
