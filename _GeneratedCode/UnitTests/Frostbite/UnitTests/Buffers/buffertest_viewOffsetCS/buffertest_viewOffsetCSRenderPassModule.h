...
class buffertest_viewOffsetCSRenderPassModule : public RefCountImpl<IRenderPassModule>
{
public:
	buffertest_viewOffsetCSRenderPassModule() = default;
	virtual ~buffertest_viewOffsetCSRenderPassModule();
