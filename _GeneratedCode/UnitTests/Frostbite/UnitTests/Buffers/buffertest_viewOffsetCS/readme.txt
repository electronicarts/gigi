...
Copy buffertest_viewOffsetCSRenderPassModule.h and buffertest_viewOffsetCSShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\buffertest_viewOffsetCS\

Copy buffertest_viewOffsetCSRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\buffertest_viewOffsetCS\

Copy buffertest_viewOffsetCSShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\buffertest_viewOffsetCS\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\buffertest_viewOffsetCS

Copy the shader files into Code\Engine\World\Render\sourcedata\source\buffertest_viewOffsetCS\
...
buffertest_viewOffsetCS.gain

Adjusts the contribution of sample n-1
buffertest_viewOffsetCS.alpha1

Adjusts the contribution of sample n-2
buffertest_viewOffsetCS.alpha2
...
#include <Engine.World.Render/buffertest_viewOffsetCS/buffertest_viewOffsetCSRenderPassModule.h>

moduleManager.registerModule<buffertest_viewOffsetCSRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

buffertest_viewOffsetCSRenderPassModule::addPass() in buffertest_viewOffsetCSRenderPassModule.cpp has a todo at the top and
