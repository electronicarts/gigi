...
class buffertest_viewOffsetCSShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(buffertest_viewOffsetCSShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
