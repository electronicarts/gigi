...
Copy MultipleUVMeshRenderPassModule.h and MultipleUVMeshShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\MultipleUVMesh\

Copy MultipleUVMeshRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\MultipleUVMesh\

Copy MultipleUVMeshShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\MultipleUVMesh\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\MultipleUVMesh

Copy the shader files into Code\Engine\World\Render\sourcedata\source\MultipleUVMesh\
...
#include <Engine.World.Render/MultipleUVMesh/MultipleUVMeshRenderPassModule.h>

moduleManager.registerModule<MultipleUVMeshRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

MultipleUVMeshRenderPassModule::addPass() in MultipleUVMeshRenderPassModule.cpp has a todo at the top and
