...
class buffertest_viewOffsetCS_VarsShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(buffertest_viewOffsetCS_VarsShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
