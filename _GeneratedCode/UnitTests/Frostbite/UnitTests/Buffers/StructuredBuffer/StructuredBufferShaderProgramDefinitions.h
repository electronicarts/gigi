...
class StructuredBufferShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(StructuredBufferShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
