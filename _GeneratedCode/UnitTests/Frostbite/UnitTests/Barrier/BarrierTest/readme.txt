...
Copy BarrierTestRenderPassModule.h and BarrierTestShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\BarrierTest\

Copy BarrierTestRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\BarrierTest\

Copy BarrierTestShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\BarrierTest\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\BarrierTest

Copy the shader files into Code\Engine\World\Render\sourcedata\source\BarrierTest\
...
#include <Engine.World.Render/BarrierTest/BarrierTestRenderPassModule.h>

moduleManager.registerModule<BarrierTestRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

BarrierTestRenderPassModule::addPass() in BarrierTestRenderPassModule.cpp has a todo at the top and
