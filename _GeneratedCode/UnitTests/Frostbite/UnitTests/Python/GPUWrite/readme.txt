...
Copy GPUWriteRenderPassModule.h and GPUWriteShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\GPUWrite\

Copy GPUWriteRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\GPUWrite\

Copy GPUWriteShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\GPUWrite\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\GPUWrite

Copy the shader files into Code\Engine\World\Render\sourcedata\source\GPUWrite\
...
#include <Engine.World.Render/GPUWrite/GPUWriteRenderPassModule.h>

moduleManager.registerModule<GPUWriteRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

GPUWriteRenderPassModule::addPass() in GPUWriteRenderPassModule.cpp has a todo at the top and
