...
class GPUWriteShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(GPUWriteShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
