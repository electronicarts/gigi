...
class profilingShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(profilingShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
