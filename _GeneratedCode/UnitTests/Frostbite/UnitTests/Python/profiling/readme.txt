...
Copy profilingRenderPassModule.h and profilingShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\profiling\

Copy profilingRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\profiling\

Copy profilingShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\profiling\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\profiling

Copy the shader files into Code\Engine\World\Render\sourcedata\source\profiling\
...
#include <Engine.World.Render/profiling/profilingRenderPassModule.h>

moduleManager.registerModule<profilingRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

profilingRenderPassModule::addPass() in profilingRenderPassModule.cpp has a todo at the top and
