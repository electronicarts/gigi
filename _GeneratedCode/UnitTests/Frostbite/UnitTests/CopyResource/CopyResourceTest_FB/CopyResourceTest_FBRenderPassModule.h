...
class CopyResourceTest_FBRenderPassModule : public RefCountImpl<IRenderPassModule>
{
public:
	CopyResourceTest_FBRenderPassModule() = default;
	virtual ~CopyResourceTest_FBRenderPassModule();
