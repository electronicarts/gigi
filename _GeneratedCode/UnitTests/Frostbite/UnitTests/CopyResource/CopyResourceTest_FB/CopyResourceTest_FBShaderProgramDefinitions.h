...
class CopyResourceTest_FBShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(CopyResourceTest_FBShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
