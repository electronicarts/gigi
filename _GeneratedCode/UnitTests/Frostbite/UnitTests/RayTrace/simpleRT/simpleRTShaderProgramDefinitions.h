...
class simpleRTShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(simpleRTShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
