...
Copy TwoRayGensSubgraphRenderPassModule.h and TwoRayGensSubgraphShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\TwoRayGensSubgraph\

Copy TwoRayGensSubgraphRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\TwoRayGensSubgraph\

Copy TwoRayGensSubgraphShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\TwoRayGensSubgraph\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\TwoRayGensSubgraph

Copy the shader files into Code\Engine\World\Render\sourcedata\source\TwoRayGensSubgraph\
...
Add these lines:
	// TwoRayGensSubgraph Shaders
	ShaderProgram_TwoRayGensSubgraph_A_TwoRayGens1_RG,
	ShaderProgram_TwoRayGensSubgraph_A_TwoRayGensMiss1_MS,
	ShaderProgram_TwoRayGensSubgraph_A_TwoRayGensClosestHit1_HG,
	ShaderProgram_TwoRayGensSubgraph_B_TwoRayGens2_RG,
	ShaderProgram_TwoRayGensSubgraph_B_TwoRayGensMiss2A_MS,
	ShaderProgram_TwoRayGensSubgraph_B_TwoRayGensMiss2B_MS,
	ShaderProgram_TwoRayGensSubgraph_B_TwoRayGensClosestHit2_HG,
...
Add these to RaytraceWorldType in Code/Engine/Render/Public/Engine.Render/Raytrace/RaytraceWorldTypes.h:
	...
	RaytraceWorldType_TwoRayGensSubgraph_A_DoRT1_World,
	RaytraceWorldType_TwoRayGensSubgraph_B_DoRT2_World,
...
TwoRayGensSubgraph.hitColor

TwoRayGensSubgraph.missColor
...
#include <Engine.World.Render/TwoRayGensSubgraph/TwoRayGensSubgraphRenderPassModule.h>

moduleManager.registerModule<TwoRayGensSubgraphRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

TwoRayGensSubgraphRenderPassModule::addPass() in TwoRayGensSubgraphRenderPassModule.cpp has a todo at the top and
