...
Copy TwoRayGensRenderPassModule.h and TwoRayGensShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\TwoRayGens\

Copy TwoRayGensRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\TwoRayGens\

Copy TwoRayGensShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\TwoRayGens\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\TwoRayGens

Copy the shader files into Code\Engine\World\Render\sourcedata\source\TwoRayGens\
...
Add these lines:
	// TwoRayGens Shaders
	ShaderProgram_TwoRayGens_TwoRayGens1_RG,
	ShaderProgram_TwoRayGens_TwoRayGensMiss1_MS,
	ShaderProgram_TwoRayGens_TwoRayGensClosestHit1_HG,
	ShaderProgram_TwoRayGens_TwoRayGens2_RG,
	ShaderProgram_TwoRayGens_TwoRayGensMiss2A_MS,
	ShaderProgram_TwoRayGens_TwoRayGensMiss2B_MS,
	ShaderProgram_TwoRayGens_TwoRayGensClosestHit2_HG,
...
Add these to RaytraceWorldType in Code/Engine/Render/Public/Engine.Render/Raytrace/RaytraceWorldTypes.h:
	...
	RaytraceWorldType_TwoRayGens_DoRT1_World,
	RaytraceWorldType_TwoRayGens_DoRT2_World,
...
#include <Engine.World.Render/TwoRayGens/TwoRayGensRenderPassModule.h>

moduleManager.registerModule<TwoRayGensRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

TwoRayGensRenderPassModule::addPass() in TwoRayGensRenderPassModule.cpp has a todo at the top and
