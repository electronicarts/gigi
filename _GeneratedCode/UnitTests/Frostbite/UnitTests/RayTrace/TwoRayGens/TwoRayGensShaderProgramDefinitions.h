...
class TwoRayGensShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(TwoRayGensShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
