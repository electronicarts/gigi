...
Copy SubGraphTestRenderPassModule.h and SubGraphTestShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\SubGraphTest\

Copy SubGraphTestRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\SubGraphTest\

Copy SubGraphTestShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\SubGraphTest\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\SubGraphTest

Copy the shader files into Code\Engine\World\Render\sourcedata\source\SubGraphTest\
...
#include <Engine.World.Render/SubGraphTest/SubGraphTestRenderPassModule.h>

moduleManager.registerModule<SubGraphTestRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

SubGraphTestRenderPassModule::addPass() in SubGraphTestRenderPassModule.cpp has a todo at the top and
