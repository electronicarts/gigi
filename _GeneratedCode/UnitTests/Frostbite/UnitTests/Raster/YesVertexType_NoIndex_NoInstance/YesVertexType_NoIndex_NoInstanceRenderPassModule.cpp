...
#include "YesVertexType_NoIndex_NoInstanceRenderPassModule.h"
...
namespace fb
{
ShaderProgramPipelineCache YesVertexType_NoIndex_NoInstanceRenderPassModule::s_pipelineCache;
...
void YesVertexType_NoIndex_NoInstanceRenderPassModule::addPass(FrameGraph& frameGraph, FrameGraphBlackboard& blackboard)
{
	...
	FrameGraphMutableResource textureDepth_Buffer;
	{
		...
		frameGraph.addRc2CallbackPass<PassData>("YesVertexType_NoIndex_NoInstance.Initialization", [&](RenderPassBuilderBase& builder, PassData& data)
		{
			...
			// Texture: Color_Buffer
			{
				...
				desc.name = "YesVertexType_NoIndex_NoInstance.Color_Buffer";
			...
			// Texture: Depth_Buffer
			{
				...
				FrameGraphTextureDesc desc;
				desc.name = "YesVertexType_NoIndex_NoInstance.Depth_Buffer";
				desc.usage = RenderResourceUsage_Static;
				desc.initialState = FrameGraphTextureDesc::InitialState_Undefined;
				desc.type = type;
				desc.bindFlags = bindFlags;
	...
	// Draw Call: Rasterize
	{
		...
		frameGraph.addRc2CallbackPass<PassData>("YesVertexType_NoIndex_NoInstance.Rasterize",
		...
		[=](const PassData& data, const Rc2RenderPassResources& resources, CommandRecorder& commandRecorder)
		{
			...
			renderPassDesc.name = "YesVertexType_NoIndex_NoInstance.Rasterize";
			...
			graphicsPipelineCompileInfo.shaderProgram = ShaderProgram_YesVertexType_NoIndex_NoInstance_Rasterize_VSPS;
...
void YesVertexType_NoIndex_NoInstanceRenderPassModule::onInit(const InitParams& params)
{
...
YesVertexType_NoIndex_NoInstanceRenderPassModule::~YesVertexType_NoIndex_NoInstanceRenderPassModule()
{
