...
class YesVertexType_NoIndex_NoInstanceShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(YesVertexType_NoIndex_NoInstanceShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
