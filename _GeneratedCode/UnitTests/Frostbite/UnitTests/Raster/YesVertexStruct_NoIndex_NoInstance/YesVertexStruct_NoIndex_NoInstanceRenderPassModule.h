...
class YesVertexStruct_NoIndex_NoInstanceRenderPassModule : public RefCountImpl<IRenderPassModule>
{
public:
	YesVertexStruct_NoIndex_NoInstanceRenderPassModule() = default;
	virtual ~YesVertexStruct_NoIndex_NoInstanceRenderPassModule();
