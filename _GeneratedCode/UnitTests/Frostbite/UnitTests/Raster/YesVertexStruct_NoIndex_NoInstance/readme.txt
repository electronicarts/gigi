...
Copy YesVertexStruct_NoIndex_NoInstanceRenderPassModule.h and YesVertexStruct_NoIndex_NoInstanceShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\YesVertexStruct_NoIndex_NoInstance\

Copy YesVertexStruct_NoIndex_NoInstanceRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\YesVertexStruct_NoIndex_NoInstance\

Copy YesVertexStruct_NoIndex_NoInstanceShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\YesVertexStruct_NoIndex_NoInstance\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\YesVertexStruct_NoIndex_NoInstance

Copy the shader files into Code\Engine\World\Render\sourcedata\source\YesVertexStruct_NoIndex_NoInstance\
...
YesVertexStruct_NoIndex_NoInstance.viewMode
...
#include <Engine.World.Render/YesVertexStruct_NoIndex_NoInstance/YesVertexStruct_NoIndex_NoInstanceRenderPassModule.h>

moduleManager.registerModule<YesVertexStruct_NoIndex_NoInstanceRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

YesVertexStruct_NoIndex_NoInstanceRenderPassModule::addPass() in YesVertexStruct_NoIndex_NoInstanceRenderPassModule.cpp has a todo at the top and
...
Systems/WorldRender/YesVertexStruct_NoIndex_NoInstance/_VSPS_Rasterize.hlsl
...
YesVertexStruct_NoIndex_NoInstanceShaderDefinitions.cpp, YesVertexStruct_NoIndex_NoInstanceShaderProgramsProvider::gatherShaderProgramDefinitions():
...
YesVertexStruct_NoIndex_NoInstanceRenderpassModule.cpp, YesVertexStruct_NoIndex_NoInstanceRenderPassModule::addPass():
