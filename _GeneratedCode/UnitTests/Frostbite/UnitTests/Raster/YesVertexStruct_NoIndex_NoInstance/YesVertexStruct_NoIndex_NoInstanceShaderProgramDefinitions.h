...
class YesVertexStruct_NoIndex_NoInstanceShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(YesVertexStruct_NoIndex_NoInstanceShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
