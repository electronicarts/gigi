...
class YesVertexStruct_YesIndex_NoInstanceRenderPassModule : public RefCountImpl<IRenderPassModule>
{
public:
	YesVertexStruct_YesIndex_NoInstanceRenderPassModule() = default;
	virtual ~YesVertexStruct_YesIndex_NoInstanceRenderPassModule();
