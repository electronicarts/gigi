...
class StencilShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(StencilShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
