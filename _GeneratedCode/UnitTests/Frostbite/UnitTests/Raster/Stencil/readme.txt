...
Copy StencilRenderPassModule.h and StencilShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\Stencil\

Copy StencilRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\Stencil\

Copy StencilShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\Stencil\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\Stencil

Copy the shader files into Code\Engine\World\Render\sourcedata\source\Stencil\
...
#include <Engine.World.Render/Stencil/StencilRenderPassModule.h>

moduleManager.registerModule<StencilRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

StencilRenderPassModule::addPass() in StencilRenderPassModule.cpp has a todo at the top and
...
Stencil/cabinsmall
  * in Frosted, import "Raw/Stencil/cabinsmall.png".  A corresponding .dbx and .fb file should show up in your data directory under Source.
    * set Gamma to Linear
    * set OutputFormat to be compatible with RGBA8_Unorm
    * you likely want to turn off Streaming Enable, Resize To Power of Two, Generate Mipmaps, and turn on Ignore Texture Group
  * in Frosted, add it to the list of assets in "Systems/Render/RenderStartupBundleFragment" to reference it and make it be loadable.
...
Systems/WorldRender/Stencil/_VSPS_Draw_1.hlsl
Systems/WorldRender/Stencil/_VSPS_Draw_2.hlsl
...
StencilShaderDefinitions.cpp, StencilShaderProgramsProvider::gatherShaderProgramDefinitions():
...
StencilRenderpassModule.cpp, StencilRenderPassModule::addPass():
