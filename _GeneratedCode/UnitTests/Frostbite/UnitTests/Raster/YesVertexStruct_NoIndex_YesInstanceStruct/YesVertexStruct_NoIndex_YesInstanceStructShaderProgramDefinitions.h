...
class YesVertexStruct_NoIndex_YesInstanceStructShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(YesVertexStruct_NoIndex_YesInstanceStructShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
