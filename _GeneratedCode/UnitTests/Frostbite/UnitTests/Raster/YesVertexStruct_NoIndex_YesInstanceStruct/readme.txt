...
Copy YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule.h and YesVertexStruct_NoIndex_YesInstanceStructShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\YesVertexStruct_NoIndex_YesInstanceStruct\

Copy YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\YesVertexStruct_NoIndex_YesInstanceStruct\

Copy YesVertexStruct_NoIndex_YesInstanceStructShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\YesVertexStruct_NoIndex_YesInstanceStruct\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\YesVertexStruct_NoIndex_YesInstanceStruct

Copy the shader files into Code\Engine\World\Render\sourcedata\source\YesVertexStruct_NoIndex_YesInstanceStruct\
...
YesVertexStruct_NoIndex_YesInstanceStruct.viewMode
...
#include <Engine.World.Render/YesVertexStruct_NoIndex_YesInstanceStruct/YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule.h>

moduleManager.registerModule<YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule::addPass() in YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule.cpp has a todo at the top and
...
Systems/WorldRender/YesVertexStruct_NoIndex_YesInstanceStruct/_VSPS_Rasterize.hlsl
...
YesVertexStruct_NoIndex_YesInstanceStructShaderDefinitions.cpp, YesVertexStruct_NoIndex_YesInstanceStructShaderProgramsProvider::gatherShaderProgramDefinitions():
...
* Instance_Buffer needs to be described in program.geometryDeclaration.elements, and stream[1], as VertexElementClassification_PerInstance.

YesVertexStruct_NoIndex_YesInstanceStructRenderpassModule.cpp, YesVertexStruct_NoIndex_YesInstanceStructRenderPassModule::addPass():
* bufferVertex_Buffer_vbdesc needs to be filled out as inputSlot 0 and InputClassification_PerVertex.
* bufferInstance_Buffer_vbdesc needs to be filled out as inputSlot 1 and InputClassification_PerInstance.
