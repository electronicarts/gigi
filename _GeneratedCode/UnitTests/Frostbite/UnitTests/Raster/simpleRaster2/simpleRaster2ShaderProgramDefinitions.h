...
class simpleRaster2ShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(simpleRaster2ShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
