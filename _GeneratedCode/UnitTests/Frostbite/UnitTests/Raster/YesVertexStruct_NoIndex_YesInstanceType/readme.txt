...
Copy YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule.h and YesVertexStruct_NoIndex_YesInstanceTypeShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\YesVertexStruct_NoIndex_YesInstanceType\

Copy YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\YesVertexStruct_NoIndex_YesInstanceType\

Copy YesVertexStruct_NoIndex_YesInstanceTypeShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\YesVertexStruct_NoIndex_YesInstanceType\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\YesVertexStruct_NoIndex_YesInstanceType

Copy the shader files into Code\Engine\World\Render\sourcedata\source\YesVertexStruct_NoIndex_YesInstanceType\
...
YesVertexStruct_NoIndex_YesInstanceType.viewMode
...
#include <Engine.World.Render/YesVertexStruct_NoIndex_YesInstanceType/YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule.h>

moduleManager.registerModule<YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::addPass() in YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule.cpp has a todo at the top and
...
Systems/WorldRender/YesVertexStruct_NoIndex_YesInstanceType/_VSPS_Rasterize.hlsl
...
YesVertexStruct_NoIndex_YesInstanceTypeShaderDefinitions.cpp, YesVertexStruct_NoIndex_YesInstanceTypeShaderProgramsProvider::gatherShaderProgramDefinitions():
...
YesVertexStruct_NoIndex_YesInstanceTypeRenderpassModule.cpp, YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::addPass():
