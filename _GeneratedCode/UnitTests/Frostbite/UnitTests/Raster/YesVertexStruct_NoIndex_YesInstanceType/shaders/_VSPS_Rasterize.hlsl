//VS Source: YesVertexStruct_NoIndex_YesInstanceType_VS.hlsl
//PS Source: YesVertexStruct_NoIndex_YesInstanceType_PS.hlsl
...
VSOutput VSMain(VSInput input)
{
	...
	ret.position = mul(float4(input.position * input.offsetScale.w + input.offsetScale.xyz, 1.0f), _VertexShaderCB.ViewProjMtx);
