...
#include "YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule.h"
...
namespace
{
	FB_DECLARE_VAR_INT(g_varviewMode, "YesVertexStruct_NoIndex_YesInstanceType.viewMode", (int)fb::YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::ViewMode::Normal);
}

namespace fb
{
ShaderProgramPipelineCache YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::s_pipelineCache;
...
void YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::addPass(FrameGraph& frameGraph, FrameGraphBlackboard& blackboard)
{
	...
	FrameGraphMutableResource textureDepth_Buffer;
	{
		...
		frameGraph.addRc2CallbackPass<PassData>("YesVertexStruct_NoIndex_YesInstanceType.Initialization", [&](RenderPassBuilderBase& builder, PassData& data)
		{
			...
			// Texture: Color_Buffer
			{
				...
				desc.name = "YesVertexStruct_NoIndex_YesInstanceType.Color_Buffer";
			...
			// Texture: Depth_Buffer
			{
				...
				FrameGraphTextureDesc desc;
				desc.name = "YesVertexStruct_NoIndex_YesInstanceType.Depth_Buffer";
				desc.usage = RenderResourceUsage_Static;
				desc.initialState = FrameGraphTextureDesc::InitialState_Undefined;
				desc.type = type;
				desc.bindFlags = bindFlags;
	...
	// Draw Call: Rasterize
	{
		...
		frameGraph.addRc2CallbackPass<PassData>("YesVertexStruct_NoIndex_YesInstanceType.Rasterize",
		...
		[=](const PassData& data, const Rc2RenderPassResources& resources, CommandRecorder& commandRecorder)
		{
			...
			renderPassDesc.name = "YesVertexStruct_NoIndex_YesInstanceType.Rasterize";
			...
			graphicsPipelineCompileInfo.shaderProgram = ShaderProgram_YesVertexStruct_NoIndex_YesInstanceType_Rasterize_VSPS;
...
void YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::onInit(const InitParams& params)
{
...
YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule::~YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule()
{
