...
class YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule : public RefCountImpl<IRenderPassModule>
{
public:
	YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule() = default;
	virtual ~YesVertexStruct_NoIndex_YesInstanceTypeRenderPassModule();
