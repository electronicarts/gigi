...
class YesVertexStruct_NoIndex_YesInstanceTypeShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(YesVertexStruct_NoIndex_YesInstanceTypeShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
