...
class NoVertex_NoIndex_NoInstanceShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(NoVertex_NoIndex_NoInstanceShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
