...
class NoVertex_NoIndex_NoInstanceRenderPassModule : public RefCountImpl<IRenderPassModule>
{
public:
	NoVertex_NoIndex_NoInstanceRenderPassModule() = default;
	virtual ~NoVertex_NoIndex_NoInstanceRenderPassModule();
