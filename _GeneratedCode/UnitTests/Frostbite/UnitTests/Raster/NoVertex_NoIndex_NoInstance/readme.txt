...
Copy NoVertex_NoIndex_NoInstanceRenderPassModule.h and NoVertex_NoIndex_NoInstanceShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\NoVertex_NoIndex_NoInstance\

Copy NoVertex_NoIndex_NoInstanceRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\NoVertex_NoIndex_NoInstance\

Copy NoVertex_NoIndex_NoInstanceShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\NoVertex_NoIndex_NoInstance\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\NoVertex_NoIndex_NoInstance

Copy the shader files into Code\Engine\World\Render\sourcedata\source\NoVertex_NoIndex_NoInstance\
...
#include <Engine.World.Render/NoVertex_NoIndex_NoInstance/NoVertex_NoIndex_NoInstanceRenderPassModule.h>

moduleManager.registerModule<NoVertex_NoIndex_NoInstanceRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

NoVertex_NoIndex_NoInstanceRenderPassModule::addPass() in NoVertex_NoIndex_NoInstanceRenderPassModule.cpp has a todo at the top and
...
Systems/WorldRender/NoVertex_NoIndex_NoInstance/_VSPS_Rasterize.hlsl
