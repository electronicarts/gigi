...
class simpleRasterShaderProgramsProvider : public IShaderProgramsProvider
{
	FB_DECLARE_SHADERPROGRAMSPROVIDER(simpleRasterShaderProgramsProvider, IShaderProgramsProvider, WorldPipeline);
public:
