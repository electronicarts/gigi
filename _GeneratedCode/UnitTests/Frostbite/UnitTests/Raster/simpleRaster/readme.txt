...
Copy simpleRasterRenderPassModule.h and simpleRasterShaderPrograms.ddf into Code\Engine\World\Render\Public\Engine.World.Render\simpleRaster\

Copy simpleRasterRenderPassModule.cpp and any custom C++ logic files into Code\Engine\World\Render\simpleRaster\

Copy simpleRasterShaderProgramDefinitions.cpp and .h into Code\Engine\World\Pipeline\simpleRaster\

Copy the contents of the assets folder (if it exists) to the data directory: Raw\simpleRaster

Copy the shader files into Code\Engine\World\Render\sourcedata\source\simpleRaster\
...
#include <Engine.World.Render/simpleRaster/simpleRasterRenderPassModule.h>

moduleManager.registerModule<simpleRasterRenderPassModule>();

=====================================================================================================
Hook up inputs and outputs
=====================================================================================================

simpleRasterRenderPassModule::addPass() in simpleRasterRenderPassModule.cpp has a todo at the top and
...
Systems/WorldRender/simpleRaster/_VSPS_Rasterize.hlsl
