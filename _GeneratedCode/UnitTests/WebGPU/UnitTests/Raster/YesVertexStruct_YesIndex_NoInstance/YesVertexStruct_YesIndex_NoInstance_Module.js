...
class class_YesVertexStruct_YesIndex_NoInstance
{
...
// Buffer Index_Buffer
buffer_Index_Buffer = null;
buffer_Index_Buffer_count = 0;
buffer_Index_Buffer_stride = 0;
buffer_Index_Buffer_usageFlags = GPUBufferUsage.COPY_DST | GPUBufferUsage.STORAGE | GPUBufferUsage.INDEX;
buffer_Index_Buffer_indexFormat = "uint32"; // Can be "uint16" or "uint32"
...
variable_viewMode = this.constructor.Enum_ViewMode.UV;
variableDefault_viewMode = this.constructor.Enum_ViewMode.UV;
...
async ValidateImports()
{
    ...
    // Validate buffer Index_Buffer
    if (this.buffer_Index_Buffer === null)
    {
        Shared.LogError("Imported resource buffer_Index_Buffer was not provided");
        return false;
    }
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture YesVertexStruct_YesIndex_NoInstance.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture YesVertexStruct_YesIndex_NoInstance.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_YesVertexStruct_YesIndex_NoInstance.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_YesVertexStruct_YesIndex_NoInstance.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance.Color_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance.Color_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance.Depth_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance.Depth_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance.Vertex_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance.Vertex_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance.Index_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance.Index_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "YesVertexStruct_YesIndex_NoInstance._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance._VertexShaderCB"

    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance._PixelShaderCB");
    ...
    if (this.constantBuffer__PixelShaderCB === null)
    {
        this.constantBuffer__PixelShaderCB = device.createBuffer({
            label: "YesVertexStruct_YesIndex_NoInstance._PixelShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance._PixelShaderCB"

    encoder.pushDebugGroup("YesVertexStruct_YesIndex_NoInstance.Rasterize");
    ...
    // Run draw call shader Rasterize
    {
        ...
        const indexCountPerInstance = this.buffer_Index_Buffer_count;
        ...
        if (this.Pipeline_DrawCall_Rasterize !== null)
        {
            const passEncoder = encoder.beginRenderPass(renderPassDescriptor);
                ...
                passEncoder.setIndexBuffer(this.buffer_Index_Buffer, this.buffer_Index_Buffer_indexFormat);
                passEncoder.drawIndexed(indexCountPerInstance, instanceCount);
            passEncoder.end();
        }
    }

    encoder.popDebugGroup(); // "YesVertexStruct_YesIndex_NoInstance.Rasterize"
...
var YesVertexStruct_YesIndex_NoInstance = new class_YesVertexStruct_YesIndex_NoInstance;

export default YesVertexStruct_YesIndex_NoInstance;
