...
class class_YesVertexStruct_NoIndex_YesInstanceStruct
{
...
// Vertex buffer attributes for struct InstanceBufferFormat
static StructVertexBufferAttributes_InstanceBufferFormat =
[
    // Offset
    {
        format: "float32x3",
...
static StructOffsets_InstanceBufferFormat =
{
    Offset_0: 0,
    Offset_1: 4,
    Offset_2: 8,
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture YesVertexStruct_NoIndex_YesInstanceStruct.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture YesVertexStruct_NoIndex_YesInstanceStruct.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_YesVertexStruct_NoIndex_YesInstanceStruct.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_YesVertexStruct_NoIndex_YesInstanceStruct.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct.Color_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct.Color_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct.Depth_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct.Depth_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct.Vertex_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct.Vertex_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct.Instance_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct.Instance_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "YesVertexStruct_NoIndex_YesInstanceStruct._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct._VertexShaderCB"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct._PixelShaderCB");
    ...
    if (this.constantBuffer__PixelShaderCB === null)
    {
        this.constantBuffer__PixelShaderCB = device.createBuffer({
            label: "YesVertexStruct_NoIndex_YesInstanceStruct._PixelShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct._PixelShaderCB"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_YesInstanceStruct.Rasterize");
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_YesInstanceStruct.Rasterize"
...
var YesVertexStruct_NoIndex_YesInstanceStruct = new class_YesVertexStruct_NoIndex_YesInstanceStruct;

export default YesVertexStruct_NoIndex_YesInstanceStruct;
