...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture simpleRaster2.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture simpleRaster2.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_simpleRaster2.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_simpleRaster2.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("simpleRaster2.VertexBuffer");

    encoder.popDebugGroup(); // "simpleRaster2.VertexBuffer"

    encoder.pushDebugGroup("simpleRaster2.Color_Buffer");

    encoder.popDebugGroup(); // "simpleRaster2.Color_Buffer"

    encoder.pushDebugGroup("simpleRaster2.Depth_Buffer");

    encoder.popDebugGroup(); // "simpleRaster2.Depth_Buffer"

    encoder.pushDebugGroup("simpleRaster2._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "simpleRaster2._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "simpleRaster2._VertexShaderCB"

    encoder.pushDebugGroup("simpleRaster2.Rasterize");
    ...
    encoder.popDebugGroup(); // "simpleRaster2.Rasterize"
...
var simpleRaster2 = new class_simpleRaster2;

export default simpleRaster2;
