...
class class_simpleRaster_Points
{
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture simpleRaster_Points.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture simpleRaster_Points.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_simpleRaster_Points.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_simpleRaster_Points.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("simpleRaster_Points.VertexBuffer");

    encoder.popDebugGroup(); // "simpleRaster_Points.VertexBuffer"

    encoder.pushDebugGroup("simpleRaster_Points.Color_Buffer");

    encoder.popDebugGroup(); // "simpleRaster_Points.Color_Buffer"

    encoder.pushDebugGroup("simpleRaster_Points.Depth_Buffer");

    encoder.popDebugGroup(); // "simpleRaster_Points.Depth_Buffer"

    encoder.pushDebugGroup("simpleRaster_Points._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "simpleRaster_Points._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "simpleRaster_Points._VertexShaderCB"

    encoder.pushDebugGroup("simpleRaster_Points.Rasterize");
    ...
    encoder.popDebugGroup(); // "simpleRaster_Points.Rasterize"
...
var simpleRaster_Points = new class_simpleRaster_Points;

export default simpleRaster_Points;
