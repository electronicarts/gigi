...
class class_YesVertexStruct_NoIndex_NoInstance
{
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture YesVertexStruct_NoIndex_NoInstance.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture YesVertexStruct_NoIndex_NoInstance.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_YesVertexStruct_NoIndex_NoInstance.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_YesVertexStruct_NoIndex_NoInstance.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("YesVertexStruct_NoIndex_NoInstance.Color_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_NoInstance.Color_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_NoInstance.Depth_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_NoInstance.Depth_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_NoInstance.Vertex_Buffer");

    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_NoInstance.Vertex_Buffer"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_NoInstance._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "YesVertexStruct_NoIndex_NoInstance._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_NoInstance._VertexShaderCB"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_NoInstance._PixelShaderCB");
    ...
    if (this.constantBuffer__PixelShaderCB === null)
    {
        this.constantBuffer__PixelShaderCB = device.createBuffer({
            label: "YesVertexStruct_NoIndex_NoInstance._PixelShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_NoInstance._PixelShaderCB"

    encoder.pushDebugGroup("YesVertexStruct_NoIndex_NoInstance.Rasterize");
    ...
    encoder.popDebugGroup(); // "YesVertexStruct_NoIndex_NoInstance.Rasterize"
...
var YesVertexStruct_NoIndex_NoInstance = new class_YesVertexStruct_NoIndex_NoInstance;

export default YesVertexStruct_NoIndex_NoInstance;
