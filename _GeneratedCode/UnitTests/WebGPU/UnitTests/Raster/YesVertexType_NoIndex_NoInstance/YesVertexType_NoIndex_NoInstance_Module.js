...
class class_YesVertexType_NoIndex_NoInstance
{
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture YesVertexType_NoIndex_NoInstance.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture YesVertexType_NoIndex_NoInstance.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_YesVertexType_NoIndex_NoInstance.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_YesVertexType_NoIndex_NoInstance.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("YesVertexType_NoIndex_NoInstance.Color_Buffer");

    encoder.popDebugGroup(); // "YesVertexType_NoIndex_NoInstance.Color_Buffer"

    encoder.pushDebugGroup("YesVertexType_NoIndex_NoInstance.Depth_Buffer");

    encoder.popDebugGroup(); // "YesVertexType_NoIndex_NoInstance.Depth_Buffer"

    encoder.pushDebugGroup("YesVertexType_NoIndex_NoInstance.Vertex_Buffer");

    encoder.popDebugGroup(); // "YesVertexType_NoIndex_NoInstance.Vertex_Buffer"

    encoder.pushDebugGroup("YesVertexType_NoIndex_NoInstance._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "YesVertexType_NoIndex_NoInstance._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "YesVertexType_NoIndex_NoInstance._VertexShaderCB"

    encoder.pushDebugGroup("YesVertexType_NoIndex_NoInstance.Rasterize");
    ...
    encoder.popDebugGroup(); // "YesVertexType_NoIndex_NoInstance.Rasterize"
...
var YesVertexType_NoIndex_NoInstance = new class_YesVertexType_NoIndex_NoInstance;

export default YesVertexType_NoIndex_NoInstance;
