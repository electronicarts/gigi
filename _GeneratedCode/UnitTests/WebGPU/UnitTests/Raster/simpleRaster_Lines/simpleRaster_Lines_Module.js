...
class class_simpleRaster_Lines
{
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Color_Buffer
    {
        ...
        if (this.texture_Color_Buffer === null)
        {
            ...
            this.texture_Color_Buffer = device.createTexture({
                label: "texture simpleRaster_Lines.Color_Buffer",
    ...
    // Handle (re)creation of texture Depth_Buffer
    {
        ...
        if (this.texture_Depth_Buffer === null)
        {
            ...
            this.texture_Depth_Buffer = device.createTexture({
                label: "texture simpleRaster_Lines.Depth_Buffer",
    ...
    // (Re)create draw call shader Rasterize
    {
        ...
        if (this.ShaderModule_DrawCall_Rasterize === null || newHash !== this.Hash_DrawCall_Rasterize)
        {
            ...
            let shaderCodeVS = class_simpleRaster_Lines.ShaderCode_Rasterize_VertexShader;
            let shaderCodePS = class_simpleRaster_Lines.ShaderCode_Rasterize_PixelShader;
...
{
    encoder.pushDebugGroup("simpleRaster_Lines.VertexBuffer");

    encoder.popDebugGroup(); // "simpleRaster_Lines.VertexBuffer"

    encoder.pushDebugGroup("simpleRaster_Lines.Color_Buffer");

    encoder.popDebugGroup(); // "simpleRaster_Lines.Color_Buffer"

    encoder.pushDebugGroup("simpleRaster_Lines.Depth_Buffer");

    encoder.popDebugGroup(); // "simpleRaster_Lines.Depth_Buffer"

    encoder.pushDebugGroup("simpleRaster_Lines._VertexShaderCB");
    ...
    if (this.constantBuffer__VertexShaderCB === null)
    {
        this.constantBuffer__VertexShaderCB = device.createBuffer({
            label: "simpleRaster_Lines._VertexShaderCB",
    ...
    encoder.popDebugGroup(); // "simpleRaster_Lines._VertexShaderCB"

    encoder.pushDebugGroup("simpleRaster_Lines.Rasterize");
    ...
    encoder.popDebugGroup(); // "simpleRaster_Lines.Rasterize"
...
var simpleRaster_Lines = new class_simpleRaster_Lines;

export default simpleRaster_Lines;
