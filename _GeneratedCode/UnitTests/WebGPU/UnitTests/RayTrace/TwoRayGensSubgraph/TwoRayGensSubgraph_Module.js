...
class class_TwoRayGensSubgraph
{
loadingPromises = new Set();
waitingOnPromises = false;

// -------------------- Shaders
// Shader code for Non BVH Variation of RTRayGen shader "A_TwoRayGens1", node "A_DoRT1"
static ShaderCode_A_DoRT1_A_TwoRayGens1_NonBVH = `
struct _MatrixStorage_float4x4std140_0
{
    @align(16) data_0 : array<vec4<f32>, i32(4)>,
};

struct Struct_A_TwoRayGens1CB_std140_0
{
    @align(16) _dispatchSize_A_TwoRayGens1_0 : vec3<u32>,
...
@binding(3) @group(0) var<uniform> _A_TwoRayGens1CB : Struct_A_TwoRayGens1CB_std140_0;
struct Struct_VertexBufferSimple_std430_0
{
    @align(16) Position_0 : vec3<f32>,
    @align(4) _padding0_1 : f32,
};

@binding(1) @group(0) var<storage, read> g_scene : array<Struct_VertexBufferSimple_std430_0>;
...
fn RayGen1(@builtin(global_invocation_id) DTid_0 : vec3<u32>)
{
    ...
    var _S40 : vec2<f32> = (vec2<f32>(px_0) + vec2<f32>(0.5f)) / vec2<f32>(_A_TwoRayGens1CB._dispatchSize_A_TwoRayGens1_0.xy) * vec2<f32>(2.0f) - vec2<f32>(1.0f);
    var screenPos_0 : vec2<f32> = _S40;
    screenPos_0[i32(1)] = - _S40.y;
    var _S41 : vec4<f32> = (((mat4x4<f32>(_A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(3)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(3)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(3)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(3)])) * (vec4<f32>(screenPos_0, _A_TwoRayGens1CB.depthNearPlane_0, 1.0f))));
    ...
    world_0.z = _S42.z;
    var ray_0 : RayDesc_0;
    var _S43 : vec3<f32> = _A_TwoRayGens1CB.cameraPos_0;
    ray_0.Origin_0 = _A_TwoRayGens1CB.cameraPos_0;
...
// Shader code for BVH Variation of RTRayGen shader "A_TwoRayGens1", node "A_DoRT1"
static ShaderCode_A_DoRT1_A_TwoRayGens1_BVH = `
struct _MatrixStorage_float4x4std140_0
{
    @align(16) data_0 : array<vec4<f32>, i32(4)>,
};
...
{
    var px_0 : vec2<u32> = DTid_0.xy;
    var _S53 : vec2<f32> = (vec2<f32>(px_0) + vec2<f32>(0.5f)) / vec2<f32>(_A_TwoRayGens1CB._dispatchSize_A_TwoRayGens1_0.xy) * vec2<f32>(2.0f) - vec2<f32>(1.0f);
    var screenPos_0 : vec2<f32> = _S53;
    screenPos_0[i32(1)] = - _S53.y;
    var _S54 : vec4<f32> = (((mat4x4<f32>(_A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(0)][i32(3)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(1)][i32(3)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(2)][i32(3)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(0)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(1)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(2)], _A_TwoRayGens1CB.clipToWorld_0.data_0[i32(3)][i32(3)])) * (vec4<f32>(screenPos_0, _A_TwoRayGens1CB.depthNearPlane_0, 1.0f))));
    ...
    world_0.z = _S55.z;
    var ray_0 : RayDesc_0;
    var _S56 : vec3<f32> = _A_TwoRayGens1CB.cameraPos_0;
    ray_0.Origin_0 = _A_TwoRayGens1CB.cameraPos_0;
...
// Shader code for Non BVH Variation of RTRayGen shader "B_TwoRayGens2", node "B_DoRT2"
static ShaderCode_B_DoRT2_B_TwoRayGens2_NonBVH = `
struct _MatrixStorage_float4x4std140_0
{
    @align(16) data_0 : array<vec4<f32>, i32(4)>,
};

struct Struct_B_TwoRayGens2CB_std140_0
{
    @align(16) _dispatchSize_B_TwoRayGens2_0 : vec3<u32>,
    @align(4) _padding0_0 : f32,
    @align(16) cameraPos_0 : vec3<f32>,
    @align(4) _padding1_0 : f32,
    @align(16) clipToWorld_0 : _MatrixStorage_float4x4std140_0,
...
@binding(4) @group(0) var<uniform> _B_TwoRayGens2CB : Struct_B_TwoRayGens2CB_std140_0;
struct Struct_VertexBufferSimple_std430_0
{
    @align(16) Position_0 : vec3<f32>,
    @align(4) _padding0_1 : f32,
...
{
    var px_0 : vec2<u32> = DTid_0.xy;
    var _S40 : vec2<f32> = vec2<f32>(_B_TwoRayGens2CB._dispatchSize_B_TwoRayGens2_0.xy);
    ...
    var _S42 : vec4<f32> = (((mat4x4<f32>(_B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(3)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(3)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(3)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(3)])) * (vec4<f32>(screenPos_0, _B_TwoRayGens2CB.depthNearPlane_0, 1.0f))));
    ...
    world_0.z = _S43.z;
    var ray_0 : RayDesc_0;
    var _S44 : vec3<f32> = _B_TwoRayGens2CB.cameraPos_0;
    ray_0.Origin_0 = _B_TwoRayGens2CB.cameraPos_0;
...
// Shader code for BVH Variation of RTRayGen shader "B_TwoRayGens2", node "B_DoRT2"
static ShaderCode_B_DoRT2_B_TwoRayGens2_BVH = `
struct _MatrixStorage_float4x4std140_0
{
    @align(16) data_0 : array<vec4<f32>, i32(4)>,
};
...
{
    var px_0 : vec2<u32> = DTid_0.xy;
    var _S53 : vec2<f32> = vec2<f32>(_B_TwoRayGens2CB._dispatchSize_B_TwoRayGens2_0.xy);
    ...
    var _S55 : vec4<f32> = (((mat4x4<f32>(_B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(0)][i32(3)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(1)][i32(3)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(2)][i32(3)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(0)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(1)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(2)], _B_TwoRayGens2CB.clipToWorld_0.data_0[i32(3)][i32(3)])) * (vec4<f32>(screenPos_0, _B_TwoRayGens2CB.depthNearPlane_0, 1.0f))));
    ...
    world_0.z = _S56.z;
    var ray_0 : RayDesc_0;
    var _S57 : vec3<f32> = _B_TwoRayGens2CB.cameraPos_0;
    ray_0.Origin_0 = _B_TwoRayGens2CB.cameraPos_0;
...
// Vertex buffer attributes for struct A_VertexBuffer
static StructVertexBufferAttributes_A_VertexBuffer =
[
    // Color
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct A_VertexBufferSimple
static StructVertexBufferAttributes_A_VertexBufferSimple =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct A_VertexBufferFull
static StructVertexBufferAttributes_A_VertexBufferFull =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct B_VertexBuffer
static StructVertexBufferAttributes_B_VertexBuffer =
[
    // Color
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct B_VertexBufferSimple
static StructVertexBufferAttributes_B_VertexBufferSimple =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct B_VertexBufferFull
static StructVertexBufferAttributes_B_VertexBufferFull =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct A_VertexBuffer_Unpadded
static StructVertexBufferAttributes_A_VertexBuffer_Unpadded =
[
    // Color
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct A_VertexBufferSimple_Unpadded
static StructVertexBufferAttributes_A_VertexBufferSimple_Unpadded =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct A_VertexBufferFull_Unpadded
static StructVertexBufferAttributes_A_VertexBufferFull_Unpadded =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct B_VertexBuffer_Unpadded
static StructVertexBufferAttributes_B_VertexBuffer_Unpadded =
[
    // Color
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct B_VertexBufferSimple_Unpadded
static StructVertexBufferAttributes_B_VertexBufferSimple_Unpadded =
[
    // Position
    {
        format: "float32x3",
...
// Vertex buffer attributes for struct B_VertexBufferFull_Unpadded
static StructVertexBufferAttributes_B_VertexBufferFull_Unpadded =
[
    // Position
    {
        format: "float32x3",
...
// Texture A_DoRT1_g_texture_ReadOnly : This is a read only texture copy to help get around read-write storage texture format limitations.
texture_A_DoRT1_g_texture_ReadOnly = null;
texture_A_DoRT1_g_texture_ReadOnly_size = [0, 0, 0];
texture_A_DoRT1_g_texture_ReadOnly_format = "";
texture_A_DoRT1_g_texture_ReadOnly_usageFlags = GPUTextureUsage.COPY_DST | GPUTextureUsage.COPY_SRC | GPUTextureUsage.STORAGE_BINDING;

// Texture B_DoRT2_g_texture_ReadOnly : This is a read only texture copy to help get around read-write storage texture format limitations.
texture_B_DoRT2_g_texture_ReadOnly = null;
texture_B_DoRT2_g_texture_ReadOnly_size = [0, 0, 0];
texture_B_DoRT2_g_texture_ReadOnly_format = "";
texture_B_DoRT2_g_texture_ReadOnly_usageFlags = GPUTextureUsage.COPY_DST | GPUTextureUsage.COPY_SRC | GPUTextureUsage.STORAGE_BINDING;

// Constant buffer _A_TwoRayGens1CB
constantBuffer__A_TwoRayGens1CB = null;
constantBuffer__A_TwoRayGens1CB_size = 112;
constantBuffer__A_TwoRayGens1CB_usageFlags = GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM;

// RayGen Shader A_DoRT1
Hash_RayGen_A_DoRT1 = 0;
ShaderModule_RayGen_A_DoRT1 = null;
BindGroupLayout_RayGen_A_DoRT1 = null;
PipelineLayout_RayGen_A_DoRT1 = null;
Pipeline_RayGen_A_DoRT1 = null;

// Constant buffer _B_TwoRayGens2CB
constantBuffer__B_TwoRayGens2CB = null;
constantBuffer__B_TwoRayGens2CB_size = 112;
constantBuffer__B_TwoRayGens2CB_usageFlags = GPUBufferUsage.COPY_DST | GPUBufferUsage.UNIFORM;

// RayGen Shader B_DoRT2
Hash_RayGen_B_DoRT2 = 0;
ShaderModule_RayGen_B_DoRT2 = null;
BindGroupLayout_RayGen_B_DoRT2 = null;
PipelineLayout_RayGen_B_DoRT2 = null;
Pipeline_RayGen_B_DoRT2 = null;
...
variable__dispatchSize_B_TwoRayGens2 = [ 0,0,0 ];
variableDefault__dispatchSize_B_TwoRayGens2 = [ 0,0,0 ];
variableChanged__dispatchSize_B_TwoRayGens2 = [ false, false, false ];
// -------------------- Structs
...
static StructOffsets_A_VertexBuffer =
{
    Color_0: 0,
    Color_1: 4,
    Color_2: 8,
...
static StructOffsets_A_VertexBufferSimple =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets_A_VertexBufferFull =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets_B_VertexBuffer =
{
    Color_0: 0,
    Color_1: 4,
    Color_2: 8,
...
static StructOffsets_B_VertexBufferSimple =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets_B_VertexBufferFull =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets__A_TwoRayGens1CB =
{
    _dispatchSize_A_TwoRayGens1_0: 0,
    _dispatchSize_A_TwoRayGens1_1: 4,
    _dispatchSize_A_TwoRayGens1_2: 8,
    _padding0: 12,
    cameraPos_0: 16,
    cameraPos_1: 20,
    cameraPos_2: 24,
...
static StructOffsets__B_TwoRayGens2CB =
{
    _dispatchSize_B_TwoRayGens2_0: 0,
    _dispatchSize_B_TwoRayGens2_1: 4,
    _dispatchSize_B_TwoRayGens2_2: 8,
    _padding0: 12,
    cameraPos_0: 16,
    cameraPos_1: 20,
    cameraPos_2: 24,
...
static StructOffsets_A_VertexBuffer_Unpadded =
{
    Color_0: 0,
    Color_1: 4,
    Color_2: 8,
...
static StructOffsets_A_VertexBufferSimple_Unpadded =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets_A_VertexBufferFull_Unpadded =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets_B_VertexBuffer_Unpadded =
{
    Color_0: 0,
    Color_1: 4,
    Color_2: 8,
...
static StructOffsets_B_VertexBufferSimple_Unpadded =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
static StructOffsets_B_VertexBufferFull_Unpadded =
{
    Position_0: 0,
    Position_1: 4,
    Position_2: 8,
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture Texture
    {
        ...
        if (this.texture_Texture === null)
        {
            ...
            this.texture_Texture = device.createTexture({
                label: "texture TwoRayGensSubgraph.Texture",
    ...
    // Handle (re)creation of texture A_DoRT1_g_texture_ReadOnly
    {
        ...
        if (this.texture_A_DoRT1_g_texture_ReadOnly !== null && (this.texture_A_DoRT1_g_texture_ReadOnly_format != desiredFormat || this.texture_A_DoRT1_g_texture_ReadOnly_size[0] != desiredSize[0] || this.texture_A_DoRT1_g_texture_ReadOnly_size[1] != desiredSize[1] || this.texture_A_DoRT1_g_texture_ReadOnly_size[2] != desiredSize[2]))
        {
            this.texture_A_DoRT1_g_texture_ReadOnly.destroy();
            this.texture_A_DoRT1_g_texture_ReadOnly = null;
        }

        if (this.texture_A_DoRT1_g_texture_ReadOnly === null)
        {
            this.texture_A_DoRT1_g_texture_ReadOnly_size = desiredSize.slice();
            this.texture_A_DoRT1_g_texture_ReadOnly_format = desiredFormat;

            let viewFormats = [];
            if (Shared.IsSRGBFormat(this.texture_A_DoRT1_g_texture_ReadOnly_format))
                viewFormats.push(this.texture_A_DoRT1_g_texture_ReadOnly_format);

            this.texture_A_DoRT1_g_texture_ReadOnly = device.createTexture({
                label: "texture TwoRayGensSubgraph.A_DoRT1_g_texture_ReadOnly",
                size: this.texture_A_DoRT1_g_texture_ReadOnly_size,
                format: Shared.GetNonSRGBFormat(this.texture_A_DoRT1_g_texture_ReadOnly_format),
                usage: this.texture_A_DoRT1_g_texture_ReadOnly_usageFlags,
                viewFormats: viewFormats,
            });
        }
    }

    // Handle (re)creation of texture B_DoRT2_g_texture_ReadOnly
    {
        const baseSize = this.texture_Texture_size.slice();
        const desiredSize = [
            Math.floor(((parseInt(baseSize[0]) + 0) * 1) / 1) + 0,
        ...
        const desiredFormat = this.texture_Texture_format;
        if (this.texture_B_DoRT2_g_texture_ReadOnly !== null && (this.texture_B_DoRT2_g_texture_ReadOnly_format != desiredFormat || this.texture_B_DoRT2_g_texture_ReadOnly_size[0] != desiredSize[0] || this.texture_B_DoRT2_g_texture_ReadOnly_size[1] != desiredSize[1] || this.texture_B_DoRT2_g_texture_ReadOnly_size[2] != desiredSize[2]))
        {
            this.texture_B_DoRT2_g_texture_ReadOnly.destroy();
            this.texture_B_DoRT2_g_texture_ReadOnly = null;
        }

        if (this.texture_B_DoRT2_g_texture_ReadOnly === null)
        {
            this.texture_B_DoRT2_g_texture_ReadOnly_size = desiredSize.slice();
            this.texture_B_DoRT2_g_texture_ReadOnly_format = desiredFormat;

            let viewFormats = [];
            if (Shared.IsSRGBFormat(this.texture_B_DoRT2_g_texture_ReadOnly_format))
                viewFormats.push(this.texture_B_DoRT2_g_texture_ReadOnly_format);

            this.texture_B_DoRT2_g_texture_ReadOnly = device.createTexture({
                label: "texture TwoRayGensSubgraph.B_DoRT2_g_texture_ReadOnly",
                size: this.texture_B_DoRT2_g_texture_ReadOnly_size,
                format: Shared.GetNonSRGBFormat(this.texture_B_DoRT2_g_texture_ReadOnly_format),
                usage: this.texture_B_DoRT2_g_texture_ReadOnly_usageFlags,
                viewFormats: viewFormats,
            });
        }
    }

    // (Re)create raygen shader A_DoRT1
    {
        ...
        [
            ...
            },
            {
                ...
                binding: 2,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_A_DoRT1_g_texture_ReadOnly_format), viewDimension: "2d" }
            },
            {
                // _A_TwoRayGens1CB
                binding: 3,
        ...
        if (this.ShaderModule_RayGen_A_DoRT1 === null || newHash !== this.Hash_RayGen_A_DoRT1)
        {
            this.Hash_RayGen_A_DoRT1 = newHash;

            let shaderCode = this.buffer_Scene_isBVH
                ? class_TwoRayGensSubgraph.ShaderCode_A_DoRT1_A_TwoRayGens1_BVH
                : class_TwoRayGensSubgraph.ShaderCode_A_DoRT1_A_TwoRayGens1_NonBVH
            ;
            ...
            shaderCode = shaderCode.replace("/*(g_textureReadOnly_format)*/", Shared.GetNonSRGBFormat(this.texture_A_DoRT1_g_texture_ReadOnly_format));

            this.ShaderModule_RayGen_A_DoRT1 = device.createShaderModule({ code: shaderCode, label: "RayGen Shader A_DoRT1"});
            this.BindGroupLayout_RayGen_A_DoRT1 = device.createBindGroupLayout({
                label: "RayGen Bind Group Layout A_DoRT1",
                entries: bindGroupEntries
            });

            this.PipelineLayout_RayGen_A_DoRT1 = device.createPipelineLayout({
                label: "RayGen Pipeline Layout A_DoRT1",
                bindGroupLayouts: [this.BindGroupLayout_RayGen_A_DoRT1],
            });

            if (useBlockingAPIs)
            {
                this.Pipeline_RayGen_A_DoRT1 = device.createComputePipeline({
                    label: "RayGen Pipeline A_DoRT1",
                    layout: this.PipelineLayout_RayGen_A_DoRT1,
                    compute: {
                        module: this.ShaderModule_RayGen_A_DoRT1,
                        entryPoint: "RayGen1",
                    }
                });
            }
            ...
            {
                this.loadingPromises.add("A_DoRT1");
                ...
                }).then( handle => { this.Pipeline_RayGen_A_DoRT1 = handle; this.loadingPromises.delete("A_DoRT1"); } );
            }
        }
    }

    // (Re)create raygen shader B_DoRT2
    {
        const bindGroupEntries =
        [
            {
            ...
            },
            {
                ...
                binding: 3,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_B_DoRT2_g_texture_ReadOnly_format), viewDimension: "2d" }
            },
            {
                // _B_TwoRayGens2CB
                binding: 4,
        ...
        if (this.ShaderModule_RayGen_B_DoRT2 === null || newHash !== this.Hash_RayGen_B_DoRT2)
        {
            this.Hash_RayGen_B_DoRT2 = newHash;

            let shaderCode = this.buffer_Scene_isBVH
                ? class_TwoRayGensSubgraph.ShaderCode_B_DoRT2_B_TwoRayGens2_BVH
                : class_TwoRayGensSubgraph.ShaderCode_B_DoRT2_B_TwoRayGens2_NonBVH
            ;
            shaderCode = "fn SCENE_IS_AABBS() -> bool { return " + this.buffer_Scene_isAABBs.toString() + "; }\n" + shaderCode;
            shaderCode = shaderCode.replace("/*(g_texture_format)*/", Shared.GetNonSRGBFormat(this.texture_Texture_format));
            shaderCode = shaderCode.replace("/*(g_textureReadOnly_format)*/", Shared.GetNonSRGBFormat(this.texture_B_DoRT2_g_texture_ReadOnly_format));

            this.ShaderModule_RayGen_B_DoRT2 = device.createShaderModule({ code: shaderCode, label: "RayGen Shader B_DoRT2"});
            this.BindGroupLayout_RayGen_B_DoRT2 = device.createBindGroupLayout({
                label: "RayGen Bind Group Layout B_DoRT2",
                entries: bindGroupEntries
            });

            this.PipelineLayout_RayGen_B_DoRT2 = device.createPipelineLayout({
                label: "RayGen Pipeline Layout B_DoRT2",
                bindGroupLayouts: [this.BindGroupLayout_RayGen_B_DoRT2],
            });

            if (useBlockingAPIs)
            {
                this.Pipeline_RayGen_B_DoRT2 = device.createComputePipeline({
                    label: "RayGen Pipeline B_DoRT2",
                    layout: this.PipelineLayout_RayGen_B_DoRT2,
                    compute: {
                        module: this.ShaderModule_RayGen_B_DoRT2,
                        entryPoint: "RayGen2",
                    }
                });
            }
            ...
            {
                this.loadingPromises.add("B_DoRT2");
                ...
                }).then( handle => { this.Pipeline_RayGen_B_DoRT2 = handle; this.loadingPromises.delete("B_DoRT2"); } );
            }
        }
    }
...
{
    encoder.pushDebugGroup("TwoRayGensSubgraph.Texture");

    encoder.popDebugGroup(); // "TwoRayGensSubgraph.Texture"

    encoder.pushDebugGroup("TwoRayGensSubgraph.Scene");

    encoder.popDebugGroup(); // "TwoRayGensSubgraph.Scene"

    encoder.pushDebugGroup("TwoRayGensSubgraph.BlueChannel");

    encoder.popDebugGroup(); // "TwoRayGensSubgraph.BlueChannel"

    encoder.pushDebugGroup("TwoRayGensSubgraph.A_DoRT1_g_texture_ReadOnly");

    encoder.popDebugGroup(); // "TwoRayGensSubgraph.A_DoRT1_g_texture_ReadOnly"

    encoder.pushDebugGroup("TwoRayGensSubgraph.Copy_A_DoRT1_g_texture");

    // Copy texture Texture to texture A_DoRT1_g_texture_ReadOnly
    {
        const numMips = Math.min(this.texture_Texture.mipLevelCount, this.texture_A_DoRT1_g_texture_ReadOnly.mipLevelCount);
        ...
        for (let mipIndex = 0; mipIndex < numMips; ++mipIndex)
        {
            ...
            encoder.copyTextureToTexture(
                ...
                { texture: this.texture_A_DoRT1_g_texture_ReadOnly, mipLevel: mipIndex },
                {
                    width: mipWidth,
                    height: mipHeight,
    ...
    encoder.popDebugGroup(); // "TwoRayGensSubgraph.Copy_A_DoRT1_g_texture"

    encoder.pushDebugGroup("TwoRayGensSubgraph.B_DoRT2_g_texture_ReadOnly");

    encoder.popDebugGroup(); // "TwoRayGensSubgraph.B_DoRT2_g_texture_ReadOnly"

    encoder.pushDebugGroup("TwoRayGensSubgraph._A_TwoRayGens1CB");

    // Create constant buffer _A_TwoRayGens1CB
    if (this.constantBuffer__A_TwoRayGens1CB === null)
    {
        this.constantBuffer__A_TwoRayGens1CB = device.createBuffer({
            label: "TwoRayGensSubgraph._A_TwoRayGens1CB",
            size: Shared.Align(16, this.constructor.StructOffsets__A_TwoRayGens1CB._size),
            usage: this.constantBuffer__A_TwoRayGens1CB_usageFlags,
        });
    }

    // Upload values to constant buffer _A_TwoRayGens1CB
    {
        const bufferCPU = new ArrayBuffer(Shared.Align(16, this.constructor.StructOffsets__A_TwoRayGens1CB._size));
        const view = new DataView(bufferCPU);
        view.setUint32(this.constructor.StructOffsets__A_TwoRayGens1CB._dispatchSize_A_TwoRayGens1_0, this.variable__dispatchSize_A_TwoRayGens1[0], true);
        view.setUint32(this.constructor.StructOffsets__A_TwoRayGens1CB._dispatchSize_A_TwoRayGens1_1, this.variable__dispatchSize_A_TwoRayGens1[1], true);
        view.setUint32(this.constructor.StructOffsets__A_TwoRayGens1CB._dispatchSize_A_TwoRayGens1_2, this.variable__dispatchSize_A_TwoRayGens1[2], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.cameraPos_0, this.variable_cameraPos[0], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.cameraPos_1, this.variable_cameraPos[1], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.cameraPos_2, this.variable_cameraPos[2], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_0, this.variable_clipToWorld[0], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_1, this.variable_clipToWorld[1], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_2, this.variable_clipToWorld[2], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_3, this.variable_clipToWorld[3], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_4, this.variable_clipToWorld[4], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_5, this.variable_clipToWorld[5], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_6, this.variable_clipToWorld[6], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_7, this.variable_clipToWorld[7], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_8, this.variable_clipToWorld[8], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_9, this.variable_clipToWorld[9], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_10, this.variable_clipToWorld[10], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_11, this.variable_clipToWorld[11], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_12, this.variable_clipToWorld[12], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_13, this.variable_clipToWorld[13], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_14, this.variable_clipToWorld[14], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.clipToWorld_15, this.variable_clipToWorld[15], true);
        view.setFloat32(this.constructor.StructOffsets__A_TwoRayGens1CB.depthNearPlane, this.variable_depthNearPlane, true);
        device.queue.writeBuffer(this.constantBuffer__A_TwoRayGens1CB, 0, bufferCPU);
    }

    encoder.popDebugGroup(); // "TwoRayGensSubgraph._A_TwoRayGens1CB"

    encoder.pushDebugGroup("TwoRayGensSubgraph.A_DoRT1");

    // Run raygen shader A_DoRT1
    {
        const bindGroup = device.createBindGroup({
            label: "RayGen Bind Group A_DoRT1",
            layout: this.BindGroupLayout_RayGen_A_DoRT1,
            entries: [
                {
                    // g_texture
                    binding: 0,
                ...
                },
                {
                    // g_textureReadOnly
                    binding: 2,
                    resource: this.texture_A_DoRT1_g_texture_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 0 })
                },
                {
                    // _A_TwoRayGens1CB
                    binding: 3,
                    resource: { buffer: this.constantBuffer__A_TwoRayGens1CB }
                },
            ]
        });
        ...
        // Update the dispatch size in the constant buffer
        {
            ...
            device.queue.writeBuffer(this.constantBuffer__A_TwoRayGens1CB, this.constructor.StructOffsets__A_TwoRayGens1CB._dispatchSize_A_TwoRayGens1_0, specialVariablesBuffer);
        }

        if (this.Pipeline_RayGen_A_DoRT1 !== null)
        {
            const computePass = encoder.beginComputePass();
                computePass.setPipeline(this.Pipeline_RayGen_A_DoRT1);
    ...
    encoder.popDebugGroup(); // "TwoRayGensSubgraph.A_DoRT1"

    encoder.pushDebugGroup("TwoRayGensSubgraph.Copy_B_DoRT2_g_texture");

    // Copy texture Texture to texture B_DoRT2_g_texture_ReadOnly
    {
        const numMips = Math.min(this.texture_Texture.mipLevelCount, this.texture_B_DoRT2_g_texture_ReadOnly.mipLevelCount);
        ...
        for (let mipIndex = 0; mipIndex < numMips; ++mipIndex)
        {
            ...
            encoder.copyTextureToTexture(
                { texture: this.texture_Texture, mipLevel: mipIndex },
                { texture: this.texture_B_DoRT2_g_texture_ReadOnly, mipLevel: mipIndex },
                {
                    width: mipWidth,
                    height: mipHeight,
                    depthOrArrayLayers: mipDepth,
    ...
    encoder.popDebugGroup(); // "TwoRayGensSubgraph.Copy_B_DoRT2_g_texture"

    encoder.pushDebugGroup("TwoRayGensSubgraph._B_TwoRayGens2CB");

    // Create constant buffer _B_TwoRayGens2CB
    if (this.constantBuffer__B_TwoRayGens2CB === null)
    {
        this.constantBuffer__B_TwoRayGens2CB = device.createBuffer({
            label: "TwoRayGensSubgraph._B_TwoRayGens2CB",
            size: Shared.Align(16, this.constructor.StructOffsets__B_TwoRayGens2CB._size),
            usage: this.constantBuffer__B_TwoRayGens2CB_usageFlags,
        });
    }

    // Upload values to constant buffer _B_TwoRayGens2CB
    {
        const bufferCPU = new ArrayBuffer(Shared.Align(16, this.constructor.StructOffsets__B_TwoRayGens2CB._size));
        const view = new DataView(bufferCPU);
        view.setUint32(this.constructor.StructOffsets__B_TwoRayGens2CB._dispatchSize_B_TwoRayGens2_0, this.variable__dispatchSize_B_TwoRayGens2[0], true);
        view.setUint32(this.constructor.StructOffsets__B_TwoRayGens2CB._dispatchSize_B_TwoRayGens2_1, this.variable__dispatchSize_B_TwoRayGens2[1], true);
        view.setUint32(this.constructor.StructOffsets__B_TwoRayGens2CB._dispatchSize_B_TwoRayGens2_2, this.variable__dispatchSize_B_TwoRayGens2[2], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.cameraPos_0, this.variable_cameraPos[0], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.cameraPos_1, this.variable_cameraPos[1], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.cameraPos_2, this.variable_cameraPos[2], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_0, this.variable_clipToWorld[0], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_1, this.variable_clipToWorld[1], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_2, this.variable_clipToWorld[2], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_3, this.variable_clipToWorld[3], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_4, this.variable_clipToWorld[4], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_5, this.variable_clipToWorld[5], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_6, this.variable_clipToWorld[6], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_7, this.variable_clipToWorld[7], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_8, this.variable_clipToWorld[8], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_9, this.variable_clipToWorld[9], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_10, this.variable_clipToWorld[10], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_11, this.variable_clipToWorld[11], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_12, this.variable_clipToWorld[12], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_13, this.variable_clipToWorld[13], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_14, this.variable_clipToWorld[14], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.clipToWorld_15, this.variable_clipToWorld[15], true);
        view.setFloat32(this.constructor.StructOffsets__B_TwoRayGens2CB.depthNearPlane, this.variable_depthNearPlane, true);
        device.queue.writeBuffer(this.constantBuffer__B_TwoRayGens2CB, 0, bufferCPU);
    }

    encoder.popDebugGroup(); // "TwoRayGensSubgraph._B_TwoRayGens2CB"

    encoder.pushDebugGroup("TwoRayGensSubgraph.B_DoRT2");

    // Run raygen shader B_DoRT2
    {
        const bindGroup = device.createBindGroup({
            label: "RayGen Bind Group B_DoRT2",
            layout: this.BindGroupLayout_RayGen_B_DoRT2,
            entries: [
                {
                    // g_texture
                    binding: 0,
                ...
                },
                {
                    // g_textureReadOnly
                    binding: 3,
                    resource: this.texture_B_DoRT2_g_texture_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 0 })
                },
                {
                    // _B_TwoRayGens2CB
                    binding: 4,
                    resource: { buffer: this.constantBuffer__B_TwoRayGens2CB }
                },
            ]
        });
        ...
        // Update the dispatch size in the constant buffer
        {
            ...
            specialVariablesBuffer[1] = dispatchSizePreDiv[1];
            specialVariablesBuffer[2] = dispatchSizePreDiv[2];
            device.queue.writeBuffer(this.constantBuffer__B_TwoRayGens2CB, this.constructor.StructOffsets__B_TwoRayGens2CB._dispatchSize_B_TwoRayGens2_0, specialVariablesBuffer);
        }

        if (this.Pipeline_RayGen_B_DoRT2 !== null)
        {
            const computePass = encoder.beginComputePass();
                computePass.setPipeline(this.Pipeline_RayGen_B_DoRT2);
                computePass.setBindGroup(0, bindGroup);
                computePass.dispatchWorkgroups(dispatchSize[0], dispatchSize[1], dispatchSize[2]);
            computePass.end();
        }
    ...
    encoder.popDebugGroup(); // "TwoRayGensSubgraph.B_DoRT2"
...
var TwoRayGensSubgraph = new class_TwoRayGensSubgraph;

export default TwoRayGensSubgraph;
