...
class class_Texture2DArrayRW_CS
{
...
fn csmain(@builtin(global_invocation_id) DTid_0 : vec3<u32>)
{
    ...
    var loadedTexturePx_0 : vec3<f32> = (textureLoad((_loadedTexture_0), ((_S2)).xy, i32(((_S2)).z), ((_S2)).w)).xyz;
    var _S3 : vec3<i32> = vec3<i32>(_S1);
    var _S4 : vec4<f32> = (textureLoad((importedTextureReadOnly), ((_S3)).xy, i32(((_S3)).z)));
    var importedTexturePx_0 : vec3<f32> = _S4.xyz;
    var importedColorPx_0 : vec3<f32> = (textureLoad((importedColor), ((_S2)).xy, i32(((_S2)).z), ((_S2)).w)).xyz;
    textureStore((nodeTexture), ((_S1)).xy, i32(((_S1)).z), (vec4<f32>(loadedTexturePx_0 * importedTexturePx_0 * importedColorPx_0, 1.0f)));
    textureStore((importedTexture), ((_S1)).xy, i32(((_S1)).z), (vec4<f32>((loadedTexturePx_0 + importedTexturePx_0) / vec3<f32>(2.0f) * importedColorPx_0, 1.0f)));
    return;
}
...
async Init(device, encoder, useBlockingAPIs)
{
    // Handle (re)creation of texture NodeTexture
    {
        ...
        if (this.texture_NodeTexture === null)
        {
            ...
            this.texture_NodeTexture = device.createTexture({
                label: "texture Texture2DArrayRW_CS.NodeTexture",
    ...
    // Handle (re)creation of texture RW_nodeTexture_ReadOnly
    {
        ...
        if (this.texture_RW_nodeTexture_ReadOnly === null)
        {
            ...
            this.texture_RW_nodeTexture_ReadOnly = device.createTexture({
                label: "texture Texture2DArrayRW_CS.RW_nodeTexture_ReadOnly",
    ...
    // Handle (re)creation of texture RW_importedTexture_ReadOnly
    {
        ...
        if (this.texture_RW_importedTexture_ReadOnly === null)
        {
            ...
            this.texture_RW_importedTexture_ReadOnly = device.createTexture({
                label: "texture Texture2DArrayRW_CS.RW_importedTexture_ReadOnly",
    ...
    // (Re)create compute shader RW
    {
        ...
        if (this.ShaderModule_Compute_RW === null || newHash !== this.Hash_Compute_RW)
        {
            ...
            let shaderCode = class_Texture2DArrayRW_CS.ShaderCode_RW_RWCS_0;
...
{
    encoder.pushDebugGroup("Texture2DArrayRW_CS.NodeTexture");

    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.NodeTexture"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.ImportedTexture");

    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.ImportedTexture"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.ImportedColor");

    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.ImportedColor"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.RW_nodeTexture_ReadOnly");

    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.RW_nodeTexture_ReadOnly"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.Copy_RW_nodeTexture");
    ...
    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.Copy_RW_nodeTexture"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.RW_importedTexture_ReadOnly");

    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.RW_importedTexture_ReadOnly"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.Copy_RW_importedTexture");
    ...
    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.Copy_RW_importedTexture"

    encoder.pushDebugGroup("Texture2DArrayRW_CS._loadedTexture_0");

    encoder.popDebugGroup(); // "Texture2DArrayRW_CS._loadedTexture_0"

    encoder.pushDebugGroup("Texture2DArrayRW_CS.RW");
    ...
    encoder.popDebugGroup(); // "Texture2DArrayRW_CS.RW"
...
var Texture2DArrayRW_CS = new class_Texture2DArrayRW_CS;

export default Texture2DArrayRW_CS;
