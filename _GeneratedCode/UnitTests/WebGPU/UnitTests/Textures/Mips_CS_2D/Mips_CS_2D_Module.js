...
@binding(2) @group(0) var InputReadOnly : texture_storage_2d</*(InputReadOnly_format)*/, read>;
...
fn main(@builtin(global_invocation_id) DTid_0 : vec3<u32>)
{
    ...
    var _S4 : vec4<f32> = (textureLoad((InputReadOnly), (vec2<i32>(_S3))));
    var _S5 : vec3<f32> = SRGBToLinear_0(_S4.xyz);
    var _S6 : vec4<f32> = (textureLoad((InputReadOnly), (vec2<i32>(_S3 + vec2<u32>(u32(1), u32(0))))));
    var _S7 : vec3<f32> = _S5 + SRGBToLinear_0(_S6.xyz);
    var _S8 : vec4<f32> = (textureLoad((InputReadOnly), (vec2<i32>(_S3 + vec2<u32>(u32(1), u32(1))))));
    var _S9 : vec3<f32> = _S7 + SRGBToLinear_0(_S8.xyz);
    var _S10 : vec4<f32> = (textureLoad((InputReadOnly), (vec2<i32>(_S3 + vec2<u32>(u32(0), u32(1))))));
    textureStore((Output), (px_0), (vec4<f32>(LinearToSRGB_0((_S9 + SRGBToLinear_0(_S10.xyz)) / vec3<f32>(4.0f)), 1.0f)));
    return;
}
    ...
    // Handle (re)creation of texture Output
    {
        ...
        if (this.texture_Output === null)
        {
            ...
            this.texture_Output = device.createTexture({
                label: "texture Mips_CS_2D.Output",
    ...
    // Handle (re)creation of texture Mip0_Output_ReadOnly
    {
        ...
        if (this.texture_Mip0_Output_ReadOnly === null)
        {
            ...
            this.texture_Mip0_Output_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip0_Output_ReadOnly",
    ...
    // Handle (re)creation of texture Mip1_Input_ReadOnly
    {
        ...
        if (this.texture_Mip1_Input_ReadOnly === null)
        {
            ...
            this.texture_Mip1_Input_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip1_Input_ReadOnly",
    ...
    // Handle (re)creation of texture Mip1_Output_ReadOnly
    {
        ...
        if (this.texture_Mip1_Output_ReadOnly === null)
        {
            ...
            this.texture_Mip1_Output_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip1_Output_ReadOnly",
    ...
    // Handle (re)creation of texture Mip2_Input_ReadOnly
    {
        ...
        if (this.texture_Mip2_Input_ReadOnly === null)
        {
            ...
            this.texture_Mip2_Input_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip2_Input_ReadOnly",
    ...
    // Handle (re)creation of texture Mip2_Output_ReadOnly
    {
        ...
        if (this.texture_Mip2_Output_ReadOnly === null)
        {
            ...
            this.texture_Mip2_Output_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip2_Output_ReadOnly",
    ...
    // Handle (re)creation of texture Mip3_Input_ReadOnly
    {
        ...
        if (this.texture_Mip3_Input_ReadOnly === null)
        {
            ...
            this.texture_Mip3_Input_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip3_Input_ReadOnly",
    ...
    // Handle (re)creation of texture Mip3_Output_ReadOnly
    {
        ...
        if (this.texture_Mip3_Output_ReadOnly === null)
        {
            ...
            this.texture_Mip3_Output_ReadOnly = device.createTexture({
                label: "texture Mips_CS_2D.Mip3_Output_ReadOnly",
    ...
    // (Re)create compute shader Mip0
    {
        ...
        [
            ...
            },
            {
                ...
                binding: 1,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip0_Output_ReadOnly_format), viewDimension: "2d" }
            },
            {
                // _loadedTexture_0
                binding: 2,
        ...
        if (this.ShaderModule_Compute_Mip0 === null || newHash !== this.Hash_Compute_Mip0)
        {
            ...
            let shaderCode = class_Mips_CS_2D.ShaderCode_Mip0_Mip0CS_0;
    ...
    // (Re)create compute shader Mip1
    {
        ...
        [
            ...
            },
            {
                ...
                binding: 2,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip1_Input_ReadOnly_format), viewDimension: "2d" }
            },
            {
                // OutputReadOnly
                binding: 3,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip1_Output_ReadOnly_format), viewDimension: "2d" }
            },
        ];
        ...
        if (this.ShaderModule_Compute_Mip1 === null || newHash !== this.Hash_Compute_Mip1)
        {
            ...
            let shaderCode = class_Mips_CS_2D.ShaderCode_Mip1_MipNCS_0;
    ...
    // (Re)create compute shader Mip2
    {
        ...
        [
            ...
            },
            {
                ...
                binding: 2,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip2_Input_ReadOnly_format), viewDimension: "2d" }
            },
            {
                // OutputReadOnly
                binding: 3,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip2_Output_ReadOnly_format), viewDimension: "2d" }
            },
        ];
        ...
        if (this.ShaderModule_Compute_Mip2 === null || newHash !== this.Hash_Compute_Mip2)
        {
            ...
            let shaderCode = class_Mips_CS_2D.ShaderCode_Mip2_MipNCS_1;
            shaderCode = shaderCode.replace("/*(Input_format)*/", Shared.GetNonSRGBFormat(this.texture_Output_format));
            shaderCode = shaderCode.replace("/*(Output_format)*/", Shared.GetNonSRGBFormat(this.texture_Output_format));
    ...
    // (Re)create compute shader Mip3
    {
        ...
        [
            ...
            },
            {
                ...
                binding: 2,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip3_Input_ReadOnly_format), viewDimension: "2d" }
            },
            {
                // OutputReadOnly
                binding: 3,
                visibility: GPUShaderStage.COMPUTE,
                storageTexture : { access: "read-only", format: Shared.GetNonSRGBFormat(this.texture_Mip3_Output_ReadOnly_format), viewDimension: "2d" }
            },
        ];
        ...
        if (this.ShaderModule_Compute_Mip3 === null || newHash !== this.Hash_Compute_Mip3)
        {
            ...
            let shaderCode = class_Mips_CS_2D.ShaderCode_Mip3_MipNCS_2;
            shaderCode = shaderCode.replace("/*(Input_format)*/", Shared.GetNonSRGBFormat(this.texture_Output_format));
            shaderCode = shaderCode.replace("/*(Output_format)*/", Shared.GetNonSRGBFormat(this.texture_Output_format));
...
{
    encoder.pushDebugGroup("Mips_CS_2D.Output");

    encoder.popDebugGroup(); // "Mips_CS_2D.Output"

    encoder.pushDebugGroup("Mips_CS_2D.Mip0_Output_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip0_Output_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip0_Output");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip0_Output"

    encoder.pushDebugGroup("Mips_CS_2D.Mip1_Input_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip1_Input_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D.Mip1_Output_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip1_Output_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D.Mip2_Input_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip2_Input_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D.Mip2_Output_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip2_Output_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D.Mip3_Input_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip3_Input_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D.Mip3_Output_ReadOnly");

    encoder.popDebugGroup(); // "Mips_CS_2D.Mip3_Output_ReadOnly"

    encoder.pushDebugGroup("Mips_CS_2D._loadedTexture_0");

    encoder.popDebugGroup(); // "Mips_CS_2D._loadedTexture_0"

    encoder.pushDebugGroup("Mips_CS_2D.Mip0");
        ...
        const bindGroup = device.createBindGroup({
            ...
            entries: [
                ...
                },
                {
                    // OutputReadOnly
                    binding: 1,
                    resource: this.texture_Mip0_Output_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 0 })
                },
                {
                    // _loadedTexture_0
                    binding: 2,
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Mip0"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip1_Input");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip1_Input"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip1_Output");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip1_Output"

    encoder.pushDebugGroup("Mips_CS_2D.Mip1");
        ...
        const bindGroup = device.createBindGroup({
            ...
            entries: [
                ...
                },
                {
                    // Output
                    binding: 1,
                    resource: this.texture_Output.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 1 })
                },
                {
                    // InputReadOnly
                    binding: 2,
                    resource: this.texture_Mip1_Input_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 0 })
                },
                {
                    // OutputReadOnly
                    binding: 3,
                    resource: this.texture_Mip1_Output_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 1 })
                },
            ]
        });
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Mip1"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip2_Input");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip2_Input"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip2_Output");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip2_Output"

    encoder.pushDebugGroup("Mips_CS_2D.Mip2");
        ...
        const bindGroup = device.createBindGroup({
            ...
            entries: [
                ...
                },
                {
                    // Output
                    binding: 1,
                    resource: this.texture_Output.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 2 })
                },
                {
                    // InputReadOnly
                    binding: 2,
                    resource: this.texture_Mip2_Input_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 1 })
                },
                {
                    // OutputReadOnly
                    binding: 3,
                    resource: this.texture_Mip2_Output_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 2 })
                },
            ]
        });
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Mip2"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip3_Input");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip3_Input"

    encoder.pushDebugGroup("Mips_CS_2D.Copy_Mip3_Output");
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Copy_Mip3_Output"

    encoder.pushDebugGroup("Mips_CS_2D.Mip3");
        ...
        const bindGroup = device.createBindGroup({
            ...
            entries: [
                ...
                },
                {
                    // Output
                    binding: 1,
                    resource: this.texture_Output.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 3 })
                },
                {
                    // InputReadOnly
                    binding: 2,
                    resource: this.texture_Mip3_Input_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 2 })
                },
                {
                    // OutputReadOnly
                    binding: 3,
                    resource: this.texture_Mip3_Output_ReadOnly.createView({ dimension: "2d", mipLevelCount: 1, baseMipLevel: 3 })
                },
            ]
        });
    ...
    encoder.popDebugGroup(); // "Mips_CS_2D.Mip3"
...
var Mips_CS_2D = new class_Mips_CS_2D;

export default Mips_CS_2D;
