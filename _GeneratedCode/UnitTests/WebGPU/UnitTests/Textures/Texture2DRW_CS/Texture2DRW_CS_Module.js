    ...
    // Handle (re)creation of texture NodeTexture
    {
        ...
        if (this.texture_NodeTexture === null)
        {
            ...
            this.texture_NodeTexture = device.createTexture({
                label: "texture Texture2DRW_CS.NodeTexture",
    ...
    // Handle (re)creation of texture RW_nodeTexture_ReadOnly
    {
        ...
        if (this.texture_RW_nodeTexture_ReadOnly === null)
        {
            ...
            this.texture_RW_nodeTexture_ReadOnly = device.createTexture({
                label: "texture Texture2DRW_CS.RW_nodeTexture_ReadOnly",
    ...
    // Handle (re)creation of texture RW_importedTexture_ReadOnly
    {
        ...
        if (this.texture_RW_importedTexture_ReadOnly === null)
        {
            ...
            this.texture_RW_importedTexture_ReadOnly = device.createTexture({
                label: "texture Texture2DRW_CS.RW_importedTexture_ReadOnly",
...
{
    encoder.pushDebugGroup("Texture2DRW_CS.NodeTexture");

    encoder.popDebugGroup(); // "Texture2DRW_CS.NodeTexture"

    encoder.pushDebugGroup("Texture2DRW_CS.ImportedTexture");

    encoder.popDebugGroup(); // "Texture2DRW_CS.ImportedTexture"

    encoder.pushDebugGroup("Texture2DRW_CS.ImportedColor");

    encoder.popDebugGroup(); // "Texture2DRW_CS.ImportedColor"

    encoder.pushDebugGroup("Texture2DRW_CS.RW_nodeTexture_ReadOnly");

    encoder.popDebugGroup(); // "Texture2DRW_CS.RW_nodeTexture_ReadOnly"

    encoder.pushDebugGroup("Texture2DRW_CS.Copy_RW_nodeTexture");
    ...
    encoder.popDebugGroup(); // "Texture2DRW_CS.Copy_RW_nodeTexture"

    encoder.pushDebugGroup("Texture2DRW_CS.RW_importedTexture_ReadOnly");

    encoder.popDebugGroup(); // "Texture2DRW_CS.RW_importedTexture_ReadOnly"

    encoder.pushDebugGroup("Texture2DRW_CS.Copy_RW_importedTexture");
    ...
    encoder.popDebugGroup(); // "Texture2DRW_CS.Copy_RW_importedTexture"

    encoder.pushDebugGroup("Texture2DRW_CS._loadedTexture_0");

    encoder.popDebugGroup(); // "Texture2DRW_CS._loadedTexture_0"

    encoder.pushDebugGroup("Texture2DRW_CS.RW");
    ...
    encoder.popDebugGroup(); // "Texture2DRW_CS.RW"
...
var Texture2DRW_CS = new class_Texture2DRW_CS;

export default Texture2DRW_CS;
