...
copy public\SlangAutoDiffTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\SlangAutoDiffTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\SlangAutoDiff\ mkdir %1Engine\Shaders\Private\SlangAutoDiff\
copy shaders\*.* %1Engine\Shaders\Private\SlangAutoDiff\
