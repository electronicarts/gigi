...
Copy Public/simpleTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/simpleTechnique.cpp to Engine/Source/Runtime/Renderer/Private/
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_simple.Var_Enabled = true;
...
See simpleTechnique.cpp for details.
