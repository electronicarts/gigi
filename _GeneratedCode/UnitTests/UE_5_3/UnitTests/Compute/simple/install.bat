...
copy public\simpleTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\simpleTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\simple\ mkdir %1Engine\Shaders\Private\simple\
copy shaders\*.* %1Engine\Shaders\Private\simple\
