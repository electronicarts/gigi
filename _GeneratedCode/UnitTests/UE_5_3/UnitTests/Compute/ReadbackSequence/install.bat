...
copy public\ReadbackSequenceTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\ReadbackSequenceTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\ReadbackSequence\ mkdir %1Engine\Shaders\Private\ReadbackSequence\
copy shaders\*.* %1Engine\Shaders\Private\ReadbackSequence\
