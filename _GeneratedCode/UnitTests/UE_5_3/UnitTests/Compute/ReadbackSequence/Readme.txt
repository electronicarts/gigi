...
Copy Public/ReadbackSequenceTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/ReadbackSequenceTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/ReadbackSequence/
...
struct FTechniqueState_ReadbackSequence
{
...
FTechniqueState_ReadbackSequence TechniqueState_ReadbackSequence;
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_ReadbackSequence.Var_Enabled = true;
