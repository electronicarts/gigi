...
copy public\boxblurTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\boxblurTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\boxblur\ mkdir %1Engine\Shaders\Private\boxblur\
copy shaders\*.* %1Engine\Shaders\Private\boxblur\
