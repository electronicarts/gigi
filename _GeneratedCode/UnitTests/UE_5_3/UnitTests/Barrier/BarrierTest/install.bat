...
copy public\BarrierTestTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\BarrierTestTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\BarrierTest\ mkdir %1Engine\Shaders\Private\BarrierTest\
copy shaders\*.* %1Engine\Shaders\Private\BarrierTest\
