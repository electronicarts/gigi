#include "simpleRaster2Technique.h"
...
IMPLEMENT_GLOBAL_SHADER(FRasterizeVS, "/Engine/Private/simpleRaster2/simpleRaster_VS.usf", "VSMain", SF_Vertex);
...
IMPLEMENT_GLOBAL_SHADER(FRasterizePS, "/Engine/Private/simpleRaster2/simpleRaster_PS.usf", "PSMain", SF_Pixel);
...
void AddTechnique(FRDGBuilder& GraphBuilder, const FViewInfo& View, FTechniqueParams& params)
{
    ...
    FRDGBufferRef Buffer_VertexBuffer = params.inputs.Buffer_VertexBuffer;
    ...
    FRDGTextureRef Texture_Color_Buffer;
    {
        ...
        // Create Texture
        Texture_Color_Buffer = GraphBuilder.CreateTexture(desc, TEXT("simpleRaster2.Color_Buffer"));
    }
    ...
    FRDGTextureRef Texture_Depth_Buffer;
    {
        ...
        // Create Texture
        Texture_Depth_Buffer = GraphBuilder.CreateTexture(desc, TEXT("simpleRaster2.Depth_Buffer"));
    }
    ...
    // Run Draw Call "Rasterize"
    {
        ...
        PassParameters->Vertex_Buffer = Buffer_VertexBuffer;

        // Vertex Shader Parameters
        PassParameters->VSParameters.cb_VertexShaderCB_ViewProjMtx = View.ViewState->TechniqueState_simpleRaster2.Var_ViewProjMtx;
        ...
        GraphBuilder.AddPass(
            RDG_EVENT_NAME("simpleRaster2.Rasterize"),
            PassParameters,
            ...
            [VertexShader, PixelShader, PassParameters, viewportMax, depthStencilIsStencil, params](FRHICommandListImmediate& RHICmdList)
            {
                ...
                for (FVertexElement element : params.inputs.BufferVertexFormat_VertexBuffer)
                {
