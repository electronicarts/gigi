...
Copy Public/simpleRaster2Technique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/simpleRaster2Technique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/simpleRaster2/
...
struct FTechniqueState_simpleRaster2
{
...
FTechniqueState_simpleRaster2 TechniqueState_simpleRaster2;
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:
	...
	{
		simpleRaster2::FTechniqueParams params;

		// Set inputs, such as this line:
		//params.inputs.Texture_InputTexture = SceneColor.Texture;

		// Set variables, such as this line:
		// View.ViewState->TechniqueState_simpleRaster2.Var_Enabled = true;

		simpleRaster2::AddTechnique(GraphBuilder, View, params);
