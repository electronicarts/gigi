...
copy public\simpleRaster2Technique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\simpleRaster2Technique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\simpleRaster2\ mkdir %1Engine\Shaders\Private\simpleRaster2\
copy shaders\*.* %1Engine\Shaders\Private\simpleRaster2\
