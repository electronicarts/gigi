...
Copy Public/YesVertexStruct_NoIndex_YesInstanceStructTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/YesVertexStruct_NoIndex_YesInstanceStructTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/YesVertexStruct_NoIndex_YesInstanceStruct/
...
Shaders Files Potentially Affected:
  * YesVertexStruct_NoIndex_YesInstanceStruct_VS.usf
...
struct FTechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct
{
...
FTechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct TechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct;
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:
	...
	{
		YesVertexStruct_NoIndex_YesInstanceStruct::FTechniqueParams params;

		// Set inputs, such as this line:
		//params.inputs.Texture_InputTexture = SceneColor.Texture;

		// Set variables, such as this line:
		// View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct.Var_Enabled = true;

		YesVertexStruct_NoIndex_YesInstanceStruct::AddTechnique(GraphBuilder, View, params);
...
r.YesVertexStruct_NoIndex_YesInstanceStruct.<variable>

Transient and non transient textures are viewable using the "vis" command
and have names in the form of:

YesVertexStruct_NoIndex_YesInstanceStruct.<resource>

See YesVertexStruct_NoIndex_YesInstanceStructTechnique.cpp for details.
