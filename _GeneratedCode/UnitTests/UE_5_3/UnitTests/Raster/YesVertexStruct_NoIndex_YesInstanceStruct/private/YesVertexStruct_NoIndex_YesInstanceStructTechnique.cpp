#include "YesVertexStruct_NoIndex_YesInstanceStructTechnique.h"
#include "ScenePrivate.h"

static bool CVarChanged_YesVertexStruct_NoIndex_YesInstanceStruct_viewMode = false;
TAutoConsoleVariable<int32> CVar_YesVertexStruct_NoIndex_YesInstanceStruct_viewMode(
    TEXT("r.YesVertexStruct_NoIndex_YesInstanceStruct.viewMode"), int32(0),
    TEXT(""),
    FConsoleVariableDelegate::CreateLambda([](IConsoleVariable* InVariable)
        {
            CVarChanged_YesVertexStruct_NoIndex_YesInstanceStruct_viewMode = true;
        }),
...
IMPLEMENT_GLOBAL_SHADER(FRasterizeVS, "/Engine/Private/YesVertexStruct_NoIndex_YesInstanceStruct/YesVertexStruct_NoIndex_YesInstanceStruct_VS.usf", "VSMain", SF_Vertex);
...
IMPLEMENT_GLOBAL_SHADER(FRasterizePS, "/Engine/Private/YesVertexStruct_NoIndex_YesInstanceStruct/YesVertexStruct_NoIndex_YesInstanceStruct_PS.usf", "PSMain", SF_Pixel);
...
BEGIN_SHADER_PARAMETER_STRUCT(FRasterizeParameters, )
    ...
    RDG_BUFFER_ACCESS(Instance_Buffer, ERHIAccess::VertexOrIndexBuffer)
END_SHADER_PARAMETER_STRUCT()
...
void AddTechnique(FRDGBuilder& GraphBuilder, const FViewInfo& View, FTechniqueParams& params)
{
    ...
    if (CVarChanged_YesVertexStruct_NoIndex_YesInstanceStruct_viewMode)
    {
        View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct.Var_viewMode = CVar_YesVertexStruct_NoIndex_YesInstanceStruct_viewMode.GetValueOnRenderThread();
        CVarChanged_YesVertexStruct_NoIndex_YesInstanceStruct_viewMode = false;
    }
    ...
    FRDGTextureRef Texture_Color_Buffer;
    {
        ...
        // Create Texture
        Texture_Color_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexStruct_NoIndex_YesInstanceStruct.Color_Buffer"));
    }
    ...
    FRDGTextureRef Texture_Depth_Buffer;
    {
        ...
        // Create Texture
        Texture_Depth_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexStruct_NoIndex_YesInstanceStruct.Depth_Buffer"));
    }

    FRDGBufferRef Buffer_Vertex_Buffer = params.inputs.Buffer_Vertex_Buffer;

    FRDGBufferRef Buffer_Instance_Buffer = params.inputs.Buffer_Instance_Buffer;
    ...
    // Run Draw Call "Rasterize"
    {
        ...
        PassParameters->Instance_Buffer = Buffer_Instance_Buffer;

        // Vertex Shader Parameters
        PassParameters->VSParameters.cb_VertexShaderCB_ViewProjMtx = View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct.Var_ViewProjMtx;

        // Pixel Shader Parameters
        PassParameters->PSParameters.cb_PixelShaderCB_viewMode = View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceStruct.Var_viewMode;
        ...
        GraphBuilder.AddPass(
            RDG_EVENT_NAME("YesVertexStruct_NoIndex_YesInstanceStruct.Rasterize"),
            PassParameters,
            ...
            [VertexShader, PixelShader, PassParameters, viewportMax, depthStencilIsStencil, params](FRHICommandListImmediate& RHICmdList)
            {
                ...
                for (FVertexElement element : params.inputs.BufferVertexFormat_Instance_Buffer)
                {
                    element.StreamIndex = 1;
                ...
                RHICmdList.SetStreamSource(1, PassParameters->Instance_Buffer->GetRHI(), 0);
                int vertexCountPerInstance = PassParameters->Vertex_Buffer->Desc.NumElements;

                int instanceCount = PassParameters->Instance_Buffer->Desc.NumElements;
