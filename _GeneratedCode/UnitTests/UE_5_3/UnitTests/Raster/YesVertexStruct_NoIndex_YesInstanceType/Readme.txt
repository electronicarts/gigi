...
Copy Public/YesVertexStruct_NoIndex_YesInstanceTypeTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/YesVertexStruct_NoIndex_YesInstanceTypeTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/YesVertexStruct_NoIndex_YesInstanceType/
...
Shaders Files Potentially Affected:
  * YesVertexStruct_NoIndex_YesInstanceType_VS.usf
...
struct FTechniqueState_YesVertexStruct_NoIndex_YesInstanceType
{
...
FTechniqueState_YesVertexStruct_NoIndex_YesInstanceType TechniqueState_YesVertexStruct_NoIndex_YesInstanceType;
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceType.Var_Enabled = true;
...
r.YesVertexStruct_NoIndex_YesInstanceType.<variable>

Transient and non transient textures are viewable using the "vis" command
and have names in the form of:

YesVertexStruct_NoIndex_YesInstanceType.<resource>

See YesVertexStruct_NoIndex_YesInstanceTypeTechnique.cpp for details.
