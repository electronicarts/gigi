#include "YesVertexStruct_NoIndex_YesInstanceTypeTechnique.h"
#include "ScenePrivate.h"

static bool CVarChanged_YesVertexStruct_NoIndex_YesInstanceType_viewMode = false;
TAutoConsoleVariable<int32> CVar_YesVertexStruct_NoIndex_YesInstanceType_viewMode(
    TEXT("r.YesVertexStruct_NoIndex_YesInstanceType.viewMode"), int32(0),
    TEXT(""),
    FConsoleVariableDelegate::CreateLambda([](IConsoleVariable* InVariable)
        {
            CVarChanged_YesVertexStruct_NoIndex_YesInstanceType_viewMode = true;
        }),
...
IMPLEMENT_GLOBAL_SHADER(FRasterizeVS, "/Engine/Private/YesVertexStruct_NoIndex_YesInstanceType/YesVertexStruct_NoIndex_YesInstanceType_VS.usf", "VSMain", SF_Vertex);
...
IMPLEMENT_GLOBAL_SHADER(FRasterizePS, "/Engine/Private/YesVertexStruct_NoIndex_YesInstanceType/YesVertexStruct_NoIndex_YesInstanceType_PS.usf", "PSMain", SF_Pixel);
...
void AddTechnique(FRDGBuilder& GraphBuilder, const FViewInfo& View, FTechniqueParams& params)
{
    ...
    if (CVarChanged_YesVertexStruct_NoIndex_YesInstanceType_viewMode)
    {
        View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceType.Var_viewMode = CVar_YesVertexStruct_NoIndex_YesInstanceType_viewMode.GetValueOnRenderThread();
        CVarChanged_YesVertexStruct_NoIndex_YesInstanceType_viewMode = false;
    }
    ...
    FRDGTextureRef Texture_Color_Buffer;
    {
        ...
        // Create Texture
        Texture_Color_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexStruct_NoIndex_YesInstanceType.Color_Buffer"));
    }
    ...
    FRDGTextureRef Texture_Depth_Buffer;
    {
        ...
        // Create Texture
        Texture_Depth_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexStruct_NoIndex_YesInstanceType.Depth_Buffer"));
    }
    ...
    // Run Draw Call "Rasterize"
    {
        ...
        PassParameters->VSParameters.cb_VertexShaderCB_ViewProjMtx = View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceType.Var_ViewProjMtx;

        // Pixel Shader Parameters
        PassParameters->PSParameters.cb_PixelShaderCB_viewMode = View.ViewState->TechniqueState_YesVertexStruct_NoIndex_YesInstanceType.Var_viewMode;
        ...
        GraphBuilder.AddPass(
            RDG_EVENT_NAME("YesVertexStruct_NoIndex_YesInstanceType.Rasterize"),
            PassParameters,
