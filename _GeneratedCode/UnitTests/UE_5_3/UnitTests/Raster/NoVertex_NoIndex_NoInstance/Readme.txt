...
Copy Public/NoVertex_NoIndex_NoInstanceTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/NoVertex_NoIndex_NoInstanceTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/NoVertex_NoIndex_NoInstance/
...
Shaders Files Potentially Affected:
  * NoVertex_NoIndex_NoInstance_VS.usf
...
struct FTechniqueState_NoVertex_NoIndex_NoInstance
{
...
FTechniqueState_NoVertex_NoIndex_NoInstance TechniqueState_NoVertex_NoIndex_NoInstance;
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_NoVertex_NoIndex_NoInstance.Var_Enabled = true;
...
r.NoVertex_NoIndex_NoInstance.<variable>

Transient and non transient textures are viewable using the "vis" command
and have names in the form of:

NoVertex_NoIndex_NoInstance.<resource>

See NoVertex_NoIndex_NoInstanceTechnique.cpp for details.
