...
IMPLEMENT_GLOBAL_SHADER(FRasterizeVS, "/Engine/Private/YesVertexType_NoIndex_NoInstance/YesVertexType_NoIndex_NoInstance_VS.usf", "VSMain", SF_Vertex);
...
IMPLEMENT_GLOBAL_SHADER(FRasterizePS, "/Engine/Private/YesVertexType_NoIndex_NoInstance/YesVertexType_NoIndex_NoInstance_PS.usf", "PSMain", SF_Pixel);
...
void AddTechnique(FRDGBuilder& GraphBuilder, const FViewInfo& View, FTechniqueParams& params)
{
    ...
    FRDGTextureRef Texture_Color_Buffer;
    {
        ...
        // Create Texture
        Texture_Color_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexType_NoIndex_NoInstance.Color_Buffer"));
    }
    ...
    FRDGTextureRef Texture_Depth_Buffer;
    {
        ...
        // Create Texture
        Texture_Depth_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexType_NoIndex_NoInstance.Depth_Buffer"));
    }
    ...
    // Run Draw Call "Rasterize"
    {
        ...
        PassParameters->VSParameters.cb_VertexShaderCB_ViewProjMtx = View.ViewState->TechniqueState_YesVertexType_NoIndex_NoInstance.Var_ViewProjMtx;
        ...
        GraphBuilder.AddPass(
            RDG_EVENT_NAME("YesVertexType_NoIndex_NoInstance.Rasterize"),
            PassParameters,
