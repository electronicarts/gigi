...
Copy Public/YesVertexType_NoIndex_NoInstanceTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/YesVertexType_NoIndex_NoInstanceTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/YesVertexType_NoIndex_NoInstance/
...
Shaders Files Potentially Affected:
  * YesVertexType_NoIndex_NoInstance_VS.usf
...
struct FTechniqueState_YesVertexType_NoIndex_NoInstance
{
...
FTechniqueState_YesVertexType_NoIndex_NoInstance TechniqueState_YesVertexType_NoIndex_NoInstance;
...
#include "YesVertexType_NoIndex_NoInstanceTechnique.h"
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_YesVertexType_NoIndex_NoInstance.Var_Enabled = true;
...
r.YesVertexType_NoIndex_NoInstance.<variable>

Transient and non transient textures are viewable using the "vis" command
and have names in the form of:

YesVertexType_NoIndex_NoInstance.<resource>

See YesVertexType_NoIndex_NoInstanceTechnique.cpp for details.
