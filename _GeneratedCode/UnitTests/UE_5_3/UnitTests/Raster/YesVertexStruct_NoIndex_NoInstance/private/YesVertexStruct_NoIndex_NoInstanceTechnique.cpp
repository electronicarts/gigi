#include "YesVertexStruct_NoIndex_NoInstanceTechnique.h"
#include "ScenePrivate.h"

static bool CVarChanged_YesVertexStruct_NoIndex_NoInstance_viewMode = false;
TAutoConsoleVariable<int32> CVar_YesVertexStruct_NoIndex_NoInstance_viewMode(
    TEXT("r.YesVertexStruct_NoIndex_NoInstance.viewMode"), int32(0),
    TEXT(""),
    FConsoleVariableDelegate::CreateLambda([](IConsoleVariable* InVariable)
        {
            CVarChanged_YesVertexStruct_NoIndex_NoInstance_viewMode = true;
        }),
...
IMPLEMENT_GLOBAL_SHADER(FRasterizeVS, "/Engine/Private/YesVertexStruct_NoIndex_NoInstance/YesVertexStruct_NoIndex_NoInstance_VS.usf", "VSMain", SF_Vertex);
...
IMPLEMENT_GLOBAL_SHADER(FRasterizePS, "/Engine/Private/YesVertexStruct_NoIndex_NoInstance/YesVertexStruct_NoIndex_NoInstance_PS.usf", "PSMain", SF_Pixel);
...
void AddTechnique(FRDGBuilder& GraphBuilder, const FViewInfo& View, FTechniqueParams& params)
{
    ...
    if (CVarChanged_YesVertexStruct_NoIndex_NoInstance_viewMode)
    {
        View.ViewState->TechniqueState_YesVertexStruct_NoIndex_NoInstance.Var_viewMode = CVar_YesVertexStruct_NoIndex_NoInstance_viewMode.GetValueOnRenderThread();
        CVarChanged_YesVertexStruct_NoIndex_NoInstance_viewMode = false;
    }
    ...
    FRDGTextureRef Texture_Color_Buffer;
    {
        ...
        // Create Texture
        Texture_Color_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexStruct_NoIndex_NoInstance.Color_Buffer"));
    }
    ...
    FRDGTextureRef Texture_Depth_Buffer;
    {
        ...
        // Create Texture
        Texture_Depth_Buffer = GraphBuilder.CreateTexture(desc, TEXT("YesVertexStruct_NoIndex_NoInstance.Depth_Buffer"));
    }
    ...
    // Run Draw Call "Rasterize"
    {
        ...
        PassParameters->VSParameters.cb_VertexShaderCB_ViewProjMtx = View.ViewState->TechniqueState_YesVertexStruct_NoIndex_NoInstance.Var_ViewProjMtx;

        // Pixel Shader Parameters
        PassParameters->PSParameters.cb_PixelShaderCB_viewMode = View.ViewState->TechniqueState_YesVertexStruct_NoIndex_NoInstance.Var_viewMode;
        ...
        GraphBuilder.AddPass(
            RDG_EVENT_NAME("YesVertexStruct_NoIndex_NoInstance.Rasterize"),
            PassParameters,
