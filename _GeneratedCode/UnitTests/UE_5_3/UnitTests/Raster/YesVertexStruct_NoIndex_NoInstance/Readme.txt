...
Copy Public/YesVertexStruct_NoIndex_NoInstanceTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/YesVertexStruct_NoIndex_NoInstanceTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/YesVertexStruct_NoIndex_NoInstance/
...
Shaders Files Potentially Affected:
  * YesVertexStruct_NoIndex_NoInstance_VS.usf
...
struct FTechniqueState_YesVertexStruct_NoIndex_NoInstance
{
...
FTechniqueState_YesVertexStruct_NoIndex_NoInstance TechniqueState_YesVertexStruct_NoIndex_NoInstance;
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_YesVertexStruct_NoIndex_NoInstance.Var_Enabled = true;
...
r.YesVertexStruct_NoIndex_NoInstance.<variable>

Transient and non transient textures are viewable using the "vis" command
and have names in the form of:

YesVertexStruct_NoIndex_NoInstance.<resource>

See YesVertexStruct_NoIndex_NoInstanceTechnique.cpp for details.
