...
copy public\buffertestTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\buffertestTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\buffertest\ mkdir %1Engine\Shaders\Private\buffertest\
copy shaders\*.* %1Engine\Shaders\Private\buffertest\
