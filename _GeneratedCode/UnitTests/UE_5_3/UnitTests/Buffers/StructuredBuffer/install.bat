...
copy public\StructuredBufferTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\StructuredBufferTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\StructuredBuffer\ mkdir %1Engine\Shaders\Private\StructuredBuffer\
copy shaders\*.* %1Engine\Shaders\Private\StructuredBuffer\
