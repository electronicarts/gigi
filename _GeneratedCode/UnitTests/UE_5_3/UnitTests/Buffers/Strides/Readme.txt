...
Copy Public/StridesTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/StridesTechnique.cpp to Engine/Source/Runtime/Renderer/Private/

Copy the contents of Shaders to Engine/Shaders/Private/Strides/
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:

	{
		...
		// View.ViewState->TechniqueState_Strides.Var_Enabled = true;
...
See StridesTechnique.cpp for details.
