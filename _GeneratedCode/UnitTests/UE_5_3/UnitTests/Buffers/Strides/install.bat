...
copy public\StridesTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\StridesTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\Strides\ mkdir %1Engine\Shaders\Private\Strides\
copy shaders\*.* %1Engine\Shaders\Private\Strides\
