...
copy public\SubGraphTestTechnique.h %1Engine\Source\Runtime\Renderer\Public\

copy private\SubGraphTestTechnique.cpp %1Engine\Source\Runtime\Renderer\Private\

if not exist %1Engine\Shaders\Private\SubGraphTest\ mkdir %1Engine\Shaders\Private\SubGraphTest\
copy shaders\*.* %1Engine\Shaders\Private\SubGraphTest\
