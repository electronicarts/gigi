...
Copy Public/SubGraphTestTechnique.h to Engine/Source/Runtime/Renderer/Public/

Copy Public/SubGraphTestTechnique.cpp to Engine/Source/Runtime/Renderer/Private/
...
Assuming you want your new post processing effect to run first, you can put this chunk of code after that line:
	...
	{
		SubGraphTest::FTechniqueParams params;

		// Set inputs, such as this line:
		//params.inputs.Texture_InputTexture = SceneColor.Texture;

		// Set variables, such as this line:
		// View.ViewState->TechniqueState_SubGraphTest.Var_Enabled = true;

		SubGraphTest::AddTechnique(GraphBuilder, View, params);
