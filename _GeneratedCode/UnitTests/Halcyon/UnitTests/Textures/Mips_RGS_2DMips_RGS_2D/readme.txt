...
class IMips_RGS_2DPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_RGS_2DPass, 0);

	virtual void addMips_RGS_2DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IMips_RGS_2DPass::addMips_RGS_2DPass, m_rgMips_RGS_2DPass);
...
=====================================================================================================
4) Put Mips_RGS_2DPass.cpp and Mips_RGS_2DPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_RGS_2D_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_RGS_2DPassData
{
	// Set and get these
	RenderGraphResource textureMipTex;
	RenderResourceHandle bufferVertexBuffer;

	// Internal use only
};
DeclareRenderGraphScopeContainer(Mips_RGS_2DPassData);
...
auto& d = scope.get<Mips_RGS_2DPassData>();
...
your Mips_RGS_2DPass::addMips_RGS_2DPass() function within Mips_RGS_2DPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_RGS_2D\
=====================================================================================================
...
["Shaders/Mips_RGS_2D/Miss"]
type = ""
entryPoint = "Miss"
source = "Shaders/Mips_RGS_2D/Mips_RGS_2D_RGS.hlsl"
flags = ""

["Shaders/Mips_RGS_2D/RayGen"]
type = ""
entryPoint = "main"
source = "Shaders/Mips_RGS_2D/Mips_RGS_2D_RGS.hlsl"
flags = ""
...
struct Mips_RGS_2DSettings
{
};

// This goes in the struct RenderSettings
Mips_RGS_2DSettings  Mips_RGS_2D;
...
// in the Window menu.
Mips_RGS_2D::MakeUI(m_owner.m_renderSettings.Mips_RGS_2D);
