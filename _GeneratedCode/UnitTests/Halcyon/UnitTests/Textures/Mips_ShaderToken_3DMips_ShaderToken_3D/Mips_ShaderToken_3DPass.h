...
class Mips_ShaderToken_3DPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_ShaderToken_3DPipeline, IShaderPipeline);
...
class Mips_ShaderToken_3DPass : public IMips_ShaderToken_3DPass
{
	HCY_DECLARE_CLASS(Mips_ShaderToken_3DPass, IMips_ShaderToken_3DPass);
...
public:
	...
	virtual void addMips_ShaderToken_3DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
