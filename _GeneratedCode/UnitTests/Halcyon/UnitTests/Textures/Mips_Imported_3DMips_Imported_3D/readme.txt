...
class IMips_Imported_3DPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_Imported_3DPass, 0);

	virtual void addMips_Imported_3DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Mips_Imported_3D)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IMips_Imported_3DPass::addMips_Imported_3DPass, m_rgMips_Imported_3DPass);
...
=====================================================================================================
4) Put Mips_Imported_3DPass.cpp and Mips_Imported_3DPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_Imported_3D_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_Imported_3DPassData
{
	// Set and get these

	// Internal use only
};
DeclareRenderGraphScopeContainer(Mips_Imported_3DPassData);
...
auto& d = scope.get<Mips_Imported_3DPassData>();
...
your Mips_Imported_3DPass::addMips_Imported_3DPass() function within Mips_Imported_3DPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_Imported_3D\
=====================================================================================================
...
struct Mips_Imported_3DSettings
{
};

// This goes in the struct RenderSettings
Mips_Imported_3DSettings  Mips_Imported_3D;
...
#include "Mips_Imported_3D_imgui.h"
...
// in the Window menu.
Mips_Imported_3D::MakeUI(m_owner.m_renderSettings.Mips_Imported_3D);
