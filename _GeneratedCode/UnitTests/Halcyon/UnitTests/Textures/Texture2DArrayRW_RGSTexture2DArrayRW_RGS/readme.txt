...
class ITexture2DArrayRW_RGSPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ITexture2DArrayRW_RGSPass, 0);

	virtual void addTexture2DArrayRW_RGSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Texture2DArrayRW_RGS)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&ITexture2DArrayRW_RGSPass::addTexture2DArrayRW_RGSPass, m_rgTexture2DArrayRW_RGSPass);
...
=====================================================================================================
4) Put Texture2DArrayRW_RGSPass.cpp and Texture2DArrayRW_RGSPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Texture2DArrayRW_RGS_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Texture2DArrayRW_RGSPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(Texture2DArrayRW_RGSPassData);
...
auto& d = scope.get<Texture2DArrayRW_RGSPassData>();
...
your Texture2DArrayRW_RGSPass::addTexture2DArrayRW_RGSPass() function within Texture2DArrayRW_RGSPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Texture2DArrayRW_RGS\
=====================================================================================================
...
["Shaders/Texture2DArrayRW_RGS/RWCHS"]
type = ""
entryPoint = "chsmain"
source = "Shaders/Texture2DArrayRW_RGS/Texture2DArrayRW_RGS.hlsl"
flags = ""

["Shaders/Texture2DArrayRW_RGS/RWMISS"]
type = ""
entryPoint = "missmain"
source = "Shaders/Texture2DArrayRW_RGS/Texture2DArrayRW_RGS.hlsl"
flags = ""

["Shaders/Texture2DArrayRW_RGS/RW"]
type = ""
entryPoint = "rgsmain"
source = "Shaders/Texture2DArrayRW_RGS/Texture2DArrayRW_RGS.hlsl"
flags = ""
...
struct Texture2DArrayRW_RGSSettings
{
};

// This goes in the struct RenderSettings
Texture2DArrayRW_RGSSettings  Texture2DArrayRW_RGS;
...
#include "Texture2DArrayRW_RGS_imgui.h"
...
// in the Window menu.
Texture2DArrayRW_RGS::MakeUI(m_owner.m_renderSettings.Texture2DArrayRW_RGS);
