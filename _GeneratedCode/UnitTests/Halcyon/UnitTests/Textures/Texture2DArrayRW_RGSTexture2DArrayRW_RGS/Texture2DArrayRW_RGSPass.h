...
class Texture2DArrayRW_RGSPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Texture2DArrayRW_RGSPipeline, IShaderPipeline);
...
class Texture2DArrayRW_RGSPass : public ITexture2DArrayRW_RGSPass
{
	HCY_DECLARE_CLASS(Texture2DArrayRW_RGSPass, ITexture2DArrayRW_RGSPass);
...
public:
	...
	virtual void addTexture2DArrayRW_RGSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
