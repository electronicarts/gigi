...
class Mips_Imported_2DPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_Imported_2DPipeline, IShaderPipeline);
...
class Mips_Imported_2DPass : public IMips_Imported_2DPass
{
	HCY_DECLARE_CLASS(Mips_Imported_2DPass, IMips_Imported_2DPass);
...
public:
	...
	virtual void addMips_Imported_2DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
