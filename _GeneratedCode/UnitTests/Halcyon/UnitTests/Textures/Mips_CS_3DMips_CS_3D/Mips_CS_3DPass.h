...
class Mips_CS_3DPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_CS_3DPipeline, IShaderPipeline);
...
class Mips_CS_3DPass : public IMips_CS_3DPass
{
	HCY_DECLARE_CLASS(Mips_CS_3DPass, IMips_CS_3DPass);
...
public:
	...
	virtual void addMips_CS_3DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
