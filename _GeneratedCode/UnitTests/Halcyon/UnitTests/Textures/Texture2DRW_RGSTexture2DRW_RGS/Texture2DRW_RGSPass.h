...
class Texture2DRW_RGSPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Texture2DRW_RGSPipeline, IShaderPipeline);
...
class Texture2DRW_RGSPass : public ITexture2DRW_RGSPass
{
	HCY_DECLARE_CLASS(Texture2DRW_RGSPass, ITexture2DRW_RGSPass);
...
public:
	...
	virtual void addTexture2DRW_RGSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
