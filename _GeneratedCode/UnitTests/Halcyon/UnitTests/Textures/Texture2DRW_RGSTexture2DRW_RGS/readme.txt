...
class ITexture2DRW_RGSPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ITexture2DRW_RGSPass, 0);

	virtual void addTexture2DRW_RGSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Texture2DRW_RGS)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&ITexture2DRW_RGSPass::addTexture2DRW_RGSPass, m_rgTexture2DRW_RGSPass);
...
=====================================================================================================
4) Put Texture2DRW_RGSPass.cpp and Texture2DRW_RGSPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Texture2DRW_RGS_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Texture2DRW_RGSPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(Texture2DRW_RGSPassData);
...
auto& d = scope.get<Texture2DRW_RGSPassData>();
...
your Texture2DRW_RGSPass::addTexture2DRW_RGSPass() function within Texture2DRW_RGSPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Texture2DRW_RGS\
=====================================================================================================
...
["Shaders/Texture2DRW_RGS/RWCHS"]
type = ""
entryPoint = "chsmain"
source = "Shaders/Texture2DRW_RGS/Texture2DRW_RGS.hlsl"
flags = ""

["Shaders/Texture2DRW_RGS/RWMISS"]
type = ""
entryPoint = "missmain"
source = "Shaders/Texture2DRW_RGS/Texture2DRW_RGS.hlsl"
flags = ""

["Shaders/Texture2DRW_RGS/RW"]
type = ""
entryPoint = "rgsmain"
source = "Shaders/Texture2DRW_RGS/Texture2DRW_RGS.hlsl"
flags = ""
...
struct Texture2DRW_RGSSettings
{
};

// This goes in the struct RenderSettings
Texture2DRW_RGSSettings  Texture2DRW_RGS;
...
#include "Texture2DRW_RGS_imgui.h"
...
// in the Window menu.
Texture2DRW_RGS::MakeUI(m_owner.m_renderSettings.Texture2DRW_RGS);
