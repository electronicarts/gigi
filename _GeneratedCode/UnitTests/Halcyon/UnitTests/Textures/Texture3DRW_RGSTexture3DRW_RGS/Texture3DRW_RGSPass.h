...
class Texture3DRW_RGSPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Texture3DRW_RGSPipeline, IShaderPipeline);
...
class Texture3DRW_RGSPass : public ITexture3DRW_RGSPass
{
	HCY_DECLARE_CLASS(Texture3DRW_RGSPass, ITexture3DRW_RGSPass);
...
public:
	...
	virtual void addTexture3DRW_RGSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
