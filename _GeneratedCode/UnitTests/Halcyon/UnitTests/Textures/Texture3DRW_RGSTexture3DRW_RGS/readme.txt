...
class ITexture3DRW_RGSPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ITexture3DRW_RGSPass, 0);

	virtual void addTexture3DRW_RGSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Texture3DRW_RGS)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&ITexture3DRW_RGSPass::addTexture3DRW_RGSPass, m_rgTexture3DRW_RGSPass);
...
=====================================================================================================
4) Put Texture3DRW_RGSPass.cpp and Texture3DRW_RGSPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Texture3DRW_RGS_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Texture3DRW_RGSPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(Texture3DRW_RGSPassData);
...
auto& d = scope.get<Texture3DRW_RGSPassData>();
...
your Texture3DRW_RGSPass::addTexture3DRW_RGSPass() function within Texture3DRW_RGSPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Texture3DRW_RGS\
=====================================================================================================
...
["Shaders/Texture3DRW_RGS/RWCHS"]
type = ""
entryPoint = "chsmain"
source = "Shaders/Texture3DRW_RGS/Texture3DRW_RGS.hlsl"
flags = ""

["Shaders/Texture3DRW_RGS/RWMISS"]
type = ""
entryPoint = "missmain"
source = "Shaders/Texture3DRW_RGS/Texture3DRW_RGS.hlsl"
flags = ""

["Shaders/Texture3DRW_RGS/RW"]
type = ""
entryPoint = "rgsmain"
source = "Shaders/Texture3DRW_RGS/Texture3DRW_RGS.hlsl"
flags = ""
...
struct Texture3DRW_RGSSettings
{
};

// This goes in the struct RenderSettings
Texture3DRW_RGSSettings  Texture3DRW_RGS;
...
#include "Texture3DRW_RGS_imgui.h"
...
// in the Window menu.
Texture3DRW_RGS::MakeUI(m_owner.m_renderSettings.Texture3DRW_RGS);
