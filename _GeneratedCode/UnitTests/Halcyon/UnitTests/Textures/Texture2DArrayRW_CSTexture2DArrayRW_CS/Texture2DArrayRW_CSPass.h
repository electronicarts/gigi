...
class Texture2DArrayRW_CSPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Texture2DArrayRW_CSPipeline, IShaderPipeline);
...
class Texture2DArrayRW_CSPass : public ITexture2DArrayRW_CSPass
{
	HCY_DECLARE_CLASS(Texture2DArrayRW_CSPass, ITexture2DArrayRW_CSPass);
...
public:
	...
	virtual void addTexture2DArrayRW_CSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
