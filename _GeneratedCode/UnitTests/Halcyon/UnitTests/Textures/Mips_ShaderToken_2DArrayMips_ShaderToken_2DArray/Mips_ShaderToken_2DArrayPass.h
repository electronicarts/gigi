...
class Mips_ShaderToken_2DArrayPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_ShaderToken_2DArrayPipeline, IShaderPipeline);
...
class Mips_ShaderToken_2DArrayPass : public IMips_ShaderToken_2DArrayPass
{
	HCY_DECLARE_CLASS(Mips_ShaderToken_2DArrayPass, IMips_ShaderToken_2DArrayPass);
...
public:
	...
	virtual void addMips_ShaderToken_2DArrayPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
