...
class IMips_ShaderToken_2DArrayPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_ShaderToken_2DArrayPass, 0);

	virtual void addMips_ShaderToken_2DArrayPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Mips_ShaderToken_2DArray)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IMips_ShaderToken_2DArrayPass::addMips_ShaderToken_2DArrayPass, m_rgMips_ShaderToken_2DArrayPass);
...
=====================================================================================================
4) Put Mips_ShaderToken_2DArrayPass.cpp and Mips_ShaderToken_2DArrayPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_ShaderToken_2DArray_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_ShaderToken_2DArrayPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(Mips_ShaderToken_2DArrayPassData);
...
auto& d = scope.get<Mips_ShaderToken_2DArrayPassData>();
...
your Mips_ShaderToken_2DArrayPass::addMips_ShaderToken_2DArrayPass() function within Mips_ShaderToken_2DArrayPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_ShaderToken_2DArray\
=====================================================================================================
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_ShaderToken_2DArray/Mips_ShaderToken_2DArray_CS.hlsl"
flags = ""
...
struct Mips_ShaderToken_2DArraySettings
{
};

// This goes in the struct RenderSettings
Mips_ShaderToken_2DArraySettings  Mips_ShaderToken_2DArray;
...
#include "Mips_ShaderToken_2DArray_imgui.h"
...
// in the Window menu.
Mips_ShaderToken_2DArray::MakeUI(m_owner.m_renderSettings.Mips_ShaderToken_2DArray);
