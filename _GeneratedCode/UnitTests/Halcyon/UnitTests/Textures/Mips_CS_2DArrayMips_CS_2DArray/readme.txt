...
class IMips_CS_2DArrayPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_CS_2DArrayPass, 0);

	virtual void addMips_CS_2DArrayPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Mips_CS_2DArray)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IMips_CS_2DArrayPass::addMips_CS_2DArrayPass, m_rgMips_CS_2DArrayPass);
...
=====================================================================================================
4) Put Mips_CS_2DArrayPass.cpp and Mips_CS_2DArrayPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_CS_2DArray_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_CS_2DArrayPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(Mips_CS_2DArrayPassData);
...
auto& d = scope.get<Mips_CS_2DArrayPassData>();
...
your Mips_CS_2DArrayPass::addMips_CS_2DArrayPass() function within Mips_CS_2DArrayPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_CS_2DArray\
=====================================================================================================
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_CS_2DArray/Mips_CS_2DArray_Mip0CS.hlsl"
flags = ""
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_CS_2DArray/Mips_CS_2DArray_MipNCS.hlsl"
flags = ""
...
struct Mips_CS_2DArraySettings
{
	glm::uvec2 RenderSize = {256, 256};
};

// This goes in the struct RenderSettings
Mips_CS_2DArraySettings  Mips_CS_2DArray;
...
#include "Mips_CS_2DArray_imgui.h"
...
// in the Window menu.
Mips_CS_2DArray::MakeUI(m_owner.m_renderSettings.Mips_CS_2DArray);
