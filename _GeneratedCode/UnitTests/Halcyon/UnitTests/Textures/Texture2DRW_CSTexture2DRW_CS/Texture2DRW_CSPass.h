...
class Texture2DRW_CSPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Texture2DRW_CSPipeline, IShaderPipeline);
...
class Texture2DRW_CSPass : public ITexture2DRW_CSPass
{
	HCY_DECLARE_CLASS(Texture2DRW_CSPass, ITexture2DRW_CSPass);
...
public:
	...
	virtual void addTexture2DRW_CSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
