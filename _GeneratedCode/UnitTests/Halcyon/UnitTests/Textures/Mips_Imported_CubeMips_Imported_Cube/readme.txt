...
class IMips_Imported_CubePass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_Imported_CubePass, 0);

	virtual void addMips_Imported_CubePass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Mips_Imported_Cube)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IMips_Imported_CubePass::addMips_Imported_CubePass, m_rgMips_Imported_CubePass);
...
=====================================================================================================
4) Put Mips_Imported_CubePass.cpp and Mips_Imported_CubePass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_Imported_Cube_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_Imported_CubePassData
{
	// Set and get these

	// Internal use only
};
DeclareRenderGraphScopeContainer(Mips_Imported_CubePassData);
...
auto& d = scope.get<Mips_Imported_CubePassData>();
...
your Mips_Imported_CubePass::addMips_Imported_CubePass() function within Mips_Imported_CubePass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_Imported_Cube\
=====================================================================================================
...
struct Mips_Imported_CubeSettings
{
};

// This goes in the struct RenderSettings
Mips_Imported_CubeSettings  Mips_Imported_Cube;
...
#include "Mips_Imported_Cube_imgui.h"
...
// in the Window menu.
Mips_Imported_Cube::MakeUI(m_owner.m_renderSettings.Mips_Imported_Cube);
