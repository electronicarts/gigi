...
class Mips_Imported_CubePipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_Imported_CubePipeline, IShaderPipeline);
...
class Mips_Imported_CubePass : public IMips_Imported_CubePass
{
	HCY_DECLARE_CLASS(Mips_Imported_CubePass, IMips_Imported_CubePass);
...
public:
	...
	virtual void addMips_Imported_CubePass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
