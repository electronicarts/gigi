...
class IMips_CS_CubePass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_CS_CubePass, 0);

	virtual void addMips_CS_CubePass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IMips_CS_CubePass::addMips_CS_CubePass, m_rgMips_CS_CubePass);
...
=====================================================================================================
4) Put Mips_CS_CubePass.cpp and Mips_CS_CubePass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_CS_Cube_imgui.h into Browser\Lib.
=====================================================================================================
...
DeclareRenderGraphScopeContainer(Mips_CS_CubePassData);
...
auto& d = scope.get<Mips_CS_CubePassData>();
...
your Mips_CS_CubePass::addMips_CS_CubePass() function within Mips_CS_CubePass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_CS_Cube\
=====================================================================================================
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_CS_Cube/Mips_CS_Cube_Mip0CS.hlsl"
flags = ""
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_CS_Cube/Mips_CS_Cube_MipNCS.hlsl"
flags = ""
defines="__GigiDispatchMultiply=uint3(1,1,1) __GigiDispatchDivide=uint3(2,2,1) __GigiDispatchPreAdd=uint3(0,0,0) __GigiDispatchPostAdd=uint3(0,0,0)"
...
source = "Shaders/Mips_CS_Cube/Mips_CS_Cube_MipNCS.hlsl"
flags = ""
defines="__GigiDispatchMultiply=uint3(1,1,1) __GigiDispatchDivide=uint3(4,4,1) __GigiDispatchPreAdd=uint3(0,0,0) __GigiDispatchPostAdd=uint3(0,0,0)"
...
source = "Shaders/Mips_CS_Cube/Mips_CS_Cube_MipNCS.hlsl"
flags = ""
defines="__GigiDispatchMultiply=uint3(1,1,1) __GigiDispatchDivide=uint3(8,8,1) __GigiDispatchPreAdd=uint3(0,0,0) __GigiDispatchPostAdd=uint3(0,0,0)"
...
// in the Window menu.
Mips_CS_Cube::MakeUI(m_owner.m_renderSettings.Mips_CS_Cube);
