...
class Mips_CS_CubePipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_CS_CubePipeline, IShaderPipeline);
...
class Mips_CS_CubePass : public IMips_CS_CubePass
{
	HCY_DECLARE_CLASS(Mips_CS_CubePass, IMips_CS_CubePass);
...
public:
	...
	virtual void addMips_CS_CubePass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
