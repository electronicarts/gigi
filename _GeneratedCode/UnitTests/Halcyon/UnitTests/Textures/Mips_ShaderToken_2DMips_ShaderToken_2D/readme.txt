...
class IMips_ShaderToken_2DPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_ShaderToken_2DPass, 0);

	virtual void addMips_ShaderToken_2DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Mips_ShaderToken_2D)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IMips_ShaderToken_2DPass::addMips_ShaderToken_2DPass, m_rgMips_ShaderToken_2DPass);
...
=====================================================================================================
4) Put Mips_ShaderToken_2DPass.cpp and Mips_ShaderToken_2DPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_ShaderToken_2D_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_ShaderToken_2DPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(Mips_ShaderToken_2DPassData);
...
auto& d = scope.get<Mips_ShaderToken_2DPassData>();
...
your Mips_ShaderToken_2DPass::addMips_ShaderToken_2DPass() function within Mips_ShaderToken_2DPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_ShaderToken_2D\
=====================================================================================================
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_ShaderToken_2D/Mips_ShaderToken_2D_CS.hlsl"
flags = ""
...
struct Mips_ShaderToken_2DSettings
{
};

// This goes in the struct RenderSettings
Mips_ShaderToken_2DSettings  Mips_ShaderToken_2D;
...
#include "Mips_ShaderToken_2D_imgui.h"
...
// in the Window menu.
Mips_ShaderToken_2D::MakeUI(m_owner.m_renderSettings.Mips_ShaderToken_2D);
