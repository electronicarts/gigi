...
class ITexture3DRW_PSPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ITexture3DRW_PSPass, 0);

	virtual void addTexture3DRW_PSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&ITexture3DRW_PSPass::addTexture3DRW_PSPass, m_rgTexture3DRW_PSPass);
...
=====================================================================================================
4) Put Texture3DRW_PSPass.cpp and Texture3DRW_PSPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Texture3DRW_PS_imgui.h into Browser\Lib.
=====================================================================================================
...
DeclareRenderGraphScopeContainer(Texture3DRW_PSPassData);
...
auto& d = scope.get<Texture3DRW_PSPassData>();
...
your Texture3DRW_PSPass::addTexture3DRW_PSPass() function within Texture3DRW_PSPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Texture3DRW_PS\
=====================================================================================================
...
struct Texture3DRW_PSSettings
{
};

// This goes in the struct RenderSettings
Texture3DRW_PSSettings  Texture3DRW_PS;
...
#include "Texture3DRW_PS_imgui.h"
...
// in the Window menu.
Texture3DRW_PS::MakeUI(m_owner.m_renderSettings.Texture3DRW_PS);
