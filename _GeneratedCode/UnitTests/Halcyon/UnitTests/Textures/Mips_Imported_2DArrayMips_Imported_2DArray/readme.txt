...
class IMips_Imported_2DArrayPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_Imported_2DArrayPass, 0);

	virtual void addMips_Imported_2DArrayPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(Mips_Imported_2DArray)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IMips_Imported_2DArrayPass::addMips_Imported_2DArrayPass, m_rgMips_Imported_2DArrayPass);
...
=====================================================================================================
4) Put Mips_Imported_2DArrayPass.cpp and Mips_Imported_2DArrayPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_Imported_2DArray_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct Mips_Imported_2DArrayPassData
{
	// Set and get these

	// Internal use only
};
DeclareRenderGraphScopeContainer(Mips_Imported_2DArrayPassData);
...
auto& d = scope.get<Mips_Imported_2DArrayPassData>();
...
your Mips_Imported_2DArrayPass::addMips_Imported_2DArrayPass() function within Mips_Imported_2DArrayPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_Imported_2DArray\
=====================================================================================================
...
struct Mips_Imported_2DArraySettings
{
};

// This goes in the struct RenderSettings
Mips_Imported_2DArraySettings  Mips_Imported_2DArray;
...
#include "Mips_Imported_2DArray_imgui.h"
...
// in the Window menu.
Mips_Imported_2DArray::MakeUI(m_owner.m_renderSettings.Mips_Imported_2DArray);
