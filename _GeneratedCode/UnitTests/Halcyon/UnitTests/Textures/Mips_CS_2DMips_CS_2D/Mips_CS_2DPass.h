...
class Mips_CS_2DPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Mips_CS_2DPipeline, IShaderPipeline);
...
class Mips_CS_2DPass : public IMips_CS_2DPass
{
	HCY_DECLARE_CLASS(Mips_CS_2DPass, IMips_CS_2DPass);
...
public:
	...
	virtual void addMips_CS_2DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
