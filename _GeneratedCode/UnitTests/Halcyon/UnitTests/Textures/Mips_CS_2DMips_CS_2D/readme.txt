...
class IMips_CS_2DPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IMips_CS_2DPass, 0);

	virtual void addMips_CS_2DPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IMips_CS_2DPass::addMips_CS_2DPass, m_rgMips_CS_2DPass);
...
=====================================================================================================
4) Put Mips_CS_2DPass.cpp and Mips_CS_2DPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Mips_CS_2D_imgui.h into Browser\Lib.
=====================================================================================================
...
DeclareRenderGraphScopeContainer(Mips_CS_2DPassData);
...
auto& d = scope.get<Mips_CS_2DPassData>();
...
your Mips_CS_2DPass::addMips_CS_2DPass() function within Mips_CS_2DPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Mips_CS_2D\
=====================================================================================================
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_CS_2D/Mips_CS_2D_Mip0CS.hlsl"
flags = ""
...
type = "cs"
entryPoint = "main"
source = "Shaders/Mips_CS_2D/Mips_CS_2D_MipNCS.hlsl"
flags = ""
...
// in the Window menu.
Mips_CS_2D::MakeUI(m_owner.m_renderSettings.Mips_CS_2D);
