...
class Texture2DRW_PSPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(Texture2DRW_PSPipeline, IShaderPipeline);
...
class Texture2DRW_PSPass : public ITexture2DRW_PSPass
{
	HCY_DECLARE_CLASS(Texture2DRW_PSPass, ITexture2DRW_PSPass);
...
public:
	...
	virtual void addTexture2DRW_PSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
