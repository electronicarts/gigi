...
class ITexture2DRW_PSPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ITexture2DRW_PSPass, 0);

	virtual void addTexture2DRW_PSPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&ITexture2DRW_PSPass::addTexture2DRW_PSPass, m_rgTexture2DRW_PSPass);
...
=====================================================================================================
4) Put Texture2DRW_PSPass.cpp and Texture2DRW_PSPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Texture2DRW_PS_imgui.h into Browser\Lib.
=====================================================================================================
...
DeclareRenderGraphScopeContainer(Texture2DRW_PSPassData);
...
auto& d = scope.get<Texture2DRW_PSPassData>();
...
your Texture2DRW_PSPass::addTexture2DRW_PSPass() function within Texture2DRW_PSPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Texture2DRW_PS\
=====================================================================================================
...
struct Texture2DRW_PSSettings
{
};

// This goes in the struct RenderSettings
Texture2DRW_PSSettings  Texture2DRW_PS;
...
#include "Texture2DRW_PS_imgui.h"
...
// in the Window menu.
Texture2DRW_PS::MakeUI(m_owner.m_renderSettings.Texture2DRW_PS);
