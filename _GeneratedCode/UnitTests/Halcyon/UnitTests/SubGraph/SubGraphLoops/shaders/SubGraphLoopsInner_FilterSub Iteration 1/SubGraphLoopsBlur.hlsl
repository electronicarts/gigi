...
ConstantBuffer<Struct__FilterSub_Iteration_1_Blur_0CB> _FilterSub_Iteration_1_Blur_0CB : register(b0);
...
void main(uint3 DTid : SV_DispatchThreadID)
{
	...
	int radius = _FilterSub_Iteration_1_Blur_0CB.__loopIndexValue_1 + 1;
	...
	if ((bool)_FilterSub_Iteration_1_Blur_0CB.FilterSub_Iteration_1_sRGB)
