...
class ISubGraphTestPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ISubGraphTestPass, 0);

	virtual void addSubGraphTestPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&ISubGraphTestPass::addSubGraphTestPass, m_rgSubGraphTestPass);
...
=====================================================================================================
4) Put SubGraphTestPass.cpp and SubGraphTestPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put SubGraphTest_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct SubGraphTestPassData
{
	// Set and get these
	RenderGraphResource textureTest;
	glm::uvec3 textureTest_size = {0, 0, 0};
	RenderGraphResource textureInner_Exported_Tex;

	// Internal use only
};
DeclareRenderGraphScopeContainer(SubGraphTestPassData);
...
auto& d = scope.get<SubGraphTestPassData>();

// Set the input resources
d.textureTest = /*Texture Goes Here*/;
d.textureTest_size = /*Texture Size Goes Here*/;

// Get and use the results
auto& d = scope.get<SubGraphTestPassData>();
// use d.textureTest for whatever you want

If you are doing a post processing effect, a good way to hook up the inputs and outputs is to go into
your SubGraphTestPass::addSubGraphTestPass() function within SubGraphTestPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\SubGraphTest\
=====================================================================================================
...
type = "cs"
entryPoint = "csmain"
source = "Shaders/SubGraphTest/SubGraphTest_SwapColors.hlsl"
flags = ""
...
struct SubGraphTestSettings
{
};

// This goes in the struct RenderSettings
SubGraphTestSettings  SubGraphTest;
...
// in the Window menu.
SubGraphTest::MakeUI(m_owner.m_renderSettings.SubGraphTest);
