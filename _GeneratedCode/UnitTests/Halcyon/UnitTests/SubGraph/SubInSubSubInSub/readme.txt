...
class ISubInSubPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ISubInSubPass, 0);

	virtual void addSubInSubPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&ISubInSubPass::addSubInSubPass, m_rgSubInSubPass);
...
=====================================================================================================
4) Put SubInSubPass.cpp and SubInSubPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put SubInSub_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct SubInSubPassData
{
	// Set and get these
	RenderGraphResource textureInput;
	glm::uvec3 textureInput_size = {0, 0, 0};
	RenderGraphResource textureInner1_Inner2_Output;

	// Internal use only
};
DeclareRenderGraphScopeContainer(SubInSubPassData);
...
auto& d = scope.get<SubInSubPassData>();
...
your SubInSubPass::addSubInSubPass() function within SubInSubPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\SubInSub\
=====================================================================================================
...
type = "cs"
entryPoint = "main"
source = "Shaders/SubInSub/SubInSubInner2_Inner1.Inner2/SubInSubInner2_CS.hlsl"
flags = ""
...
// in the Window menu.
SubInSub::MakeUI(m_owner.m_renderSettings.SubInSub);
