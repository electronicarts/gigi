...
class YesVertexStruct_NoIndex_NoInstancePipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(YesVertexStruct_NoIndex_NoInstancePipeline, IShaderPipeline);
...
class YesVertexStruct_NoIndex_NoInstancePass : public IYesVertexStruct_NoIndex_NoInstancePass
{
	HCY_DECLARE_CLASS(YesVertexStruct_NoIndex_NoInstancePass, IYesVertexStruct_NoIndex_NoInstancePass);
...
public:
	...
	virtual void addYesVertexStruct_NoIndex_NoInstancePass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
...
private:
	...
	{
		int viewMode = (int)YesVertexStruct_NoIndex_NoInstanceSettings::ViewMode::Normal;
