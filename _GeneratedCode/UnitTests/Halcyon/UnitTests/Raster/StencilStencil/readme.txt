...
class IStencilPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IStencilPass, 0);

	virtual void addStencilPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IStencilPass::addStencilPass, m_rgStencilPass);
...
=====================================================================================================
4) Put StencilPass.cpp and StencilPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put Stencil_imgui.h into Browser\Lib.
=====================================================================================================
...
auto& d = scope.get<StencilPassData>();
...
your StencilPass::addStencilPass() function within StencilPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\Stencil\
=====================================================================================================
...
// in the Window menu.
Stencil::MakeUI(m_owner.m_renderSettings.Stencil);
