...
class simpleRaster_PointsPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(simpleRaster_PointsPipeline, IShaderPipeline);
...
class simpleRaster_PointsPass : public IsimpleRaster_PointsPass
{
	HCY_DECLARE_CLASS(simpleRaster_PointsPass, IsimpleRaster_PointsPass);
...
public:
	...
	virtual void addsimpleRaster_PointsPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
