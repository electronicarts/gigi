...
class IsimpleRaster_PointsPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IsimpleRaster_PointsPass, 0);

	virtual void addsimpleRaster_PointsPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(simpleRaster_Points)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IsimpleRaster_PointsPass::addsimpleRaster_PointsPass, m_rgsimpleRaster_PointsPass);
...
=====================================================================================================
4) Put simpleRaster_PointsPass.cpp and simpleRaster_PointsPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put simpleRaster_Points_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct simpleRaster_PointsPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(simpleRaster_PointsPassData);
...
auto& d = scope.get<simpleRaster_PointsPassData>();
...
your simpleRaster_PointsPass::addsimpleRaster_PointsPass() function within simpleRaster_PointsPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\simpleRaster_Points\
=====================================================================================================
...
struct simpleRaster_PointsSettings
{
...
simpleRaster_PointsSettings  simpleRaster_Points;
...
#include "simpleRaster_Points_imgui.h"
...
// in the Window menu.
simpleRaster_Points::MakeUI(m_owner.m_renderSettings.simpleRaster_Points);
