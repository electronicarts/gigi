...
class IsimpleRaster2Pass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IsimpleRaster2Pass, 0);

	virtual void addsimpleRaster2Pass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IsimpleRaster2Pass::addsimpleRaster2Pass, m_rgsimpleRaster2Pass);
...
=====================================================================================================
4) Put simpleRaster2Pass.cpp and simpleRaster2Pass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put simpleRaster2_imgui.h into Browser\Lib.
=====================================================================================================
...
DeclareRenderGraphScopeContainer(simpleRaster2PassData);
...
auto& d = scope.get<simpleRaster2PassData>();
...
your simpleRaster2Pass::addsimpleRaster2Pass() function within simpleRaster2Pass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\simpleRaster2\
=====================================================================================================
...
simpleRaster2Settings  simpleRaster2;
...
// in the Window menu.
simpleRaster2::MakeUI(m_owner.m_renderSettings.simpleRaster2);
