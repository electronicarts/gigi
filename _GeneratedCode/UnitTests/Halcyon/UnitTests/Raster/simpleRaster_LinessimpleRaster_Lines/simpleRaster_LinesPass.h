...
class simpleRaster_LinesPipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(simpleRaster_LinesPipeline, IShaderPipeline);
...
class simpleRaster_LinesPass : public IsimpleRaster_LinesPass
{
	HCY_DECLARE_CLASS(simpleRaster_LinesPass, IsimpleRaster_LinesPass);
...
public:
	...
	virtual void addsimpleRaster_LinesPass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
