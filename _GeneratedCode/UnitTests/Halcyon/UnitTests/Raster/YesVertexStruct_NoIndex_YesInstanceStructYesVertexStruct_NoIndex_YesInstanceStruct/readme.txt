...
class IYesVertexStruct_NoIndex_YesInstanceStructPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IYesVertexStruct_NoIndex_YesInstanceStructPass, 0);

	virtual void addYesVertexStruct_NoIndex_YesInstanceStructPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(YesVertexStruct_NoIndex_YesInstanceStruct)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IYesVertexStruct_NoIndex_YesInstanceStructPass::addYesVertexStruct_NoIndex_YesInstanceStructPass, m_rgYesVertexStruct_NoIndex_YesInstanceStructPass);
...
=====================================================================================================
4) Put YesVertexStruct_NoIndex_YesInstanceStructPass.cpp and YesVertexStruct_NoIndex_YesInstanceStructPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put YesVertexStruct_NoIndex_YesInstanceStruct_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct YesVertexStruct_NoIndex_YesInstanceStructPassData
{
	// Set and get these
	RenderGraphResource textureColor_Buffer;
	RenderGraphResource textureDepth_Buffer;
	RenderGraphResource bufferVertex_Buffer;
	RenderGraphResource bufferInstance_Buffer;

	// Internal use only
};
DeclareRenderGraphScopeContainer(YesVertexStruct_NoIndex_YesInstanceStructPassData);
...
auto& d = scope.get<YesVertexStruct_NoIndex_YesInstanceStructPassData>();

// Set the input resources
d.bufferVertex_Buffer = /*Buffer Goes Here*/;
d.bufferInstance_Buffer = /*Buffer Goes Here*/;

// Get and use the results
auto& d = scope.get<YesVertexStruct_NoIndex_YesInstanceStructPassData>();
// use d.bufferVertex_Buffer for whatever you want
// use d.bufferInstance_Buffer for whatever you want

If you are doing a post processing effect, a good way to hook up the inputs and outputs is to go into
your YesVertexStruct_NoIndex_YesInstanceStructPass::addYesVertexStruct_NoIndex_YesInstanceStructPass() function within YesVertexStruct_NoIndex_YesInstanceStructPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\YesVertexStruct_NoIndex_YesInstanceStruct\
=====================================================================================================
...
struct YesVertexStruct_NoIndex_YesInstanceStructSettings
{
...
YesVertexStruct_NoIndex_YesInstanceStructSettings  YesVertexStruct_NoIndex_YesInstanceStruct;
...
#include "YesVertexStruct_NoIndex_YesInstanceStruct_imgui.h"
...
// in the Window menu.
YesVertexStruct_NoIndex_YesInstanceStruct::MakeUI(m_owner.m_renderSettings.YesVertexStruct_NoIndex_YesInstanceStruct);
