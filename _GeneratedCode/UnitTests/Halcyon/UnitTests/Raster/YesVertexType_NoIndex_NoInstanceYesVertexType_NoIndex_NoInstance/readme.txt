...
class IYesVertexType_NoIndex_NoInstancePass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IYesVertexType_NoIndex_NoInstancePass, 0);

	virtual void addYesVertexType_NoIndex_NoInstancePass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(YesVertexType_NoIndex_NoInstance)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IYesVertexType_NoIndex_NoInstancePass::addYesVertexType_NoIndex_NoInstancePass, m_rgYesVertexType_NoIndex_NoInstancePass);
...
=====================================================================================================
4) Put YesVertexType_NoIndex_NoInstancePass.cpp and YesVertexType_NoIndex_NoInstancePass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put YesVertexType_NoIndex_NoInstance_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct YesVertexType_NoIndex_NoInstancePassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(YesVertexType_NoIndex_NoInstancePassData);
...
auto& d = scope.get<YesVertexType_NoIndex_NoInstancePassData>();
...
your YesVertexType_NoIndex_NoInstancePass::addYesVertexType_NoIndex_NoInstancePass() function within YesVertexType_NoIndex_NoInstancePass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\YesVertexType_NoIndex_NoInstance\
=====================================================================================================
...
struct YesVertexType_NoIndex_NoInstanceSettings
{
...
YesVertexType_NoIndex_NoInstanceSettings  YesVertexType_NoIndex_NoInstance;
...
#include "YesVertexType_NoIndex_NoInstance_imgui.h"
...
// in the Window menu.
YesVertexType_NoIndex_NoInstance::MakeUI(m_owner.m_renderSettings.YesVertexType_NoIndex_NoInstance);
