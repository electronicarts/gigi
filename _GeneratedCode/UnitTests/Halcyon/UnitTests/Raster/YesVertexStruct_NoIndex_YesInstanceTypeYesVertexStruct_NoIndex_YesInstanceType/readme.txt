...
class IYesVertexStruct_NoIndex_YesInstanceTypePass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IYesVertexStruct_NoIndex_YesInstanceTypePass, 0);

	virtual void addYesVertexStruct_NoIndex_YesInstanceTypePass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(YesVertexStruct_NoIndex_YesInstanceType)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IYesVertexStruct_NoIndex_YesInstanceTypePass::addYesVertexStruct_NoIndex_YesInstanceTypePass, m_rgYesVertexStruct_NoIndex_YesInstanceTypePass);
...
=====================================================================================================
4) Put YesVertexStruct_NoIndex_YesInstanceTypePass.cpp and YesVertexStruct_NoIndex_YesInstanceTypePass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put YesVertexStruct_NoIndex_YesInstanceType_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct YesVertexStruct_NoIndex_YesInstanceTypePassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(YesVertexStruct_NoIndex_YesInstanceTypePassData);
...
auto& d = scope.get<YesVertexStruct_NoIndex_YesInstanceTypePassData>();
...
your YesVertexStruct_NoIndex_YesInstanceTypePass::addYesVertexStruct_NoIndex_YesInstanceTypePass() function within YesVertexStruct_NoIndex_YesInstanceTypePass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\YesVertexStruct_NoIndex_YesInstanceType\
=====================================================================================================
...
struct YesVertexStruct_NoIndex_YesInstanceTypeSettings
{
...
YesVertexStruct_NoIndex_YesInstanceTypeSettings  YesVertexStruct_NoIndex_YesInstanceType;
...
#include "YesVertexStruct_NoIndex_YesInstanceType_imgui.h"
...
// in the Window menu.
YesVertexStruct_NoIndex_YesInstanceType::MakeUI(m_owner.m_renderSettings.YesVertexStruct_NoIndex_YesInstanceType);
