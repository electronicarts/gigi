...
class IReadbackSequencePass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IReadbackSequencePass, 0);

	virtual void addReadbackSequencePass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(ReadbackSequence)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IReadbackSequencePass::addReadbackSequencePass, m_rgReadbackSequencePass);
...
=====================================================================================================
4) Put ReadbackSequencePass.cpp and ReadbackSequencePass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put ReadbackSequence_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct ReadbackSequencePassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(ReadbackSequencePassData);
...
auto& d = scope.get<ReadbackSequencePassData>();
...
your ReadbackSequencePass::addReadbackSequencePass() function within ReadbackSequencePass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\ReadbackSequence\
=====================================================================================================
...
type = "cs"
entryPoint = "csmain"
source = "Shaders/ReadbackSequence/ReadbackSequence.hlsl"
flags = ""
...
struct ReadbackSequenceSettings
{
	int frameIndex = 0;
};

// This goes in the struct RenderSettings
ReadbackSequenceSettings  ReadbackSequence;
...
#include "ReadbackSequence_imgui.h"
...
// in the Window menu.
ReadbackSequence::MakeUI(m_owner.m_renderSettings.ReadbackSequence);
