...
class ISlangAutoDiffPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ISlangAutoDiffPass, 0);

	virtual void addSlangAutoDiffPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&ISlangAutoDiffPass::addSlangAutoDiffPass, m_rgSlangAutoDiffPass);
...
=====================================================================================================
4) Put SlangAutoDiffPass.cpp and SlangAutoDiffPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put SlangAutoDiff_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct SlangAutoDiffPassData
{
	// Set and get these
	RenderGraphResource textureOutput;
	glm::uvec3 textureOutput_size = {0, 0, 0};

	// Internal use only
	RenderGraphResource bufferData;
};
DeclareRenderGraphScopeContainer(SlangAutoDiffPassData);
...
auto& d = scope.get<SlangAutoDiffPassData>();

// Set the input resources
d.textureOutput = /*Texture Goes Here*/;
d.textureOutput_size = /*Texture Size Goes Here*/;

// Get and use the results
auto& d = scope.get<SlangAutoDiffPassData>();
// use d.textureOutput for whatever you want

If you are doing a post processing effect, a good way to hook up the inputs and outputs is to go into
your SlangAutoDiffPass::addSlangAutoDiffPass() function within SlangAutoDiffPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\SlangAutoDiff\
=====================================================================================================
...
type = "cs"
entryPoint = "csmain"
source = "Shaders/SlangAutoDiff/SlangAutoDiff_Initialize.hlsl"
flags = ""
...
type = "cs"
entryPoint = "csmain"
source = "Shaders/SlangAutoDiff/SlangAutoDiff_Descend_0.hlsl"
flags = ""
defines="SCREEN_MIN=0.001f SCREEN_MAX=0.99f __GigiDispatchMultiply=uint3(1,1,1) __GigiDispatchDivide=uint3(1,1,1) __GigiDispatchPreAdd=uint3(0,0,0) __GigiDispatchPostAdd=uint3(0,0,0)"

["Shaders/SlangAutoDiff/Render"]
type = "cs"
entryPoint = "csmain"
source = "Shaders/SlangAutoDiff/SlangAutoDiff_Render.hlsl"
flags = ""
defines="__GigiDispatchMultiply=uint3(1,1,1) __GigiDispatchDivide=uint3(1,1,1) __GigiDispatchPreAdd=uint3(0,0,0) __GigiDispatchPostAdd=uint3(0,0,0)"
...
struct SlangAutoDiffSettings
{
	...
	bool UseBackwardAD = true;
	bool QuantizeDisplay = false;
};

// This goes in the struct RenderSettings
SlangAutoDiffSettings  SlangAutoDiff;
...
// in the Window menu.
SlangAutoDiff::MakeUI(m_owner.m_renderSettings.SlangAutoDiff);
