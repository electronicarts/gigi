...
class IGPUWritePass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IGPUWritePass, 0);

	virtual void addGPUWritePass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IGPUWritePass::addGPUWritePass, m_rgGPUWritePass);
...
=====================================================================================================
4) Put GPUWritePass.cpp and GPUWritePass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put GPUWrite_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct GPUWritePassData
{
	// Set and get these

	// Internal use only
	RenderGraphResource textureTexture2D;
	RenderGraphResource textureTexture2DArray;
	RenderGraphResource textureTexture3D;
	RenderGraphResource bufferFloatBuffer;
	RenderGraphResource bufferStructBuffer;
};
DeclareRenderGraphScopeContainer(GPUWritePassData);
...
auto& d = scope.get<GPUWritePassData>();
...
your GPUWritePass::addGPUWritePass() function within GPUWritePass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\GPUWrite\
=====================================================================================================
...
type = "cs"
entryPoint = "csmain"
source = "Shaders/GPUWrite/GPUWrite.hlsl"
flags = ""
...
struct GPUWriteSettings
{
};

// This goes in the struct RenderSettings
GPUWriteSettings  GPUWrite;
...
// in the Window menu.
GPUWrite::MakeUI(m_owner.m_renderSettings.GPUWrite);
