...
class IAnyHitPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IAnyHitPass, 0);

	virtual void addAnyHitPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
pass(&IAnyHitPass::addAnyHitPass, m_rgAnyHitPass);
...
=====================================================================================================
4) Put AnyHitPass.cpp and AnyHitPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put AnyHit_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct AnyHitPassData
{
	// Set and get these
	RenderGraphResource textureOutput;
	RenderResourceHandle bufferScene;
	RenderGraphResource bufferSceneVB;

	// Internal use only
};
DeclareRenderGraphScopeContainer(AnyHitPassData);
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\AnyHit\
=====================================================================================================
...
type = ""
entryPoint = "Miss"
source = "Shaders/AnyHit/AnyHit.hlsl"
flags = ""

["Shaders/AnyHit/ClosestHit"]
type = ""
...
// in the Window menu.
AnyHit::MakeUI(m_owner.m_renderSettings.AnyHit);
