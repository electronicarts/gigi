...
class ITwoRayGensSubgraphPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(ITwoRayGensSubgraphPass, 0);

	virtual void addTwoRayGensSubgraphPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(TwoRayGensSubgraph)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&ITwoRayGensSubgraphPass::addTwoRayGensSubgraphPass, m_rgTwoRayGensSubgraphPass);
...
=====================================================================================================
4) Put TwoRayGensSubgraphPass.cpp and TwoRayGensSubgraphPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put TwoRayGensSubgraph_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct TwoRayGensSubgraphPassData
{
	// Set and get these
...
DeclareRenderGraphScopeContainer(TwoRayGensSubgraphPassData);
...
auto& d = scope.get<TwoRayGensSubgraphPassData>();
...
your TwoRayGensSubgraphPass::addTwoRayGensSubgraphPass() function within TwoRayGensSubgraphPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\TwoRayGensSubgraph\
=====================================================================================================
...
["Shaders/TwoRayGensSubgraph/A_TwoRayGensMiss1"]
type = ""
entryPoint = "Miss1"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphA_A/TwoRayGens1.hlsl"
flags = ""

["Shaders/TwoRayGensSubgraph/A_TwoRayGensClosestHit1"]
type = ""
entryPoint = "ClosestHit1"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphA_A/TwoRayGens1.hlsl"
flags = ""

["Shaders/TwoRayGensSubgraph/B_TwoRayGensMiss2A"]
type = ""
entryPoint = "Miss2A"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphB_B/TwoRayGens2.hlsl"
flags = ""

["Shaders/TwoRayGensSubgraph/B_TwoRayGensMiss2B"]
type = ""
entryPoint = "Miss2B"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphB_B/TwoRayGens2.hlsl"
flags = ""

["Shaders/TwoRayGensSubgraph/B_TwoRayGensClosestHit2"]
type = ""
entryPoint = "ClosestHit2"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphB_B/TwoRayGens2.hlsl"
flags = ""

["Shaders/TwoRayGensSubgraph/A_DoRT1"]
type = ""
entryPoint = "RayGen1"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphA_A/TwoRayGens1.hlsl"
flags = ""

["Shaders/TwoRayGensSubgraph/B_DoRT2"]
type = ""
entryPoint = "RayGen2"
source = "Shaders/TwoRayGensSubgraph/TwoRayGensSubgraphB_B/TwoRayGens2.hlsl"
flags = ""
...
struct TwoRayGensSubgraphSettings
{
...
TwoRayGensSubgraphSettings  TwoRayGensSubgraph;
...
#include "TwoRayGensSubgraph_imgui.h"
...
// in the Window menu.
TwoRayGensSubgraph::MakeUI(m_owner.m_renderSettings.TwoRayGensSubgraph);
