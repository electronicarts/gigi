...
class AnyHitSimplePipeline : public IShaderPipeline
{
	HCY_DECLARE_CLASS(AnyHitSimplePipeline, IShaderPipeline);
...
class AnyHitSimplePass : public IAnyHitSimplePass
{
	HCY_DECLARE_CLASS(AnyHitSimplePass, IAnyHitSimplePass);
...
public:
	...
	virtual void addAnyHitSimplePass(RenderGraph& renderGraph, RenderGraphScope& scope, const ShaderPipelines& pipelines) override;
