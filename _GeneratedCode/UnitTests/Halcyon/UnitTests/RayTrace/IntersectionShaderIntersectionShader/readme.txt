...
class IIntersectionShaderPass : public IRenderPass
{
public:
	HCY_DECLARE_INTERFACE(IIntersectionShaderPass, 0);

	virtual void addIntersectionShaderPass(RenderGraph& renderGraph, RenderGraphScope& scope, const class ShaderPipelines& pipelines) = 0;
};
...
PASS(IntersectionShader)

=====================================================================================================
3) Add this to Browser\Lib\Renderer.cpp wherever you want the render pass to happen
=====================================================================================================

pass(&IIntersectionShaderPass::addIntersectionShaderPass, m_rgIntersectionShaderPass);
...
=====================================================================================================
4) Put IntersectionShaderPass.cpp and IntersectionShaderPass.h and any custom c++ headers or
source files into Modules\Render.Passes\Lib\.
=====================================================================================================

=====================================================================================================
5) Put IntersectionShader_imgui.h into Browser\Lib.
=====================================================================================================
...
//
struct IntersectionShaderPassData
{
	// Set and get these
	RenderResourceHandle bufferAABBs;
	RenderGraphResource textureOutput;
	RenderGraphResource bufferAABBsSRV;

	// Internal use only
};
DeclareRenderGraphScopeContainer(IntersectionShaderPassData);
...
auto& d = scope.get<IntersectionShaderPassData>();

// Set the input resources
d.bufferAABBs = /*Buffer Goes Here*/;
d.bufferAABBsSRV = /*Buffer Goes Here*/;

// Get and use the results
auto& d = scope.get<IntersectionShaderPassData>();
// use d.bufferAABBs for whatever you want
// use d.bufferAABBsSRV for whatever you want

If you are doing a post processing effect, a good way to hook up the inputs and outputs is to go into
your IntersectionShaderPass::addIntersectionShaderPass() function within IntersectionShaderPass.cpp and put lines like these
...
=====================================================================================================
8) Copy the contents of the shaders folder to Shaders\IntersectionShader\
=====================================================================================================
...
["Shaders/IntersectionShader/Miss"]
type = ""
entryPoint = "Miss"
source = "Shaders/IntersectionShader/IntersectionShader.hlsl"
flags = ""

["Shaders/IntersectionShader/ClosestHit"]
type = ""
entryPoint = "ClosestHit"
source = "Shaders/IntersectionShader/IntersectionShader.hlsl"
flags = ""

["Shaders/IntersectionShader/Do_RT"]
type = ""
entryPoint = "RayGen"
source = "Shaders/IntersectionShader/IntersectionShader.hlsl"
flags = ""
...
struct IntersectionShaderSettings
{
...
IntersectionShaderSettings  IntersectionShader;
...
#include "IntersectionShader_imgui.h"
...
// in the Window menu.
IntersectionShader::MakeUI(m_owner.m_renderSettings.IntersectionShader);
