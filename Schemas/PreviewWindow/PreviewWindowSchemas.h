...
STRUCT_BEGIN(GGUserFile_AMD_FidelityFXSDK_FrameInterpolation, "")
    ...
    STRUCT_FIELD(bool, constrainToRectangle, { true }, "If true, constrains frame generation to the texture being viewed.", 0)
STRUCT_END()
...
ENUM_BEGIN(GGUserFile_LoadBufferAs, "How to load a file into a buffer")
    ENUM_ITEM(Auto, "")
    ENUM_ITEM(Binary, "")
ENUM_END()
...
STRUCT_BEGIN(GGUserFile_ImportedBuffer, "The details of an imported buffer")
    ...
    STRUCT_FIELD(GGUserFile_LoadBufferAs, loadBufferAs, GGUserFile_LoadBufferAs::Auto, "How to load data", 0)
