...
STRUCT_BEGIN(GGUserFile_SystemVars, "")
	...
	STRUCT_FIELD(std::string, PrevViewProjMtx_varName, "PrevViewProjMtx", "", 0)
	STRUCT_FIELD(std::string, PrevInvViewProjMtx_varName, "PrevInvViewProjMtx", "", 0)
	...
	STRUCT_FIELD(std::string, PrevCameraPos_varName, "PrevCameraPos", "", 0)
