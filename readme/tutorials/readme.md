...
| |  |
|:-----|:------|
| [<img src="../tutorial/verletblur.png" width="500"/>](#) | **Introduction**<br>Make a box blur post processing effect using compute shaders and apply it to another technique.<br> [Text Version](../tutorial/tutorial.md) <br> [Video Version (slightly outdated)](https://www.youtube.com/watch?v=qknK-tahICE)
