...
Struct_Materials Material_MaterialBuffer_Level(StructuredBuffer<Struct_Materials> MaterialsBuffer, int materialID, float2 uv0, float2 uv1, float2 uv2, float2 uv3, out float3 normal, out float occlusion,
    int level = 0)
{
    Struct_Materials ret = (Struct_Materials)0;
    ret.baseColor = float4(1.f, 1.f, 1.f, 1.f);
