...
resources = [
	[ "Swap_Colors.Output: Inner_Exported_Tex (UAV - After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/SubGraph/SubGraphTest/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/SubGraph/SubGraphTest.gg"):
		return False
