...
resources = [
	[ "Inner1_Inner2_Copy_Back.Dest (After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/SubGraph/SubInSub/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/SubGraph/SubInSub.gg"):
		return False
