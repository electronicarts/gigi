...
resources = [
	[ "FilterSub_Iteration_4_Copy_back.Dest (After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/SubGraph/SubGraphLoops/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/SubGraph/SubGraphLoops.gg"):
		return False
