...
resources = [
	...
	"Copy_Buffer_To_Texture.Dest (After)",
	"Copy_Texture_To_Buffer.Dest (After)",
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/CopyResource/CopyResourceTest/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/CopyResource/CopyResourceTest.gg"):
		return False
