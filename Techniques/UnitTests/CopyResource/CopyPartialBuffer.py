...
resources = [
	"Partial_Copy.Dest (After)",
	"Partial_Self_Copy.Dest (After)",
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/CopyResource/CopyPartialBuffer/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/CopyResource/CopyPartialBuffer.gg"):
		return False
