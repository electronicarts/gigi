...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/MeshShaders/MeshAmplificationLines/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/MeshShaders/MeshAmplificationLines.gg"):
		return False
