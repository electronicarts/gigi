...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/NoVertex_NoIndex_NoInstance/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/NoVertex_NoIndex_NoInstance.gg"):
		return False
