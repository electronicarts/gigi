...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/YesVertexStruct_YesIndex_NoInstance/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/YesVertexStruct_YesIndex_NoInstance.gg"):
		return False
