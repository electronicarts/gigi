...
resources = [
	[ "DrawQuad.depthTarget (After)", False ],
	[ "DrawQuad.colorTarget0 (After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/VRS/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/VRS.gg"):
		return False
