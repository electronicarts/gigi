...
resources = [
	[ "IndirectDrawIndexed.colorTarget0 (After)", True ],
	[ "IndirectDraw.colorTarget0 (After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/IndirectDraw/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/IndirectDraw.gg"):
		return False
