...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/YesVertexStruct_NoIndex_YesInstanceType/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/YesVertexStruct_NoIndex_YesInstanceType.gg"):
		return False
