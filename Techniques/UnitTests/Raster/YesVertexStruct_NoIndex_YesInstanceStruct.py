...
resources = [
	[ "Rasterize.depthTarget (After)", False ],
	[ "Rasterize.colorTarget0 (After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/YesVertexStruct_NoIndex_YesInstanceStruct/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/YesVertexStruct_NoIndex_YesInstanceStruct.gg"):
		return False
