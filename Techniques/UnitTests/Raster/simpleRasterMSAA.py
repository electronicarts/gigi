...
resources = [
	[ "CustomResolveMSAA.TextureOut: Color_Buffer_No_MSAA (UAV - After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Raster/simpleRasterMSAA/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Raster/simpleRasterMSAA.gg"):
		return False
