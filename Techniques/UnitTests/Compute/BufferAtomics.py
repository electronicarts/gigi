...
resources = [
	[ "RunShader.TheBuffer: TheBuffer (UAV - After)", False ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Compute/BufferAtomics/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Compute/BufferAtomics.gg"):
		return False
