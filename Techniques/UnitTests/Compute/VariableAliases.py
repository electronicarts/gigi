...
resources = [
	[ "Set_Blue.Output: Color (UAV - After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Compute/VariableAliases/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Compute/VariableAliases.gg"):
		return False
