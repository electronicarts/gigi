...
resources = [
	[ "Render.Output: Output (UAV - After)", True ],
	[ "GradientDescend.Data: Data (UAV - After)", False ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Compute/SlangAutoDiff/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Compute/SlangAutoDiff.gg"):
		return False
