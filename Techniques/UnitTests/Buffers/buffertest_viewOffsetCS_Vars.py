...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Buffers/buffertest_viewOffsetCS_Vars/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Buffers/buffertest_viewOffsetCS_Vars.gg"):
		return False
