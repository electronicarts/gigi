...
resources = [
	"Write2.TheBuffer: TheBuffer (UAV - After)",
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Buffers/bufferViewDescriptorTable/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Buffers/bufferViewDescriptorTable.gg"):
		return False
