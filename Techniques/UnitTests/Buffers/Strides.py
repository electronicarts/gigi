...
resources = [
	"Float16RW.buff2: TheBuffer2 (UAV - After)",
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Buffers/Strides/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Buffers/Strides.gg"):
		return False
