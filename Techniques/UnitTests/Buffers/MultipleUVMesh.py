...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Buffers/MultipleUVMesh/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Buffers/MultipleUVMesh.gg"):
		return False
	...
	for i, resource in enumerate(resources):
		...
		if success:
			...
			lastReadbackNp = lastReadbackNp[:10] # Don't compare the full mesh size. not needed. do a smaller subset
