...
resources = [
	[ "_loadedTexture_0.resource", True, 0, 3 ],
	[ "_loadedTexture_0.resource", True, 1, 3 ],
	[ "_loadedTexture_0.resource", True, 2, 3 ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Mips_ShaderToken_2DArray/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Mips_ShaderToken_2DArray.gg"):
		return False
