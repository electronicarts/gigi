...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Texture2DRW_PS/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Texture2DRW_PS.gg"):
		return False
