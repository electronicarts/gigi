...
resources = [
	[ "Mip3.Output: Output (UAV - After)", True, 0, 3 ],
	[ "Mip3.Output: Output (UAV - After)", True, 1, 3 ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Mips_CS_2DArray/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Mips_CS_2DArray.gg"):
		return False
