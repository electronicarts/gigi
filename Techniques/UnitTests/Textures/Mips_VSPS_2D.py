...
resources = [
	[ "Node_1.MipTexPS: MipTex (UAV - After)", True, 0, 1 ],
	[ "Node_1.MipTexPS: MipTex (UAV - After)", True, 0, 2 ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Mips_VSPS_2D/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Mips_VSPS_2D.gg"):
		return False
