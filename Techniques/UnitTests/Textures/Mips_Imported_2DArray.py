...
resources = [
	[ "texture.resource", True, 0, 0 ],
	[ "texture.resource", True, 0, 1 ],
	[ "texture.resource", True, 0, 4 ],
	[ "texture.resource", True, 0, 6 ],
	[ "texture.resource", True, 0, 9 ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Mips_Imported_2DArray/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Mips_Imported_2DArray.gg"):
		return False
