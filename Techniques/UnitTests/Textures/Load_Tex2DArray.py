...
resources = [
	[ "Load_Tex2DArrayCS.Output: Output (UAV - After)", True],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Load_Tex2DArray/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Load_Tex2DArray.gg"):
		return False
