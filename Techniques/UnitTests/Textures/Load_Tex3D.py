...
resources = [
	[ "Load_Tex3DCS.Output: Output (UAV - After)", True],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Load_Tex3D/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Load_Tex3D.gg"):
		return False
