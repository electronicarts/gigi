...
resources = [
	[ "RayGen.Output: MipTex (UAV - After)", True, 0, 0 ],
	[ "RayGen.Output: MipTex (UAV - After)", True, 0, 1 ],
	[ "RayGen.Output: MipTex (UAV - After)", True, 0, 2 ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Mips_RGS_2D/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Mips_RGS_2D.gg"):
		return False
