...
resources = [
	[ "RW.importedTexture: ImportedTexture (UAV - After)", False ],
	[ "RW.nodeTexture: NodeTexture (UAV - After)", False ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/Textures/Texture3DRW_RGS/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/Textures/Texture3DRW_RGS.gg"):
		return False
