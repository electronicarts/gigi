...
resources = [
	[ "B_DoRT2.g_texture: Texture (UAV - After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/RayTrace/TwoRayGensSubgraph/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/RayTrace/TwoRayGensSubgraph.gg"):
		return False
