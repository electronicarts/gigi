...
resources = [
	[ "Do_RT.Output: Output (UAV - After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/RayTrace/IntersectionShader/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/RayTrace/IntersectionShader.gg"):
		return False
