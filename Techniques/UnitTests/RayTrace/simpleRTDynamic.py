...
resources = [
	[ "DoRT._SimpleRTRayGenCB: _SimpleRTRayGenCB (CBV)", False ],
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/RayTrace/simpleRTDynamic/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/RayTrace/simpleRTDynamic.gg"):
		return False
