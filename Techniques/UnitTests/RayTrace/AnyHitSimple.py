...
resources = [
	[ "DoRT.output: Output (UAV - After)", True ],
]
...
def DoTest():
	...
	outDirName = "Techniques/UnitTests/_GoldImages/RayTrace/AnyHitSimple/"
	os.makedirs(outDirName, exist_ok=True)

	# Load the technique
	if not Host.LoadGG("Techniques/UnitTests/RayTrace/AnyHitSimple.gg"):
		return False
